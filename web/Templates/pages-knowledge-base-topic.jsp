<%-- 
    Document   : pages-knowledge-base-topic
    Created on : 20/12/2021, 01:40:50 PM
        ...
        <ul class="list-unstyled">
              ...
              <li class="sidebar-list-item"><a class="sidebar-link text-muted active" href="#" data-bs-target="#pagesDropdown" role="button" aria-expanded="true" data-bs-toggle="collapse"> 
                ...
                <ul class="sidebar-menu list-unstyled collapse show" id="pagesDropdown">
                  ...
                  <li class="sidebar-list-item"><a class="sidebar-link active text-muted" href="pages-knowledge-base-topic.jsp">Knowledge base - Topic</a></li>
                </ul>
              </li>
        ...
        <div class="container-fluid px-lg-4 px-xl-5">
              ...
              <div class="page-breadcrumb">
                <ul class="breadcrumb">
                  ...
                  <li class="breadcrumb-item"><a href="pages-knowledge-base.jsp">Knowledge Base</a></li>
                  <li class="breadcrumb-item active">Knowledge Base Topic     </li>
                </ul>
              </div>
              <!-- Page Header-->
              <div class="page-header">
                <h1 class="page-heading">Knowledge Base Topic</h1>
              </div>
          <div class="row mb-3"> 
              ...
              <div class="card mb-5">
                <div class="card-body p-5">
                  <div class="text-content">
                    ...
                    <pre class="mb-5"><code class="language-js">// Create an example category map
createListingsMap({
    mapId: 'categoryMap',
    ...
    imgBasePath: 'img/photo/'
                    ...
                    <blockquote class="blockquote blockquote-primary bg-gray-100 p-5">The bedding was hardly able to cover it and seemed ready to slide off any moment. His many legs, pitifully thin compared with the size of the rest of him, waved about helplessly as he looked. &quot;What's happened to me?&quot; he thought. It wasn't a dream.</blockquote>
                    <h3>Header Level 3</h3>
                    <p>His room, a proper human room although a little too small, lay peacefully between its four familiar walls. A collection of textile samples lay spread out on the table.</p>
            ...
            <div class="col-lg-3 col-xl-4 col-xxl-3">
              <div class="card mb-5">
                <div class="card-header bg-primary-100 py-4">
                  <div class="d-flex align-items-center justify-content-between">
                    <div>
                      <p class="subtitle text-primary">Need more help?</p>
                      <h5 class="mb-0">Similar Topics</h5>
                    </div>
                        <svg class="svg-icon svg-icon svg-icon-light w-3rem h-3rem ms-3 text-primary flex-shrink-0">
                          <use xlink:href="../lib/icons/orion-svg-sprite.svg#screwdriver-1"> </use>
                        </svg>
                  </div>
                </div>
                <div class="list-group list-group-flush rounded-0 text-sm my-3"><a class="list-group-item list-group-item-action text-muted" href="knowledge-base-topic.jsp"> <i class="far fa-file me-2"></i>Sint consequat aliquip?         </a><a class="list-group-item list-group-item-action text-muted" href="knowledge-base-topic.jsp"> <i class="far fa-file me-2"></i>Adipisicing voluptate magna quis sunt dolor velit.         </a><a class="list-group-item list-group-item-action text-muted" href="knowledge-base-topic.jsp"> <i class="far fa-file me-2"></i>Ad pariatur anim magna?         </a><a class="list-group-item list-group-item-action text-muted" href="knowledge-base-topic.jsp"> <i class="far fa-file me-2"></i>officia aliqua fugiat ex?         </a><a class="list-group-item list-group-item-action text-muted" href="knowledge-base-topic.jsp"> <i class="far fa-file me-2"></i>Sint consequat aliquip?         </a><a class="list-group-item list-group-item-action text-muted" href="knowledge-base-topic.jsp"> <i class="far fa-file me-2"></i>Adipisicing voluptate magna quis sunt dolor velit.         </a><a class="list-group-item list-group-item-action text-muted" href="knowledge-base-topic.jsp"> <i class="far fa-file me-2"></i>Ad pariatur anim magna?         </a><a class="list-group-item list-group-item-action text-muted" href="knowledge-base-topic.jsp"> <i class="far fa-file me-2"></i>officia aliqua fugiat ex?         </a>
                </div>
              </div>
              <div class="card hover-animate text-center mb-4">
                <div class="card-body">
                  ...
                  <p class="text-muted text-sm card-text">One morning, when Gregor Samsa woke from troubled dreams, he found himself transformed in his bed in</p><a class="stretched-link" href="pages-knowledge-base.jsp"> <span class="sr-only">See Topic        </span></a>
                </div>
              </div>
              <div class="card hover-animate text-center mb-4">
                <div class="card-body">
                  ...
                  <p class="text-muted text-sm card-text">The bedding was hardly able to cover it and seemed ready to slide off any moment. His many legs, pit</p><a class="stretched-link" href="pages-knowledge-base.jsp"> <span class="sr-only">See Topic        </span></a>
                </div>
              </div>
              <div class="card hover-animate text-center mb-4">
                <div class="card-body">
                  ...
                  <p class="text-muted text-sm card-text">His room, a proper human room although a little too small, lay peacefully between its four familiar </p><a class="stretched-link" href="pages-knowledge-base.jsp"> <span class="sr-only">See Topic        </span></a>
                </div>
              </div>
            </div>
          </div>
          <div class="row bg-white py-5 mx-n3 mx-lg-n4 mx-xl-n5 px-3 px-lg-4 px-xl-5">
