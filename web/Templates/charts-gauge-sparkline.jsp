<%-- 
    Document   : charts-gauge-sparkline
    Created on : 20/12/2021, 01:18:02 PM
        ...
        <ul class="list-unstyled">
              ...
              <li class="sidebar-list-item"><a class="sidebar-link text-muted active" href="#" data-bs-target="#chartsDropdown" role="button" aria-expanded="true" data-bs-toggle="collapse"> 
                ...
                <ul class="sidebar-menu list-unstyled collapse show" id="chartsDropdown">
                  ...
                  <li class="sidebar-list-item"><a class="sidebar-link active text-muted" href="charts-gauge-sparkline.jsp">Gauge + Sparkline</a></li>
                </ul>
              </li>
      ...
      <div class="page-holder bg-gray-100">
        <div class="container-fluid px-lg-4 px-xl-5">
              ...
              <div class="page-header">
                <h1 class="page-heading">Charts - Gauges and Sparklines</h1>
              </div>
          <section>
            <div class="card mb-4"> 
              <div class="card-header">
                <h4 class="card-heading">Gauges   </h4>
              </div>
              <div class="card-body">
                <p>100% native and cool looking animated JavaScript/CoffeeScript gauge. See more at <a href="http://bernii.github.io/gauge.js/">Gauge.js homepage.</a></p>
                <p class="show-code-sample"><a data-bs-toggle="collapse" href="#codeSample1">Show code sample</a></p>
                <div class="collapse" id="codeSample1">
                  <pre class="code-sample"><code class="language-js">const gauge1 = document.getElementById(&quot;gauge1&quot;);
...
gaugeObject1.setTextField(document.getElementById(&quot;gauge1Value&quot;));                            
                ...
                <div class="row mt-5">
                  <div class="col-md-3">
                    <div class="gauge-container">
                      <canvas class="gauge-canvas" id="gauge1"></canvas><span class="gauge-label" id="gauge1Value"></span>
                    </div>
                  </div>
                  <div class="col-md-3">
                    <div class="gauge-container">
                      <canvas class="gauge-canvas" id="gauge2"></canvas><span class="gauge-label" id="gauge2Value"></span>
                    </div>
                  </div>
                  <div class="col-md-3">
                    <div class="gauge-container">
                      <canvas class="gauge-canvas" id="gauge3"></canvas><span class="gauge-label" id="gauge3Value"></span>
                    </div>
                  </div>
                  <div class="col-md-3">
                    <div class="gauge-container">
                      <canvas class="gauge-canvas" id="gauge4"></canvas><span class="gauge-label" id="gauge4Value"></span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="card mb-4">
              <div class="card-header">
                <h4 class="card-heading">Sparkline</h4>
              </div>
              <div class="card-body">
                <p>Generate SVG sparklines with JavaScript without any external dependency. See more at <a href="https://github.com/fnando/sparkline">Sparkline homepage.</a></p>
                ...
                <div class="collapse" id="codeSample2">
                  <pre class="code-sample"><code class="language-html">
                          ...
                          &lt;script&gt;sparkline(document.querySelector(&quot;.sparkline&quot;), [1, 5, 2, 4, 8, 3, 7]);&lt;/script&gt;</code></pre>
                </div>
                <div class="row mt-5">
                  <div class="col-lg-6 col-xl-4 mb-5">
                    <div class="d-flex align-items-center mb-4">
                      <div class="position-relative flex-shrink-0">
                        <svg class="btc" width="100" height="20" stroke-width="2" stroke="blue" fill="rgba(0, 0, 255, .2)"></svg><span class="sparkline--tooltip" hidden></span>
                      </div>
                      <div class="ms-3">
                        <p class="fw-bold mb-0">BTC Price</p>
                      </div>
                    </div>
                    <div class="d-flex align-items-center">
                      <div class="position-relative flex-shrink-0">
                        <svg class="eth" width="100" height="20" stroke-width="2" stroke="blue" fill="rgba(0, 0, 255, .2)"></svg><span class="sparkline--tooltip" hidden></span>
                      </div>
                      <div class="ms-3">
                        <p class="fw-bold mb-0">ETH Price                                    </p>
                      </div>
                    </div>
                  </div>
                  <div class="col-lg-6">
                    <div class="row row-cols-2 row-cols-md-4 row-cols-lg-3">
                      <div class="col mb-3">
                        <svg class="sparkline sparkline--red" width="100" height="30" stroke-width="3"></svg>
                        <svg class="sparkline sparkline--red sparkline--filled" width="100" height="30" stroke-width="3"></svg>
                      </div>
    ...
    <!-- Gauge.js-->
    <script src="../lib/vendor/gaugeJS/gauge.min.js"></script>
    <!-- Sparkline-->
    <script src="../lib/vendor/@fnando/sparkline/sparkline.js"></script>
    <!-- Init Gauge-->
    <script src="../lib/js/charts-gauge.js"></script>
    <!-- Init Sparkline-->
    <script src="../lib/js/charts-sparkline.js"></script>
    <!-- Main Theme JS File-->
