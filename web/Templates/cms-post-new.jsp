<%-- 
    Document   : cms-post-new
    Created on : 20/12/2021, 01:21:39 PM
...
<html>
  ...
  <body>
        ...
        <ul class="list-unstyled">
              ...
              <li class="sidebar-list-item"><a class="sidebar-link text-muted active" href="#" data-bs-target="#cmsDropdown" role="button" aria-expanded="true" data-bs-toggle="collapse"> 
                ...
                <ul class="sidebar-menu list-unstyled collapse show" id="cmsDropdown">
                  ...
                  <li class="sidebar-list-item"><a class="sidebar-link active text-muted" href="cms-post-new.jsp">Add new post</a></li>
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <div id="editorWithToolbar">
                      ...
                      <div class="bg-white" id="editor-container" style="min-height: 300px; max-height: 1000px;overflow-y: auto;">
                        <h2>Minas Tirith</h2>
                        <p><br></p>
    ...
    <!-- Add New Post JS-->
    <script src="../lib/js/cms-post-new.js"></script>
    <!-- Main Theme JS File-->
