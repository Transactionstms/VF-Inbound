<%-- 
    Document   : e-commerce-product-new
    Created on : 20/12/2021, 01:30:22 PM
...
<html>
  <head>
    ...
    <!-- Quill Themes-->
    <link rel="stylesheet" href="../lib/vendor/quill/quill.snow.css">
  ...
  <body>
        ...
        <ul class="list-unstyled">
              ...
              <li class="sidebar-list-item"><a class="sidebar-link text-muted active" href="#" data-bs-target="#e-commerceDropdown" role="button" aria-expanded="true" data-bs-toggle="collapse"> 
                ...
                <ul class="sidebar-menu list-unstyled collapse show" id="e-commerceDropdown">
                  ...
                  <li class="sidebar-list-item"><a class="sidebar-link active text-muted" href="e-commerce-product-new.jsp">Products - New</a></li>
        ...
        <div class="container-fluid px-lg-4 px-xl-5">
              ...
              <div class="page-breadcrumb">
                <ul class="breadcrumb">
                  ...
                  <li class="breadcrumb-item"><a href="e-commerce-products.jsp">Products</a></li>
                ...
                <div class="card mb-4">
                  ...
                  <div class="card-body">
                    ...
                    <div id="editorWithToolbar">
                      <div id="toolbar-container"><span class="ql-formats">
                          <select class="ql-font"></select>
                          <select class="ql-size"></select></span><span class="ql-formats">
                          <button class="ql-bold"></button>
                          <button class="ql-italic"></button>
                          <button class="ql-underline"></button>
                          <button class="ql-strike"></button></span><span class="ql-formats">
                          <select class="ql-color"></select>
                          <select class="ql-background"></select></span><span class="ql-formats">
                          ...
                          <select class="ql-align"></select></span><span class="ql-formats">
                          <button class="ql-link"></button></span><span class="ql-formats">
                          <button class="ql-clean"></button></span></div>
                      <div class="bg-white" id="editor-container" style="min-height: 200px; max-height: 600px;overflow-y: auto;">
                        <h2>Minas Tirith</h2>
                        <p><br></p>
                  ...
                  <div class="card-body">                                   
                    <div class="row gy-4 mb-4">
                      <div class="col-6 col-md-4">
                        <div class="card display-hover"><a class="glightbox" href="img/photos/soroush-zargar-zFSUhqGual8-unsplash.jpg" data-gallery="gallery" data-title="Image 1"><img class="card-img-top" src="../lib/img/photos/w-600/soroush-zargar-zFSUhqGual8-unsplash.jpg" alt="Image 1"></a>
                          <div class="card-body p-3">
                            <div class="d-flex align-items-center justify-content-between">
                              <p class="mb-0 text-muted text-sm">Image 1 das dad ad adas</p><a class="badge badge-primary-light text-base flex-shrink-0 display-hover-content" href="#!"><i class="far fa-trash-alt">                                                    </i></a>
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="col-6 col-md-4">
                        <div class="card display-hover"><a class="glightbox" href="img/photos/faruk-kaymak-CNVvDjVDiVI-unsplash.jpg" data-gallery="gallery" data-title="Image 2"><img class="card-img-top" src="../lib/img/photos/w-600/faruk-kaymak-CNVvDjVDiVI-unsplash.jpg" alt="Image 2"></a>
                          <div class="card-body p-3">
                            <div class="d-flex align-items-center justify-content-between">
                              <p class="mb-0 text-muted text-sm">Image 2 das dad ad adas</p><a class="badge badge-primary-light text-base flex-shrink-0 display-hover-content" href="#!"><i class="far fa-trash-alt">                                                    </i></a>
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="col-6 col-md-4">
                        <div class="card display-hover"><a class="glightbox" href="img/photos/aron-visuals-3jBU9TbKW7o-unsplash.jpg" data-gallery="gallery" data-title="Image 3"><img class="card-img-top" src="../lib/img/photos/w-600/aron-visuals-3jBU9TbKW7o-unsplash.jpg" alt="Image 3"></a>
                          <div class="card-body p-3">
                            <div class="d-flex align-items-center justify-content-between">
                              <p class="mb-0 text-muted text-sm">Image 3 das dad ad adas</p><a class="badge badge-primary-light text-base flex-shrink-0 display-hover-content" href="#!"><i class="far fa-trash-alt">                                                    </i></a>
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="col-6 col-md-4">
                        <div class="card display-hover"><a class="glightbox" href="img/photos/elizabeth-gottwald-dnIWYrliZfU-unsplash.jpg" data-gallery="gallery" data-title="Image 4"><img class="card-img-top" src="../lib/img/photos/w-600/elizabeth-gottwald-dnIWYrliZfU-unsplash.jpg" alt="Image 4"></a>
                          <div class="card-body p-3">
                            <div class="d-flex align-items-center justify-content-between">
                              <p class="mb-0 text-muted text-sm">Image 4 das dad ad adas</p><a class="badge badge-primary-light text-base flex-shrink-0 display-hover-content" href="#!"><i class="far fa-trash-alt">                                                    </i></a>
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="col-6 col-md-4">
                        <div class="card display-hover"><a class="glightbox" href="img/photos/willian-justen-de-vasconcellos-4hMET7vYTAQ-unsplash.jpg" data-gallery="gallery" data-title="Image 5"><img class="card-img-top" src="../lib/img/photos/w-600/willian-justen-de-vasconcellos-4hMET7vYTAQ-unsplash.jpg" alt="Image 5"></a>
                          <div class="card-body p-3">
                            <div class="d-flex align-items-center justify-content-between">
                              <p class="mb-0 text-muted text-sm">Image 5 das dad ad adas</p><a class="badge badge-primary-light text-base flex-shrink-0 display-hover-content" href="#!"><i class="far fa-trash-alt">                                                    </i></a>
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="col-6 col-md-4">
                        <div class="card display-hover"><a class="glightbox" href="img/photos/sorasak-_UIN-pFfJ7c-unsplash.jpg" data-gallery="gallery" data-title="Image 6"><img class="card-img-top" src="../lib/img/photos/w-600/sorasak-_UIN-pFfJ7c-unsplash.jpg" alt="Image 6"></a>
                          <div class="card-body p-3">
                            <div class="d-flex align-items-center justify-content-between">
                              <p class="mb-0 text-muted text-sm">Image 6 das dad ad adas</p><a class="badge badge-primary-light text-base flex-shrink-0 display-hover-content" href="#!"><i class="far fa-trash-alt">                                                    </i></a>
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="col-6 col-md-4">
                        <div class="card display-hover"><a class="glightbox" href="img/photos/montylov-ktZZiHb-GoI-unsplash.jpg" data-gallery="gallery" data-title="Image 7"><img class="card-img-top" src="../lib/img/photos/w-600/montylov-ktZZiHb-GoI-unsplash.jpg" alt="Image 7"></a>
                          <div class="card-body p-3">
                            <div class="d-flex align-items-center justify-content-between">
                              <p class="mb-0 text-muted text-sm">Image 7 das dad ad adas</p><a class="badge badge-primary-light text-base flex-shrink-0 display-hover-content" href="#!"><i class="far fa-trash-alt">                                                    </i></a>
                            </div>
                          </div>
                        </div>
                      </div>
                    </div>
                    <form class="dropzone bg-gray-100 rounded-4" id="demo-upload" action="#">
                ...
                <div class="card shadow-sm mb-4">
                  ...
                  <div class="card-body">
                    ...
                    <select class="form-select">
                      ...
                      <option value="brand1"> Zilidium                 </option>
                      <option value="brand2"> Chorizon                 </option>
                      <option value="brand3"> Comverges                 </option>
                      <option value="brand4"> Remold                 </option>
                      <option value="brand5"> Euron                 </option>
                      <option value="brand6"> Netagy                 </option>
                      <option value="brand7"> Zedalis                 </option>
                      <option value="brand8"> Uniworld                 </option>
                      <option value="brand9"> Candecor                 </option>
                      <option value="brand10"> Rameon                 </option>
                      <option value="brand11"> Balooba                 </option>
                      <option value="brand12"> Combogene                 </option>
                      <option value="brand13"> Dadabase                 </option>
                      <option value="brand14"> Progenex                 </option>
                      <option value="brand15"> Xleen                 </option>
                      <option value="brand16"> Zomboid                 </option>
                      <option value="brand17"> Hotcakes                 </option>
                      <option value="brand18"> Affluex                 </option>
                      <option value="brand19"> Ziggles                 </option>
                      <option value="brand20"> Imaginart                 </option>
                      <option value="brand21"> Applica                 </option>
                      <option value="brand22"> Capscreen                 </option>
                      <option value="brand23"> Naxdis                 </option>
                      <option value="brand24"> Telepark                 </option>
                    </select>
                    <hr class="bg-gray-500 my-4">
                    ...
                    <select class="form-select">
                      ...
                      <option value="collection2"> Autumn</option>
                      <option value="collection3"> Winter</option>
                    </select>
                    <hr class="bg-gray-500 my-4">
    ...
    <!-- Add New Product JS-->
    <script src="../lib/js/e-commerce-product-new.js">   </script>
    <!-- Main Theme JS File-->
