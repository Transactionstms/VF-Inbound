<%-- 
    ...
    Created on : 20/12/2021, 01:42:42 PM
        ...
        <ul class="list-unstyled">
              ...
              <li class="sidebar-list-item"><a class="sidebar-link text-muted active" href="#" data-bs-target="#pagesDropdown" role="button" aria-expanded="true" data-bs-toggle="collapse"> 
                ...
                <ul class="sidebar-menu list-unstyled collapse show" id="pagesDropdown">
                  <li class="sidebar-list-item"><a class="sidebar-link active text-muted" href="pages-profile.jsp">Profile</a></li>
            ...
            <div class="row">
              <div class="col-lg-4">
                <div class="card card-profile mb-4">
                  ...
                  <div class="card-body text-center"><img class="card-profile-img" src="../lib/img/avatar-7.jpg" alt="Nathan Andrews">
                ...
                <div class="card mb-4">
                  <div class="card-body">
                    <div class="d-flex align-items-center">
                      <div class="flex-shrink-0"><img class="avatar avatar-lg p-1" src="../lib/img/avatar-7.jpg" alt="Nathan Andrews"></div>
                      <div class="flex-grow-1 ps-3">
                        <h4>Nathan Andrews</h4>
                        <p class="text-muted mb-0">Coder</p>
                        <ul class="social-links list-inline mb-0 mt-2">
                          <li class="list-inline-item"><a href="javascript:void(0)" data-bs-toggle="tooltip" data-placement="top" title="Nathan's Facebook"><i class="fab fa-facebook"></i></a></li>
                ...
                <form class="card mb-4">
                  ...
                  <div class="card-body">
                    <div class="row mb-3">
                      <div class="col-auto d-flex align-items-center"><img class="avatar avatar-lg p-1" src="../lib/img/avatar-7.jpg" alt="Avatar"></div>
                      <div class="col">
                      ...
                      <div class="d-flex">
                        ...
                        <div class="flex-grow-1 ps-3"><small class="float-right">10 mins ago</small>
                          ...
                          <div class="d-flex mt-4">
                            <div class="flex-shrink-0"><img class="avatar avatar-md p-1" src="../lib/img/avatar-3.jpg" alt="Serenity Mitchelle"></div>
                          ...
                          <div class="d-flex mt-4">
                            <div class="flex-shrink-0"><img class="avatar avatar-md p-1" src="../lib/img/avatar-1.jpg" alt="Tony O'Brian"></div>
                    ...
                    <div class="list-group-item border-start-0 border-end-0 py-5">
                      <div class="d-flex">
                        ...
                        <div class="flex-grow-1 ps-3"><small class="float-right">34 mins ago</small>
                          ...
                          <div class="d-flex mt-4">
                            <div class="flex-shrink-0"><img class="avatar avatar-md p-1" src="../lib/img/avatar-6.jpg" alt="Javier Gregory"></div>
