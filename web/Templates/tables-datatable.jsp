<%-- 
    ...
    Created on : 20/12/2021, 01:44:42 PM
...
<html>
  ...
  <body>
    ...
    <div class="d-flex align-items-stretch">
      <div class="sidebar py-3" id="sidebar">
        ...
        <ul class="list-unstyled">
              ...
              <li class="sidebar-list-item"><a class="sidebar-link text-muted active" href="#" data-bs-target="#tablesDropdown" role="button" aria-expanded="true" data-bs-toggle="collapse"> 
                      <svg class="svg-icon svg-icon-md me-3">
                        <use xlink:href="../lib/icons/orion-svg-sprite.svg#grid-1"> </use>
                      </svg><span class="sidebar-link-title">Tables </span></a>
                <ul class="sidebar-menu list-unstyled collapse show" id="tablesDropdown">
                  <li class="sidebar-list-item"><a class="sidebar-link text-muted" href="tables.jsp">Bootstrap tables</a></li>
                  <li class="sidebar-list-item"><a class="sidebar-link active text-muted" href="tables-datatable.jsp">Datatable</a></li>
                </ul>
              </li>
        </ul>
      ...
      <div class="page-holder bg-gray-100">
        <div class="container-fluid px-lg-4 px-xl-5">
              ...
              <div class="page-header">
                <h1 class="page-heading">Data Table</h1>
              </div>
          <section>
            <div class="card mb-4">
              ...
              <div class="card-body text-muted">
                <p>A lightweight, extendable, dependency-free javascript HTML table plugin. Similar to jQuery DataTables for use in modern browsers, but without the jQuery dependency.</p>
                <p>Check out more at <a href="https://github.com/fiduswriter/Simple-DataTables">Project's GitHub</a>.</p>
                ...
                <pre><code class="language-js">const dataTable = new simpleDatatables.DataTable(&quot;#datatable1&quot;, {});
</code></pre>
    ...
    <script src="../lib/js/tables-datatable.js"></script>
    <!-- Main Theme JS File-->
