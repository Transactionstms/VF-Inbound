<%-- 
    ...
    Created on : 20/12/2021, 01:27:06 PM
        ...
        <ul class="list-unstyled">
              ...
              <li class="sidebar-list-item"><a class="sidebar-link text-muted active" href="#" data-bs-target="#componentsDropdown" role="button" aria-expanded="true" data-bs-toggle="collapse"> 
                ...
                <ul class="sidebar-menu list-unstyled collapse show" id="componentsDropdown">
                  ...
                  <li class="sidebar-list-item"><a class="sidebar-link active text-muted" href="components-map.jsp">Maps</a></li>
              ...
              <div class="col-xl-6">
                <div class="card mb-4">
                  <div class="card-header">
                    <h4 class="card-heading">Basic Map - One marker </h4>
                  </div>
                  <div class="card-body"> 
                    <p>This is a basic Leaflet map implementation with a custom marker. Everything is for you and this map can be created by calling a simple function.</p>
                    <p class="show-code-sample"><a data-bs-toggle="collapse" href="#codeSample">Show code sample</a></p>
                    <div class="collapse" id="codeSample">
                      <pre><code class="language-js">// coordinates for the center of the map and the marker
var lat = 40.732346;
var long = -74.0014247;
...
createBasicMap(id, lat, long, markerImage);
                    ...
                    <div class="map" id="map-3" style="height: 400px;">                                                                      </div>
                  </div>
                </div>
              </div>
              <div class="col-xl-6">
                <div class="card mb-4">
                  <div class="card-header">
                    <h4 class="card-heading">Styled Map - One marker</h4>
                  </div>
                  <div class="card-body">
                    <p>An example of the styled Leaflet map with a custom marker. You can easily replace the look by changin to another theme from <a href="https://leaflet-extras.github.io/leaflet-providers/preview/">Leaflet Providers</a>.</p>
...
createSimpleMap(id, lat, long, markerImage);
            ...
            <div class="card mb-4">
              <div class="card-header">
                <h4 class="card-heading">Styled Map - Multiple markers with infobox, images and structured content from JSON</h4>
              </div>
              <div class="card-body">
                <p>More complex implementation: data are loaded from a JSON file and custom infobox with an image is used in this example. Again, everything's prepared for you.</p>
...
createAdvancedMap(options);
                ...
                <div class="map" id="map-2" style="height: 600px;">       </div>
              </div>
            </div>
          </section>
        </div>
    ...
    <script>
      document.addEventListener("DOMContentLoaded", function() {
          ...
          // of the marker. E.g. to img/map-marker-violet.svg.
          var markerImage = 'img/map-marker-default.svg';
          // id of the map DOM element
          var id = 'map-3';
