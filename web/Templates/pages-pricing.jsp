<%-- 
    Document   : pages-pricing
    Created on : 20/12/2021, 01:42:17 PM
        ...
        <ul class="list-unstyled">
              ...
              <li class="sidebar-list-item"><a class="sidebar-link text-muted active" href="#" data-bs-target="#pagesDropdown" role="button" aria-expanded="true" data-bs-toggle="collapse"> 
                ...
                <ul class="sidebar-menu list-unstyled collapse show" id="pagesDropdown">
                  ...
                  <li class="sidebar-list-item"><a class="sidebar-link active text-muted" href="pages-pricing.jsp">Pricing table</a></li>
      ...
      <div class="page-holder bg-gray-100">
        <div class="container-fluid px-lg-4 px-xl-5">
              ...
              <div class="page-header">
                <h1 class="page-heading">Pricing tables</h1>
              </div>
          <section>
            <div class="row mb-5">
              <div class="col-lg-4">
                    ...
                    <div class="card mb-5 mb-lg-0 border-0 shadow">
                      <div class="card-body">
                        <h2 class="card-heading text-primary text-center fw-bold py-3">Free</h2>
                        <p class="text-muted text-center mb-4"><span class="h1 text-dark fw-bold">$0</span><span class="ms-2">/ month</span></p>
                        <hr class="text-muted">
                        <ul class="fa-ul my-4">
                          <li class="mb-3"><span class="fa-li text-primary"><i class="fas fa-check"></i></span>Single User</li>
                          <li class="mb-3"><span class="fa-li text-primary"><i class="fas fa-check"></i></span>5GB Storage</li>
                          <li class="mb-3"><span class="fa-li text-primary"><i class="fas fa-check"></i></span>Unlimited Public Projects</li>
                          <li class="mb-3 text-muted"><span class="fa-li"><i class="fas fa-times"></i></span>Community Access</li>
                          <li class="mb-3 text-muted"><span class="fa-li"><i class="fas fa-times"></i></span>Unlimited Private Projects</li>
                          <li class="mb-3 text-muted"><span class="fa-li"><i class="fas fa-times"></i></span>Dedicated Phone Support</li>
                          <li class="mb-3 text-muted"><span class="fa-li"><i class="fas fa-times"></i></span>Monthly Status Reports</li>
                        </ul>
              ...
              <div class="col-lg-4">
                    <!-- pricing card-->
                    <div class="card mb-5 mb-lg-0 border-0 card-highlight shadow-lg overflow-hidden">
                      <div class="card-status bg-primary"></div>
                      <div class="card-body">
                        <h2 class="card-heading text-primary text-center fw-bold py-3">Plus</h2>
                        <p class="text-muted text-center mb-4"><span class="h1 text-dark fw-bold">$9</span><span class="ms-2">/ month</span></p>
                        <hr class="text-muted">
                        <ul class="fa-ul my-4">
                          <li class="mb-3"><span class="fa-li text-primary"><i class="fas fa-check"></i></span>Single User</li>
                          <li class="mb-3"><span class="fa-li text-primary"><i class="fas fa-check"></i></span>5GB Storage</li>
                          <li class="mb-3"><span class="fa-li text-primary"><i class="fas fa-check"></i></span>Unlimited Public Projects</li>
                          <li class="mb-3"><span class="fa-li text-primary"><i class="fas fa-check"></i></span>Community Access</li>
                          <li class="mb-3"><span class="fa-li text-primary"><i class="fas fa-check"></i></span>Unlimited Private Projects</li>
                          <li class="mb-3 text-muted"><span class="fa-li"><i class="fas fa-times"></i></span>Dedicated Phone Support</li>
                          <li class="mb-3 text-muted"><span class="fa-li"><i class="fas fa-times"></i></span>Monthly Status Reports</li>
                        </ul>
                        <div class="text-center"><a class="btn btn-outline-primary" href="#">Select</a></div>
              ...
              <div class="col-lg-4">
                    ...
                    <div class="card mb-5 mb-lg-0 border-0 shadow">
                      <div class="card-body">
                        <h2 class="card-heading text-primary text-center fw-bold py-3">Pro</h2>
                        <p class="text-muted text-center mb-4"><span class="h1 text-dark fw-bold">$30</span><span class="ms-2">/ month</span></p>
                        <hr class="text-muted">
                        <ul class="fa-ul my-4">
                          <li class="mb-3"><span class="fa-li text-primary"><i class="fas fa-check"></i></span>Single User</li>
                          <li class="mb-3"><span class="fa-li text-primary"><i class="fas fa-check"></i></span>5GB Storage</li>
                          ...
                          <li class="mb-3"><span class="fa-li text-primary"><i class="fas fa-check"></i></span>Community Access</li>
                          <li class="mb-3"><span class="fa-li text-primary"><i class="fas fa-check"></i></span>Unlimited Private Projects</li>
                          <li class="mb-3"><span class="fa-li text-primary"><i class="fas fa-check"></i></span>Dedicated Phone Support</li>
                          <li class="mb-3"><span class="fa-li text-primary"><i class="fas fa-check"></i></span>Monthly Status Reports</li>
                        </ul>
                        <div class="text-center"><a class="btn btn-outline-primary" href="#">Select</a></div>
                      </div>
                    </div>
