<%-- 
    Document   : pages-contacts
    Created on : 20/12/2021, 01:39:27 PM
        ...
        <ul class="list-unstyled">
              ...
              <li class="sidebar-list-item"><a class="sidebar-link text-muted active" href="#" data-bs-target="#pagesDropdown" role="button" aria-expanded="true" data-bs-toggle="collapse"> 
                ...
                <ul class="sidebar-menu list-unstyled collapse show" id="pagesDropdown">
                  ...
                  <li class="sidebar-list-item"><a class="sidebar-link active text-muted" href="pages-contacts.jsp">Contacts</a></li>
            ...
            <div class="row">
              <div class="col-md-6 col-xl-4">                       
                <div class="card mb-4">
                  <div class="card-body">
                    <div class="d-flex align-items-center">
                      <div class="flex-shrink-0"><img class="avatar avatar-lg p-1" src="../lib/img/avatar-0.jpg" alt="Nielsen Cobb"></div>
                      <div class="flex-grow-1 ps-3 overflow-hidden">
                        ...
                        <p class="card-text"> nielsencobb@memora.com<br><abbr title="Phone">P:  </abbr>+1 (851) 552-2735</p>
                      </div>
                    </div><a class="stretched-link" href="pages-profile.jsp"></a>
                  </div>
                </div>
              </div>
              <div class="col-md-6 col-xl-4">                       
                <div class="card mb-4">
                  <div class="card-body">
                    <div class="d-flex align-items-center">
                      <div class="flex-shrink-0"><img class="avatar avatar-lg p-1" src="../lib/img/avatar-1.jpg" alt="Margret Cote"></div>
                      <div class="flex-grow-1 ps-3 overflow-hidden">
                        <h5 class="card-text mb-0">Margret Cote</h5>
                        <p class="card-text text-uppercase text-muted">Zilidium</p>
                        <p class="card-text"> margretcote@zilidium.com<br><abbr title="Phone">P:  </abbr>+1 (893) 532-2218</p>
                      </div>
                    </div><a class="stretched-link" href="pages-profile.jsp"></a>
                  </div>
                </div>
              ...
              <div class="col-md-6 col-xl-4">                       
                <div class="card mb-4">
                  <div class="card-body">
                    <div class="d-flex align-items-center">
                      <div class="flex-shrink-0"><img class="avatar avatar-lg p-1" src="../lib/img/avatar-2.jpg" alt="Rachel Vinson"></div>
                      <div class="flex-grow-1 ps-3 overflow-hidden">
                        <h5 class="card-text mb-0">Rachel Vinson</h5>
                        <p class="card-text text-uppercase text-muted">Chorizon</p>
                        <p class="card-text"> rachelvinson@chorizon.com<br><abbr title="Phone">P:  </abbr>+1 (891) 494-2060</p>
                      </div>
                    </div><a class="stretched-link" href="pages-profile.jsp"></a>
                  </div>
                </div>
              ...
              <div class="col-md-6 col-xl-4">                       
                <div class="card mb-4">
                  <div class="card-body">
                    <div class="d-flex align-items-center">
                      <div class="flex-shrink-0"><img class="avatar avatar-lg p-1" src="../lib/img/avatar-3.jpg" alt="Gabrielle Aguirre"></div>
                      <div class="flex-grow-1 ps-3 overflow-hidden">
                        <h5 class="card-text mb-0">Gabrielle Aguirre</h5>
                        <p class="card-text text-uppercase text-muted">Comverges</p>
                        <p class="card-text"> gabrielleaguirre@comverges.com<br><abbr title="Phone">P:  </abbr>+1 (805) 459-3869</p>
                      </div>
                    </div><a class="stretched-link" href="pages-profile.jsp"></a>
                  </div>
                </div>
              ...
              <div class="col-md-6 col-xl-4">                       
                <div class="card mb-4">
                  <div class="card-body">
                    <div class="d-flex align-items-center">
                      <div class="flex-shrink-0"><img class="avatar avatar-lg p-1" src="../lib/img/avatar-4.jpg" alt="Spears Collier"></div>
                      <div class="flex-grow-1 ps-3 overflow-hidden">
                        <h5 class="card-text mb-0">Spears Collier</h5>
                        <p class="card-text text-uppercase text-muted">Remold</p>
                        <p class="card-text"> spearscollier@remold.com<br><abbr title="Phone">P:  </abbr>+1 (910) 555-2436</p>
                      </div>
                    </div><a class="stretched-link" href="pages-profile.jsp"></a>
                  </div>
                </div>
              ...
              <div class="col-md-6 col-xl-4">                       
                <div class="card mb-4">
                  <div class="card-body">
                    <div class="d-flex align-items-center">
                      <div class="flex-shrink-0"><img class="avatar avatar-lg p-1" src="../lib/img/avatar-5.jpg" alt="Keisha Thomas"></div>
                      <div class="flex-grow-1 ps-3 overflow-hidden">
                        <h5 class="card-text mb-0">Keisha Thomas</h5>
                        <p class="card-text text-uppercase text-muted">Euron</p>
                        <p class="card-text"> keishathomas@euron.com<br><abbr title="Phone">P:  </abbr>+1 (958) 405-3392</p>
                      </div>
                    </div><a class="stretched-link" href="pages-profile.jsp"></a>
                  </div>
                </div>
              ...
              <div class="col-md-6 col-xl-4">                       
                <div class="card mb-4">
                  <div class="card-body">
                    <div class="d-flex align-items-center">
                      <div class="flex-shrink-0"><img class="avatar avatar-lg p-1" src="../lib/img/avatar-6.jpg" alt="Elisabeth Key"></div>
                      <div class="flex-grow-1 ps-3 overflow-hidden">
                        <h5 class="card-text mb-0">Elisabeth Key</h5>
                        <p class="card-text text-uppercase text-muted">Netagy</p>
                        <p class="card-text"> elisabethkey@netagy.com<br><abbr title="Phone">P:  </abbr>+1 (900) 421-2096</p>
                      </div>
                    </div><a class="stretched-link" href="pages-profile.jsp"></a>
                  </div>
                </div>
              ...
              <div class="col-md-6 col-xl-4">                       
                <div class="card mb-4">
                  <div class="card-body">
                    <div class="d-flex align-items-center">
                      <div class="flex-shrink-0"><img class="avatar avatar-lg p-1" src="../lib/img/avatar-7.jpg" alt="Patel Mack"></div>
                      <div class="flex-grow-1 ps-3 overflow-hidden">
                        <h5 class="card-text mb-0">Patel Mack</h5>
                        <p class="card-text text-uppercase text-muted">Zedalis</p>
                        <p class="card-text"> patelmack@zedalis.com<br><abbr title="Phone">P:  </abbr>+1 (800) 460-2720</p>
                      </div>
                    </div><a class="stretched-link" href="pages-profile.jsp"></a>
                  </div>
                </div>
              ...
              <div class="col-md-6 col-xl-4">                       
                <div class="card mb-4">
                  <div class="card-body">
                    <div class="d-flex align-items-center">
                      <div class="flex-shrink-0"><img class="avatar avatar-lg p-1" src="../lib/img/avatar-8.jpg" alt="Erika Whitaker"></div>
                      <div class="flex-grow-1 ps-3 overflow-hidden">
                        <h5 class="card-text mb-0">Erika Whitaker</h5>
                        <p class="card-text text-uppercase text-muted">Uniworld</p>
                        <p class="card-text"> erikawhitaker@uniworld.com<br><abbr title="Phone">P:  </abbr>+1 (911) 484-3333</p>
                      </div>
                    </div><a class="stretched-link" href="pages-profile.jsp"></a>
                  </div>
                </div>
              ...
              <div class="col-md-6 col-xl-4">                       
                <div class="card mb-4">
                  <div class="card-body">
                    <div class="d-flex align-items-center">
                      <div class="flex-shrink-0"><img class="avatar avatar-lg p-1" src="../lib/img/avatar-9.jpg" alt="Meyers Swanson"></div>
                      <div class="flex-grow-1 ps-3 overflow-hidden">
                        <h5 class="card-text mb-0">Meyers Swanson</h5>
                        <p class="card-text text-uppercase text-muted">Candecor</p>
                        <p class="card-text"> meyersswanson@candecor.com<br><abbr title="Phone">P:  </abbr>+1 (999) 404-3297</p>
                      </div>
                    </div><a class="stretched-link" href="pages-profile.jsp"></a>
                  </div>
                </div>
              ...
              <div class="col-md-6 col-xl-4">                       
                <div class="card mb-4">
                  <div class="card-body">
                    <div class="d-flex align-items-center">
                      <div class="flex-shrink-0"><img class="avatar avatar-lg p-1" src="../lib/img/avatar-10.jpg" alt="Townsend Sloan"></div>
                      <div class="flex-grow-1 ps-3 overflow-hidden">
                        <h5 class="card-text mb-0">Townsend Sloan</h5>
                        <p class="card-text text-uppercase text-muted">Rameon</p>
                        <p class="card-text"> townsendsloan@rameon.com<br><abbr title="Phone">P:  </abbr>+1 (978) 563-2964</p>
                      </div>
                    </div><a class="stretched-link" href="pages-profile.jsp"></a>
                  </div>
                </div>
              ...
              <div class="col-md-6 col-xl-4">                       
                <div class="card mb-4">
                  <div class="card-body">
                    <div class="d-flex align-items-center">
                      <div class="flex-shrink-0"><img class="avatar avatar-lg p-1" src="../lib/img/avatar-11.jpg" alt="Millicent Henry"></div>
                      <div class="flex-grow-1 ps-3 overflow-hidden">
                        <h5 class="card-text mb-0">Millicent Henry</h5>
                        <p class="card-text text-uppercase text-muted">Balooba</p>
                        <p class="card-text"> millicenthenry@balooba.com<br><abbr title="Phone">P:  </abbr>+1 (863) 585-3988</p>
                      </div>
                    </div><a class="stretched-link" href="pages-profile.jsp"></a>
                  </div>
                </div>
