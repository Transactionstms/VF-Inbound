<%-- 
    Document   : components-preloader
    Created on : 20/12/2021, 01:28:11 PM
        ...
        <ul class="list-unstyled">
              ...
              <li class="sidebar-list-item"><a class="sidebar-link text-muted active" href="#" data-bs-target="#componentsDropdown" role="button" aria-expanded="true" data-bs-toggle="collapse"> 
                ...
                <ul class="sidebar-menu list-unstyled collapse show" id="componentsDropdown">
                  ...
                  <li class="sidebar-list-item"><a class="sidebar-link active text-muted" href="components-preloader.jsp">Preloaders</a></li>
                </ul>
              </li>
      ...
      <div class="page-holder bg-gray-100">
        <div class="container-fluid px-lg-4 px-xl-5">
              ...
              <div class="page-header">
                <h1 class="page-heading">Preloaders</h1>
              </div>
          <section>
            <div class="card mb-4">
              <div class="card-body text-muted">
                ...
                <p class="card-text">Read more about this great plugin at its <a href="https://github.com/tobiasahlin/SpinKit">Repository home</a>.</p>
                <p class="show-code-sample"><a data-bs-toggle="collapse" href="#codeSample">Show code sample</a></p>
                <div class="collapse card-text" id="codeSample">
...
document.addEventListener(&quot;DOMContentLoaded&quot;, function () {
        ...
        hidePreloader();
            ...
            <div class="row">
              <div class="col-md-3 mb-4">
                <div class="card">
                  <div class="card-header card-heading">Rotating Plane</div>
              ...
              <div class="col-md-3 mb-4">
                <div class="card">
                  <div class="card-header card-heading">Double Bounce</div>
                  <div class="card-body d-flex justify-content-center pt-5 pb-5">
              ...
              <div class="col-md-3 mb-4">
                <div class="card">
                  <div class="card-header card-heading">Wave</div>
                  <div class="card-body d-flex justify-content-center pt-5 pb-5">
                    <div class="sk-wave">
              ...
              <div class="col-md-3 mb-4">
                <div class="card">
                  <div class="card-header card-heading">Wandering cubes</div>
                  <div class="card-body d-flex justify-content-center pt-5 pb-5">
              ...
              <div class="col-md-3 mb-4">
                <div class="card">
                  <div class="card-header card-heading">Pulse</div>
                  <div class="card-body d-flex justify-content-center pt-5 pb-5">
              ...
              <div class="col-md-3 mb-4">
                <div class="card">
                  <div class="card-header card-heading">Chasing dots</div>
                  <div class="card-body d-flex justify-content-center pt-5 pb-5">
              ...
              <div class="col-md-3 mb-4">
                <div class="card">
                  <div class="card-header card-heading">Three bounce</div>
                  <div class="card-body d-flex justify-content-center pt-5 pb-5">
              ...
              <div class="col-md-3 mb-4">
                <div class="card">
                  <div class="card-header card-heading">Circle</div>
                  <div class="card-body d-flex justify-content-center pt-5 pb-5">
                    <div class="sk-circle">
              ...
              <div class="col-md-3 mb-4">
                <div class="card">
                  <div class="card-header card-heading">Fading circle</div>
                  <div class="card-body d-flex justify-content-center pt-5 pb-5">
              ...
              <div class="col-md-3 mb-4">
                <div class="card">
                  <div class="card-header card-heading">Folding circle</div>
                  <div class="card-body d-flex justify-content-center pt-5 pb-5">
    ...
    <!-- Preloader-->
    <script src="../lib/js/components-preloader.js"> </script>
    <!-- Main Theme JS File-->
