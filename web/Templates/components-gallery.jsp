<%-- 
    Document   : components-gallery
    Created on : 20/12/2021, 01:25:23 PM
...
<html>
  ...
  <body>
    ...
    <div class="d-flex align-items-stretch">
      <div class="sidebar py-3" id="sidebar">
        ...
        <ul class="list-unstyled">
              ...
              <li class="sidebar-list-item"><a class="sidebar-link text-muted active" href="#" data-bs-target="#componentsDropdown" role="button" aria-expanded="true" data-bs-toggle="collapse"> 
                      <svg class="svg-icon svg-icon-md me-3">
                        <use xlink:href="../../lib/icons/orion-svg-sprite.svg#sorting-1"> </use>
                      </svg><span class="sidebar-link-title">Components </span></a>
                <ul class="sidebar-menu list-unstyled collapse show" id="componentsDropdown">
                  ...
                  <li class="sidebar-list-item"><a class="sidebar-link active text-muted" href="components-gallery.jsp">Gallery</a></li>
          ...
          <section>
            <div class="row"> 
              <div class="col-6 col-md-4 col-lg-3">
                <div class="card mb-4"><a class="glightbox" href="img/photos/soroush-zargar-zFSUhqGual8-unsplash.jpg" data-gallery="gallery" data-title="Image 1"><img class="card-img-top" src="../../lib/img/photos/w-600/soroush-zargar-zFSUhqGual8-unsplash.jpg" alt="Image 1"></a>
                  <div class="card-body p-3 p-lg-4">
                    <h6 class="card-title fw-bold mb-1">Image 1</h6>
                    <p class="card-text text-muted text-sm">Image sample text</p>
                  </div>
                </div>
              </div>
              <div class="col-6 col-md-4 col-lg-3">
                <div class="card mb-4"><a class="glightbox" href="img/photos/faruk-kaymak-CNVvDjVDiVI-unsplash.jpg" data-gallery="gallery" data-title="Image 2"><img class="card-img-top" src="../../lib/img/photos/w-600/faruk-kaymak-CNVvDjVDiVI-unsplash.jpg" alt="Image 2"></a>
                  <div class="card-body p-3 p-lg-4">
                    <h6 class="card-title fw-bold mb-1">Image 2</h6>
                    <p class="card-text text-muted text-sm">Image sample text</p>
                  </div>
                </div>
              </div>
              <div class="col-6 col-md-4 col-lg-3">
                <div class="card mb-4"><a class="glightbox" href="img/photos/aron-visuals-3jBU9TbKW7o-unsplash.jpg" data-gallery="gallery" data-title="Image 3"><img class="card-img-top" src="../../lib/img/photos/w-600/aron-visuals-3jBU9TbKW7o-unsplash.jpg" alt="Image 3"></a>
                  <div class="card-body p-3 p-lg-4">
                    <h6 class="card-title fw-bold mb-1">Image 3</h6>
                    <p class="card-text text-muted text-sm">Image sample text</p>
                  </div>
                </div>
              </div>
              <div class="col-6 col-md-4 col-lg-3">
                <div class="card mb-4"><a class="glightbox" href="img/photos/elizabeth-gottwald-dnIWYrliZfU-unsplash.jpg" data-gallery="gallery" data-title="Image 4"><img class="card-img-top" src="../../lib/img/photos/w-600/elizabeth-gottwald-dnIWYrliZfU-unsplash.jpg" alt="Image 4"></a>
                  <div class="card-body p-3 p-lg-4">
                    <h6 class="card-title fw-bold mb-1">Image 4</h6>
                    <p class="card-text text-muted text-sm">Image sample text</p>
                  </div>
                </div>
              </div>
              <div class="col-6 col-md-4 col-lg-3">
                <div class="card mb-4"><a class="glightbox" href="img/photos/willian-justen-de-vasconcellos-4hMET7vYTAQ-unsplash.jpg" data-gallery="gallery" data-title="Image 5"><img class="card-img-top" src="../../lib/img/photos/w-600/willian-justen-de-vasconcellos-4hMET7vYTAQ-unsplash.jpg" alt="Image 5"></a>
                  <div class="card-body p-3 p-lg-4">
                    <h6 class="card-title fw-bold mb-1">Image 5</h6>
                    <p class="card-text text-muted text-sm">Image sample text</p>
                  </div>
                </div>
              </div>
              <div class="col-6 col-md-4 col-lg-3">
                <div class="card mb-4"><a class="glightbox" href="img/photos/sorasak-_UIN-pFfJ7c-unsplash.jpg" data-gallery="gallery" data-title="Image 6"><img class="card-img-top" src="../../lib/img/photos/w-600/sorasak-_UIN-pFfJ7c-unsplash.jpg" alt="Image 6"></a>
                  <div class="card-body p-3 p-lg-4">
                    <h6 class="card-title fw-bold mb-1">Image 6</h6>
                    <p class="card-text text-muted text-sm">Image sample text</p>
                  </div>
                </div>
              </div>
              <div class="col-6 col-md-4 col-lg-3">
                <div class="card mb-4"><a class="glightbox" href="img/photos/montylov-ktZZiHb-GoI-unsplash.jpg" data-gallery="gallery" data-title="Image 7"><img class="card-img-top" src="../../lib/img/photos/w-600/montylov-ktZZiHb-GoI-unsplash.jpg" alt="Image 7"></a>
                  <div class="card-body p-3 p-lg-4">
                    <h6 class="card-title fw-bold mb-1">Image 7</h6>
                    <p class="card-text text-muted text-sm">Image sample text</p>
                  </div>
                </div>
              </div>
              <div class="col-6 col-md-4 col-lg-3">
                <div class="card mb-4"><a class="glightbox" href="img/photos/joseph-barrientos-Ji_G7Bu1MoM-unsplash.jpg" data-gallery="gallery" data-title="Image 8"><img class="card-img-top" src="../../lib/img/photos/w-600/joseph-barrientos-Ji_G7Bu1MoM-unsplash.jpg" alt="Image 8"></a>
                  <div class="card-body p-3 p-lg-4">
                    <h6 class="card-title fw-bold mb-1">Image 8</h6>
                    <p class="card-text text-muted text-sm">Image sample text</p>
                  </div>
                </div>
              </div>
              <div class="col-6 col-md-4 col-lg-3">
                <div class="card mb-4"><a class="glightbox" href="img/photos/henrique-ferreira-RKsLQoSnuTc-unsplash.jpg" data-gallery="gallery" data-title="Image 9"><img class="card-img-top" src="../../lib/img/photos/w-600/henrique-ferreira-RKsLQoSnuTc-unsplash.jpg" alt="Image 9"></a>
                  <div class="card-body p-3 p-lg-4">
                    <h6 class="card-title fw-bold mb-1">Image 9</h6>
                    <p class="card-text text-muted text-sm">Image sample text</p>
                  </div>
                </div>
              </div>
              <div class="col-6 col-md-4 col-lg-3">
                <div class="card mb-4"><a class="glightbox" href="img/photos/luca-bravo-O453M2Liufs-unsplash.jpg" data-gallery="gallery" data-title="Image 10"><img class="card-img-top" src="../../lib/img/photos/w-600/luca-bravo-O453M2Liufs-unsplash.jpg" alt="Image 10"></a>
                  <div class="card-body p-3 p-lg-4">
                    <h6 class="card-title fw-bold mb-1">Image 10</h6>
                    <p class="card-text text-muted text-sm">Image sample text</p>
                  </div>
                </div>
              </div>
              <div class="col-6 col-md-4 col-lg-3">
                <div class="card mb-4"><a class="glightbox" href="img/photos/mesut-kaya-eOcyhe5-9sQ-unsplash.jpg" data-gallery="gallery" data-title="Image 11"><img class="card-img-top" src="../../lib/img/photos/w-600/mesut-kaya-eOcyhe5-9sQ-unsplash.jpg" alt="Image 11"></a>
                  <div class="card-body p-3 p-lg-4">
                    <h6 class="card-title fw-bold mb-1">Image 11</h6>
                    <p class="card-text text-muted text-sm">Image sample text</p>
                  </div>
                </div>
              </div>
              <div class="col-6 col-md-4 col-lg-3">
                <div class="card mb-4"><a class="glightbox" href="img/photos/stefan-stefancik-0wMmxNB6Xzc-unsplash.jpg" data-gallery="gallery" data-title="Image 12"><img class="card-img-top" src="../../lib/img/photos/w-600/stefan-stefancik-0wMmxNB6Xzc-unsplash.jpg" alt="Image 12"></a>
                  <div class="card-body p-3 p-lg-4">
                    <h6 class="card-title fw-bold mb-1">Image 12</h6>
                    <p class="card-text text-muted text-sm">Image sample text</p>
                  </div>
                </div>
              </div>
            ...
            <div class="card mb-4">
              <div class="card-header">
                <h4 class="card-heading">Lightbox</h4>
              </div>
              <div class="card-body">  
                <p> GLightbox is a pure JavaScript lightbox. It can display images, iframes, inline content and videos with optional autoplay for YouTube, Vimeo and even self hosted videos.</p>
                <p>Read more about GLightbox on its <a href="https://github.com/biati-digital/glightbox">GitHub</a>.</p>
                <p class="show-code-sample"><a data-bs-toggle="collapse" href="#codeSample">Show code sample</a></p>
                <div class="collapse" id="codeSample">
                  <pre class="code-sample"><code class="language-js">const lightbox = GLightbox({
    ...
    <script src="../../lib/js/components-gallery.js"> </script>
    <!-- Main Theme JS File-->
