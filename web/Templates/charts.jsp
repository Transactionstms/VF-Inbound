<%-- 
    Document   : charts
    Created on : 20/12/2021, 01:19:39 PM
...
<html>
  ...
  <body>
    ...
    <div class="d-flex align-items-stretch">
      <div class="sidebar py-3" id="sidebar">
        ...
        <ul class="list-unstyled">
              ...
              <li class="sidebar-list-item"><a class="sidebar-link text-muted active" href="#" data-bs-target="#chartsDropdown" role="button" aria-expanded="true" data-bs-toggle="collapse"> 
                      <svg class="svg-icon svg-icon-md me-3">
                        <use xlink:href="../lib/icons/orion-svg-sprite.svg#pie-chart-1"> </use>
                      </svg><span class="sidebar-link-title">Charts </span></a>
                <ul class="sidebar-menu list-unstyled collapse show" id="chartsDropdown">
                  <li class="sidebar-list-item"><a class="sidebar-link active text-muted" href="charts.jsp">Charts</a></li>
              ...
              <div class="col-lg-8 mb-4 mb-lg-0">
                <div class="card">
                  <div class="card-header">
                    <h4 class="card-heading">Line chart Example</h4>
                  </div>
                  <div class="card-body">
                    <p class="text-gray-500">Charts on this page use <a href="https://www.chartjs.org/">Chart.js</a> - Simple yet flexible JavaScript charting for designers & developers. </p>
                    <p class="show-code-sample text-sm"><a data-bs-toggle="collapse" href="#codeSample1">Line chart - show code sample</a></p>
                    <div class="collapse" id="codeSample1">
                      <pre class="code-sample"><code class="language-js">const lineChartCustom1 = new Chart(document.getElementById(&quot;lineChartCustom1&quot;), {
        type: &quot;line&quot;,
        options: {
            tooltips: {
                mode: &quot;index&quot;,
        ...
        data: {
            ...
            datasets: [
              ...
              <div class="col-lg-4">
                <div class="card mb-4">
                  <div class="card-header">
                    <h4 class="card-heading">Line chart with primary gradient</h4>
                  </div>
                  <div class="card-body">
                ...
                <div class="card mb-3">
                  <div class="card-header">
                    <h4 class="card-heading">Bar chart</h4>
                  </div>
                  <div class="card-body">
            ...
            <div class="row mb-4">
              <div class="col-lg-5">
                <div class="card mb-4">
                  <div class="card-header">
                    <h4 class="card-heading">Donut Chart</h4>
                  </div>
                  <div class="card-body">
                    <p class="show-code-sample text-sm"><a data-bs-toggle="collapse" href="#codeSample5">Donut chart - Show code sample</a></p>
                    <div class="collapse" id="codeSample5">
                      <pre class="code-sample"><code class="language-js">const donut1 = new Chart(document.getElementById(&quot;donut1&quot;), {
    type: &quot;doughnut&quot;,
    options: {
        cutoutPercentage: 70,
        legend: {},
        ...
        datasets: [
            {
                ...
                hoverBackgroundColor: [window.colors.cyan, &quot;#eee&quot;],
                    ...
                    <canvas class="mt-4" id="donut1"></canvas>
                  </div>
                </div>
                <div class="card mb-4">
                  <div class="card-header">
                    <h4 class="card-heading">Donut Chart 2</h4>
                  </div>
                  <div class="card-body">
                    <p class="show-code-sample text-sm"><a data-bs-toggle="collapse" href="#codeSample6">Donut chart 2 - Show code sample</a></p>
                    <div class="collapse" id="codeSample6">
                      <pre class="code-sample"><code class="language-js">const donut2 = new Chart(document.getElementById(&quot;donut2&quot;), {
    type: &quot;doughnut&quot;,
    options: {
        cutoutPercentage: 90,
        legend: {
        ...
        datasets: [
            {
                ...
                hoverBackgroundColor: [window.colors.blue, &quot;#eee&quot;],
                    ...
                    <canvas class="mt-4" id="donut2"></canvas>
                  </div>
                </div>
              </div>
              <div class="col-lg-7">
                <div class="card">
                  <div class="card-header">
                    <h4 class="card-heading">Bar chart 2                                 </h4>
                  </div>
                  <div class="card-body">
                    <p class="text-gray-500 text-sm">Lorem ipsum dolor sit amet, consectetur adipisicing elit</p>
                    <p class="show-code-sample text-sm"><a data-bs-toggle="collapse" href="#codeSample2">Bar Chart - Show code sample</a></p>
                    <div class="collapse" id="codeSample2">
                      <pre class="code-sample"><code class="language-js">const barChart2 = new Chart(document.getElementById(&quot;barChart2&quot;), {
    type: &quot;bar&quot;,
    options: {
        scales: {
            xAxes: [
        ...
        datasets: [
            ...
            <div class="row">
              <div class="col-lg-6">
                <div class="card mb-4">
                  <div class="card-header">
                    <h4 class="card-heading">Donut chart Example</h4>
                  </div>
                  <div class="card-body">
                    <p class="show-code-sample text-sm"><a data-bs-toggle="collapse" href="#codeSample3">Donut chart - Show code sample</a></p>
                    <div class="collapse" id="codeSample3">
                      <pre class="code-sample"><code class="language-js">const donut3 = new Chart(document.getElementById(&quot;donut3&quot;), {
    type: &quot;doughnut&quot;,
    options: {
        cutoutPercentage: 70,
    },
        ...
        datasets: [
            {
                ...
                hoverBackgroundColor: [&quot;#0d6efd&quot;, &quot;#3d8bfd&quot;, &quot;#6ea8fe&quot;, &quot;#9ec5fe&quot;],
                    ...
                    <canvas class="mt-4" id="donut3"></canvas>
                  </div>
                </div>
              </div>
              <div class="col-lg-6">
                <div class="card mb-4">
                  <div class="card-header">
                    <h4 class="card-heading">Pie chart Example</h4>
                  </div>
                  <div class="card-body">
                    <p class="show-code-sample text-sm"><a data-bs-toggle="collapse" href="#codeSample4">Donut chart - Show code sample</a></p>
                    <div class="collapse" id="codeSample4">
                      <pre class="code-sample"><code class="language-js">const pieChartCustom3 = new Chart(document.getElementById(&quot;pieChartCustom3&quot;), {
    type: &quot;pie&quot;,
    data: {
        ...
        datasets: [
            {
                ...
                hoverBackgroundColor: [&quot;#6610f2&quot;, &quot;#8540f5&quot;, &quot;#a370f7&quot;, &quot;#c29ffa&quot;],
                    ...
                    <canvas class="mt-4" id="pieChartCustom3"></canvas>
                  </div>
                </div>
              </div>
            </div>
    ...
    <script src="../lib/js/charts-custom.js"></script>
    <!-- Main Theme JS File-->
