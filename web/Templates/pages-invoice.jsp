<%-- 
    ...
    Created on : 20/12/2021, 01:40:12 PM
        ...
        <ul class="list-unstyled">
              ...
              <li class="sidebar-list-item"><a class="sidebar-link text-muted active" href="#" data-bs-target="#pagesDropdown" role="button" aria-expanded="true" data-bs-toggle="collapse"> 
                ...
                <ul class="sidebar-menu list-unstyled collapse show" id="pagesDropdown">
                  ...
                  <li class="sidebar-list-item"><a class="sidebar-link active text-muted" href="pages-invoice.jsp">Invoice</a></li>
      ...
      <div class="page-holder bg-gray-100">
        <div class="container-fluid px-lg-4 px-xl-5">
              ...
              <div class="page-header">
                <h1 class="page-heading">Invoice</h1>
              </div>
          <section>
            <!-- Invoice heading-->
            <div class="row mb-5">
              <div class="col-sm-6 d-sm-flex align-items-center">
                <h2 class="h4 display mb-4 mb-sm-0"> Invoice #20190204</h2>
              </div>
              <div class="col-sm-6">
                <p class="text-sm-end mb-0">
            ...
            <div class="card card-body p-5 mb-5">
              ...
              <div class="text-center mb-5">
                <!-- Logo--><img class="img-fluid mb-4" src="../lib/img/brand/brand-1.svg" alt="..." style="max-width: 6rem;">
                <!-- Heading-->
                <h2 class="mb-2">Invoice from Vintage, Ltd.</h2>
                <p class="text-muted">Invoice #20190204</p>
              </div>
              <div class="row">
              ...
              <div class="row">
                <div class="col-12">
                    ...
                    <table class="table my-4">
                      <thead>
                        <tr>
                          ...
                          <th class="px-0 bg-transparent border-top-0 text-end"><span class="h6">Cost</span></th>
                        </tr>
                      </thead>
                      <tbody>
                        <tr>
                          ...
                          <td class="px-0">50</td>
                          <td class="px-0 text-end">$9230</td>
                        </tr>
                        <tr>
                          <td class="px-0">Consulting</td>
                          <td class="px-0">3</td>
                          <td class="px-0 text-end">$333</td>
                        </tr>
                        <tr>
                          <td class="px-0 border-top"><strong>Total amount due</strong></td>
                          <td class="px-0 text-end border-top" colspan="2"><span class="h3">$9533</span></td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
                  ...
                  <p class="text-muted text-sm mb-0">One morning, when Gregor Samsa woke from troubled dreams, he found himself transformed in his bed into a horrible vermin. He lay on his armour-like back, and if he lifted his head a little he could see his brown belly, slightly domed and divided by arches into stiff sections</p>
                </div>
              </div>
            </div>
          </section>
