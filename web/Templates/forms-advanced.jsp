<%-- 
    Document   : forms-advanced
    Created on : 20/12/2021, 01:31:59 PM
    ...
    <div class="d-flex align-items-stretch">
      <div class="sidebar py-3" id="sidebar">
        ...
        <ul class="list-unstyled">
              ...
              <li class="sidebar-list-item"><a class="sidebar-link text-muted active" href="#" data-bs-target="#formsDropdown" role="button" aria-expanded="true" data-bs-toggle="collapse"> 
                      <svg class="svg-icon svg-icon-md me-3">
                        <use xlink:href="../lib/icons/orion-svg-sprite.svg#file-storage-1"> </use>
                      </svg><span class="sidebar-link-title">Forms </span></a>
                <ul class="sidebar-menu list-unstyled collapse show" id="formsDropdown">
                  <li class="sidebar-list-item"><a class="sidebar-link text-muted" href="forms.jsp">Basic forms</a></li>
                  <li class="sidebar-list-item"><a class="sidebar-link active text-muted" href="forms-advanced.jsp">Advanced forms</a></li>
      ...
      <div class="page-holder bg-gray-100">
        <div class="container-fluid px-lg-4 px-xl-5">
              ...
              <div class="page-header">
                <h1 class="page-heading">Advanced forms</h1>
              </div>
          <section>
            <div class="row">
              <div class="col-lg-6">
                ...
                <div class="card mb-4">
                  <div class="card-header">
                    <h4 class="card-heading">No UI Slider</h4>
                  </div>
                  <div class="card-body text-muted"> 
                    <p>noUiSlider is a lightweight range slider with multi-touch support and a ton of features. It supports non-linear ranges, requires no external dependencies, has keyboard support, and it works great in responsive designs. </p>
                    <p>Read more about this component at <a href="https://refreshless.com/nouislider/">GitHub</a>.</p>
                    <p class="show-code-sample"><a data-bs-toggle="collapse" href="#codeSample">Show code sample</a></p>
                    <div class="collapse" id="codeSample">
                      <pre class="code-sample"><code class="language-js">var basicNoUISlider = document.getElementById(&quot;basicNoUISlider&quot;);
if (basicNoUISlider) {
    noUiSlider.create(basicNoUISlider, {
        ...
        range: {
            ...
            max: [100],
                ...
                <div class="card mb-4">
                  <div class="card-header">
                    <h4 class="card-heading">Choices.js</h4>
                  </div>
                  <div class="card-body text-muted">
                    <p>A vanilla, lightweight, configurable select box/text input plugin. Similar to Select2 and Selectize but without the jQuery dependency.</p>
                    <p>Read more about Choices.js on <a href="https://github.com/jshjohnson/Choices">GitHub</a>.</p>
                    <p class="show-code-sample"><a data-bs-toggle="collapse" href="#codeSample3">Show code sample</a></p>
                    <div class="collapse" id="codeSample3">
                      <pre class="code-sample"><code class="language-js">const choices = new Choices(document.querySelector(&quot;.choices-1&quot;), {
    placeholder: true,
...
const multipleChoices = new Choices(&quot;#choices-multiple&quot;, {
    removeItemButton: true,
                    ...
                    <form class="form-horizontal mt-5">
                      ...
                      <div class="row mb-4">
                        <label class="col-sm-3 form-label">Text Tags</label>
                        <div class="col-sm-9">
                          <input class="form-control" id="choices-text-remove-button" type="text" value="preset-1,preset-2" placeholder="Enter something">
                        </div>
                      </div>
                      <div class="row mb-4">
                        <label class="col-sm-3 form-label">Select displayed as tags - multiple choice</label>
                        <div class="col-sm-9">
                          <select class="form-control" id="choices-multiple" name="choices-multiple" multiple>
              ...
              <div class="col-lg-6">
                ...
                <div class="card mb-4">
                  <div class="card-header">
                    <h4 class="card-heading">Datepicker</h4>
                  </div>
                  <div class="card-body text-muted">
                    <p>VanillaJS Datepicker is a vanilla JavaScript remake of bootstrap-datepicker.</p>
                    <p class="mb-4">Read more about VanillaJS Datepicker on <a href="https://github.com/mymth/vanillajs-datepicker">GitHub</a>.</p>
                    <p class="show-code-sample"><a data-bs-toggle="collapse" href="#codeSample2">Show code sample</a></p>
                    <div class="collapse" id="codeSample2">
                      <pre class="code-sample"><code class="language-js">const datepicker = new Datepicker(document.querySelector(&quot;.input-datepicker&quot;), {
    buttonClass: &quot;btn&quot;,
    format: &quot;mm/dd/yyyy&quot;,
});
...
const datepickerRange = new DateRangePicker(document.querySelector(&quot;.datepicker-range&quot;), {
    buttonClass: &quot;btn&quot;,
                    ...
                    <form>
                      <div class="mb-3">
                        <label class="form-label">Variant 1 - Date</label>
                        <input class="form-control input-datepicker" type="text" value="10/20/2017">
                      </div>
                      <div class="mb-3">
                        <label class="form-label">Variant 2 - Autoclose</label>
                        <input class="form-control input-datepicker-autoclose" type="text" value="06/22/1980">
                      </div>
                      <div class="mb-3">
                        <label class="form-label">Variant 3 - Multiple dates</label>
                        <input class="form-control input-datepicker-multiple" type="text">
                      </div>
                      <div class="mb-3">
                        <label class="form-label">Variant 4 - DateRange</label>
                        <div class="input-group datepicker-range">
                          <input class="form-control" type="text"><span class="input-group-text">To</span>
            ...
            <div class="card mb-4">
              <div class="card-header">
                <h4 class="card-heading">imask Input maps</h4>
              </div>
              <div class="card-body">
                <p class="text-muted">Input masks can be used to force the user to enter data conform a specific format. Unlike validation, the user can't enter any other key than the ones specified by the mask.</p>
                <p class="text-muted mb-4">Read more about imask at <a href="https://imask.js.org/">project's homepage</a>.</p>
                <p class="show-code-sample"><a data-bs-toggle="collapse" href="#codeSample4">Show code sample</a></p>
                <div class="collapse" id="codeSample4">
                  <pre class="code-sample"><code class="language-js">var element = document.getElementById(&quot;isbn1&quot;);
if (element) {
    var maskOptions = {
                ...
                <div class="row">
                  <div class="col-lg-6">
                    <div class="mb-3">  
                      ...
                      <input class="form-control" id="isbn1" type="text"><small class="help-block-none">e.g &quot;999-99-999-9999-9&quot;</small>
                    </div>
                    <div class="mb-3">
                      <label class="form-label">ISBN 2</label>
                      <input class="form-control" id="isbn2" type="text"><small class="help-block-none">999 99 999 9999 9</small>
                    </div>
                    <div class="mb-3">
                      <label class="form-label">ISBN 3</label>
                      <input class="form-control" id="isbn3" type="text"><small class="help-block-none">999/99/999/9999/9</small>
                    </div>
                    <div class="mb-3">
                      <label class="form-label">IPV4</label>
                      <input class="form-control" id="ip4" type="text"><small class="help-block-none">192.168.110.310</small>
                    </div>
                  </div>
                  <div class="col-lg-6">
                    <div class="mb-3">
                      <label class="form-label">Tax ID</label>
                      <input class="form-control" id="taxId" type="text"><span class="font-13 text-muted">99-123456</span>
                    </div>
                    <div class="mb-3">
                      <label class="form-label">Phone</label>
                      <input class="form-control" id="phone" type="text"><span class="font-13 text-muted">+1-907-555-0165</span>
                    </div>
                    <div class="mb-3">
                      <label class="form-label">Currency</label>
                      <input class="form-control" id="currency" type="text"><span class="font-13 text-muted">$ 999,999,999.99</span>
                    </div>
                    <div class="mb-3">
                      <label class="form-label">Date</label>
                      <input class="form-control" id="date" type="text"><span class="font-13 text-muted">1980-06-22</span>
                    </div>
                  </div>
                </div>
              </div>
