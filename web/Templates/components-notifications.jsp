<%-- 
    Document   : components-notifications
    Created on : 20/12/2021, 01:27:35 PM
        ...
        <ul class="list-unstyled">
              ...
              <li class="sidebar-list-item"><a class="sidebar-link text-muted active" href="#" data-bs-target="#componentsDropdown" role="button" aria-expanded="true" data-bs-toggle="collapse"> 
                ...
                <ul class="sidebar-menu list-unstyled collapse show" id="componentsDropdown">
                  ...
                  <li class="sidebar-list-item"><a class="sidebar-link active text-muted" href="components-notifications.jsp">Notifications</a></li>
          ...
          <section>
            <div class="card">
              <div class="card-header">
                <h4 class="card-heading">Notifications</h4>
              </div>
              <div class="card-body">
                <p class="text-muted"> Toasts are lightweight notifications designed to mimic the push notifications that have been popularized by mobile and desktop operating systems. They’re built with flexbox, so they’re easy to align and position.</p>
                <p class="text-muted">Read more about toast in the official <a href="https://getbootstrap.com/docs/5.0/components/toasts/">Bootstrap Docs</a>. </p>
...
document.addEventListener(&quot;DOMContentLoaded&quot;, function () {
    ...
    toastButtonList.map(function (toastButtonEl) {
        toastButtonEl.addEventListener(&quot;click&quot;, function () {
            ...
            if (toastToTrigger) {
                ...
                <p> 
                  <button class="btn btn-success toast-btn" type="button" data-target="liveToast">Success Message</button>
                </p>
                <p>
                  <button class="btn btn-danger toast-btn" type="button" data-target="liveToast2">Error Message</button>
                </p>
                <p>
                  <button class="btn btn-info toast-btn" type="button" data-target="liveToast3">Info Message</button>
                </p>
    ...
    <!-- Notifications Init-->
    <script src="../lib/js/components-notifications.js"> </script>
    <!-- Main Theme JS File-->
