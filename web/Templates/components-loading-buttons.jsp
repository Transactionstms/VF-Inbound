<%-- 
    Document   : components-loading-buttons
    Created on : 20/12/2021, 01:26:21 PM
...
<html>
  <head>
    ...
    <!-- Ladda-->
    <link rel="stylesheet" href="../lib/vendor/ladda/ladda-themeless.min.css">
  ...
  <body>
        ...
        <ul class="list-unstyled">
              ...
              <li class="sidebar-list-item"><a class="sidebar-link text-muted active" href="#" data-bs-target="#componentsDropdown" role="button" aria-expanded="true" data-bs-toggle="collapse"> 
                ...
                <ul class="sidebar-menu list-unstyled collapse show" id="componentsDropdown">
                  ...
                  <li class="sidebar-list-item"><a class="sidebar-link active text-muted" href="components-loading-buttons.jsp">Loading buttons</a></li>
      ...
      <div class="page-holder bg-gray-100">
        <div class="container-fluid px-lg-4 px-xl-5">
              ...
              <div class="page-header">
                <h1 class="page-heading">Loading buttons</h1>
              </div>
          <section>
            <div class="card">
              <div class="card-header">
                <h4 class="card-heading">Loading Buttons - Ladda</h4>
              </div>
              <div class="card-body">
                ...
                <p>
                  <button class="btn btn-primary ladda-button mb-1" data-style="expand-left"><span class="ladda-label">expand-left</span></button>
                  <button class="btn btn-primary ladda-button mb-1" data-style="expand-right"><span class="ladda-label">expand-right</span></button>
                  <button class="btn btn-primary ladda-button mb-1" data-style="expand-up"><span class="ladda-label">expand-up</span></button>
                  <button class="btn btn-primary ladda-button mb-1" data-style="expand-down"><span class="ladda-label">expand-down</span></button>
                </p>
                <p>
                  <button class="btn btn-info ladda-button mb-1" data-style="zoom-in"><span class="ladda-label">zoom-in</span></button>
                  <button class="btn btn-info ladda-button mb-1" data-style="zoom-out"><span class="ladda-label">zoom-out</span></button>
                </p>
                <p>
                  <button class="btn btn-warning ladda-button mb-1" data-style="slide-left"><span class="ladda-label">slide-left</span></button>
                  <button class="btn btn-warning ladda-button mb-1" data-style="slide-right"><span class="ladda-label">slide-right</span></button>
                  <button class="btn btn-warning ladda-button mb-1" data-style="slide-up"><span class="ladda-label">slide-up</span></button>
                ...
                <p class="ladda-progress-demo">
                  <button class="btn btn-danger ladda-button ladda-button-progress mb-1" data-style="expand-right"><span class="ladda-label">expand-right</span></button>
                  <button class="btn btn-danger ladda-button ladda-button-progress mb-1" data-style="expand-left"><span class="ladda-label">expand-left</span></button>
                  <button class="btn btn-danger ladda-button ladda-button-progress mb-1" data-style="slide-right"><span class="ladda-label">slide-right</span></button>
                </p>
                <h5>Sizes</h5>
                <p class="card-text">
                  <button class="btn btn-primary btn-sm ladda-button mb-1" data-style="expand-right" data-size="s"><span class="ladda-label">small</span></button>
                  <button class="btn btn-primary ladda-button mb-1" data-style="expand-right" data-size="s"><span class="ladda-label">normal</span></button>
                  <button class="btn btn-primary btn-lg ladda-button mb-1" data-style="expand-right" data-size="l"><span class="ladda-label">large</span></button>
                </p>
              </div>
            </div>
          </section>
    ...
    <!-- Loading buttons-->
    <script src="../lib/vendor/ladda/spin.min.js">   </script>
    <script src="../lib/vendor/ladda/ladda.min.js">     </script>
    <script src="../lib/js/components-ladda.js"></script>
    <!-- Main Theme JS File-->
