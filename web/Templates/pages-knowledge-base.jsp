<%-- 
    Document   : pages-knowledge-base
    Created on : 20/12/2021, 01:41:47 PM
    ...
    <div class="d-flex align-items-stretch">
      <div class="sidebar py-3" id="sidebar">
        ...
        <ul class="list-unstyled">
              ...
              <li class="sidebar-list-item"><a class="sidebar-link text-muted active" href="#" data-bs-target="#pagesDropdown" role="button" aria-expanded="true" data-bs-toggle="collapse"> 
                      <svg class="svg-icon svg-icon-md me-3">
                        <use xlink:href="../lib/icons/orion-svg-sprite.svg#paper-stack-1"> </use>
                      </svg><span class="sidebar-link-title">Pages </span></a>
                <ul class="sidebar-menu list-unstyled collapse show" id="pagesDropdown">
                  ...
                  <li class="sidebar-list-item"><a class="sidebar-link active text-muted" href="pages-knowledge-base.jsp">Knowledge base</a></li>
      ...
      <div class="page-holder bg-gray-100">
        <div class="container-fluid px-lg-4 px-xl-5">
          ...
          <div class="row py-5 gy-4">
            <div class="col-sm-6 col-xl-4 col-xxl-3 mb-3 mb-lg-0 text-center">
              <div class="card shadow-sm hover-animate h-100">
                <div class="card-body">
                  <div class="icon icon-xl mx-auto mb-4 bg-primary-light">
                        <svg class="svg-icon text-primary">
                          <use xlink:href="../lib/icons/orion-svg-sprite.svg#destination-map-1"> </use>
                        </svg>
                  </div>
                  <h3 class="h5">Help &amp; Documentation</h3>
                  <p class="text-muted text-sm card-text">One morning, when Gregor Samsa woke from troubled dreams, he found himself transformed in his bed in</p><a class="stretched-link" href="pages-knowledge-base-topic.jsp"> <span class="sr-only">See Topic        </span></a>
                </div>
              </div>
            </div>
            <div class="col-sm-6 col-xl-4 col-xxl-3 mb-3 mb-lg-0 text-center">
              <div class="card shadow-sm hover-animate h-100">
                <div class="card-body">
                  <div class="icon icon-xl mx-auto mb-4 bg-pink-light">
                        <svg class="svg-icon text-pink">
                          <use xlink:href="../lib/icons/orion-svg-sprite.svg#laptop-screen-1"> </use>
                        </svg>
                  </div>
                  <h3 class="h5">Developer Resources</h3>
                  <p class="text-muted text-sm card-text">The bedding was hardly able to cover it and seemed ready to slide off any moment. His many legs, pit</p><a class="stretched-link" href="pages-knowledge-base-topic.jsp"> <span class="sr-only">See Topic        </span></a>
                </div>
              </div>
            </div>
            <div class="col-sm-6 col-xl-4 col-xxl-3 mb-3 mb-lg-0 text-center">
              <div class="card shadow-sm hover-animate h-100">
                <div class="card-body">
                  <div class="icon icon-xl mx-auto mb-4 bg-indigo-light">
                        <svg class="svg-icon text-indigo">
                          <use xlink:href="../lib/icons/orion-svg-sprite.svg#chat-bubble-1"> </use>
                        </svg>
                  </div>
                  <h3 class="h5">Chat With Us</h3>
                  <p class="text-muted text-sm card-text">His room, a proper human room although a little too small, lay peacefully between its four familiar </p><a class="stretched-link" href="pages-knowledge-base-topic.jsp"> <span class="sr-only">See Topic        </span></a>
                </div>
              </div>
            </div>
            <div class="col-sm-6 col-xl-4 col-xxl-3 mb-3 mb-lg-0 text-center">
              <div class="card shadow-sm hover-animate h-100">
                <div class="card-body">
                  <div class="icon icon-xl mx-auto mb-4 bg-blue-light">
                        <svg class="svg-icon text-blue">
                          <use xlink:href="../lib/icons/orion-svg-sprite.svg#arrow-target-1"> </use>
                        </svg>
                  </div>
                  <h3 class="h5">FAQ</h3>
                  <p class="text-muted text-sm card-text">Samsa was a travelling salesman - and above it there hung a picture that he had recently cut out of </p><a class="stretched-link" href="pages-knowledge-base-topic.jsp"> <span class="sr-only">See Topic        </span></a>
                </div>
              </div>
            </div>
          </div>
          <div class="bg-white py-5 mx-n3 mx-lg-n4 mx-xl-n5 px-3 px-lg-4 px-xl-5">
            <div class="row my-5 px-xl-5">
              <div class="col-md-8">
                <p class="subtitle text-primary">What do you need to know?  </p>
            ...
            <div class="row gy-4 px-xl-5">
              <div class="col-lg-4 col-xxl-3">
                <h3 class="h5 text-dark d-flex align-items-center mb-4"><a class="text-reset" href="knowledge-base-topic.jsp"><span class="badge badge-primary-light py-1 me-1">12</span>Introduction</a></h3>
                <ul class="list-unstyled ms-3 text-sm">
                  <li class="mb-2"><a class="text-muted" href="knowledge-base-topic.jsp"> <i class="far fa-file me-2"></i>Sint consequat aliquip?</a></li>
                  <li class="mb-2"><a class="text-muted" href="knowledge-base-topic.jsp"> <i class="far fa-file me-2"></i>Adipisicing voluptate magna quis sunt dolor velit.</a></li>
                  <li class="mb-2"><a class="text-muted" href="knowledge-base-topic.jsp"> <i class="far fa-file me-2"></i>Ad pariatur anim magna?</a></li>
                  <li class="mb-2"><a class="text-muted" href="knowledge-base-topic.jsp"> <i class="far fa-file me-2"></i>officia aliqua fugiat ex?</a></li>
                </ul>
              </div>
              <div class="col-lg-4 col-xxl-3">
                <h3 class="h5 text-dark d-flex align-items-center mb-4"><a class="text-reset" href="knowledge-base-topic.jsp"><span class="badge badge-primary-light py-1 me-1">5</span>Usage</a></h3>
                <ul class="list-unstyled ms-3 text-sm">
                  <li class="mb-2"><a class="text-muted" href="knowledge-base-topic.jsp"> <i class="far fa-file me-2"></i>Sint consequat aliquip?</a></li>
                  <li class="mb-2"><a class="text-muted" href="knowledge-base-topic.jsp"> <i class="far fa-file me-2"></i>Adipisicing voluptate magna quis sunt dolor velit.</a></li>
                  <li class="mb-2"><a class="text-muted" href="knowledge-base-topic.jsp"> <i class="far fa-file me-2"></i>Ad pariatur anim magna?</a></li>
              ...
              <div class="col-lg-4 col-xxl-3">
                <h3 class="h5 text-dark d-flex align-items-center mb-4"><a class="text-reset" href="knowledge-base-topic.jsp"><span class="badge badge-primary-light py-1 me-1">7</span>Renting</a></h3>
                <ul class="list-unstyled ms-3 text-sm">
                  <li class="mb-2"><a class="text-muted" href="knowledge-base-topic.jsp"> <i class="far fa-file me-2"></i>Sint consequat aliquip?</a></li>
                  <li class="mb-2"><a class="text-muted" href="knowledge-base-topic.jsp"> <i class="far fa-file me-2"></i>Adipisicing voluptate magna quis sunt dolor velit.</a></li>
                  <li class="mb-2"><a class="text-muted" href="knowledge-base-topic.jsp"> <i class="far fa-file me-2"></i>Ad pariatur anim magna?</a></li>
              ...
              <div class="col-lg-4 col-xxl-3">
                <h3 class="h5 text-dark d-flex align-items-center mb-4"><a class="text-reset" href="knowledge-base-topic.jsp"><span class="badge badge-primary-light py-1 me-1">4</span>Fees</a></h3>
                <ul class="list-unstyled ms-3 text-sm">
                  <li class="mb-2"><a class="text-muted" href="knowledge-base-topic.jsp"> <i class="far fa-file me-2"></i>Sint consequat aliquip?</a></li>
                  <li class="mb-2"><a class="text-muted" href="knowledge-base-topic.jsp"> <i class="far fa-file me-2"></i>Adipisicing voluptate magna quis sunt dolor velit.</a></li>
                  <li class="mb-2"><a class="text-muted" href="knowledge-base-topic.jsp"> <i class="far fa-file me-2"></i>Ad pariatur anim magna?</a></li>
              ...
              <div class="col-lg-4 col-xxl-3">
                <h3 class="h5 text-dark d-flex align-items-center mb-4"><a class="text-reset" href="knowledge-base-topic.jsp"><span class="badge badge-primary-light py-1 me-1">5</span>Other</a></h3>
                <ul class="list-unstyled ms-3 text-sm">
                  <li class="mb-2"><a class="text-muted" href="knowledge-base-topic.jsp"> <i class="far fa-file me-2"></i>Sint consequat aliquip?</a></li>
                  <li class="mb-2"><a class="text-muted" href="knowledge-base-topic.jsp"> <i class="far fa-file me-2"></i>Adipisicing voluptate magna quis sunt dolor velit.</a></li>
                  <li class="mb-2"><a class="text-muted" href="knowledge-base-topic.jsp"> <i class="far fa-file me-2"></i>Ad pariatur anim magna?</a></li>
          ...
          <div class="row bg-gray-200 py-5 mx-n3 mx-lg-n4 mx-xl-n5 px-3 px-lg-4 px-xl-5">
            <div class="col-lg-10 col-xl-8 mx-auto text-center py-5">
              ...
              <ul class="list-unstyled d-flex flex-wrap justify-content-center">
                <li><a href="#"><img class="avatar avatar-lg p-1 hover-animate mx-2" src="../lib/img/avatar-1.jpg" alt=""></a></li>
                <li><a href="#"><img class="avatar avatar-lg p-1 hover-animate mx-2" src="../lib/img/avatar-2.jpg" alt=""></a></li>
                <li><a href="#"><img class="avatar avatar-lg p-1 hover-animate mx-2" src="../lib/img/avatar-3.jpg" alt=""></a></li>
                <li><a href="#"><img class="avatar avatar-lg p-1 hover-animate mx-2" src="../lib/img/avatar-4.jpg" alt=""></a></li>
                <li><a href="#"><img class="avatar avatar-lg p-1 hover-animate mx-2" src="../lib/img/avatar-5.jpg" alt=""></a></li>
              </ul>
            </div>
          </div>
          <div class="row">
              ...
              <div class="card border-0 shadow mt-n5 mb-5">
                <div class="card-header bg-primary-100 py-4 border-0">
                  <div class="d-flex align-items-center justify-content-between">
                    <div>
                      <p class="subtitle text-sm text-primary mb-1">Drop Us a Line</p>
                      <h4 class="mb-0">Contact</h4>
                    </div>
                        <svg class="svg-icon svg-icon svg-icon-light ms-3 text-primary flex-shrink-0 svg-icon-lg">
                          <use xlink:href="../lib/icons/orion-svg-sprite.svg#ballpoint-pen-1"> </use>
                        </svg>
                  </div>
                </div>
                <div class="card-body">
                  <p class="text-muted card-text">He must have tried it a hundred times, shut his eyes so that he wouldn't have to look at the floundering legs, and only stopped when he began to feel a mild, dull pain there that he had never felt before.</p>
                </div>
                <div class="card-footer"><a class="btn btn-outline-primary" href="#">Let us know                                </a></div>
              </div>
            </div>
          </div>
        </div>
