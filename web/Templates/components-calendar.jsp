<%-- 
    ...
    Created on : 20/12/2021, 01:22:55 PM
...
<html>
  <head>
    ...
    <!-- Full Calendar-->
    <link rel="stylesheet" href="../lib/vendor/fullcalendar/main.min.css">
        ...
        <ul class="list-unstyled">
              ...
              <li class="sidebar-list-item"><a class="sidebar-link text-muted active" href="#" data-bs-target="#componentsDropdown" role="button" aria-expanded="true" data-bs-toggle="collapse"> 
                ...
                <ul class="sidebar-menu list-unstyled collapse show" id="componentsDropdown">
                  ...
                  <li class="sidebar-list-item"><a class="sidebar-link active text-muted" href="components-calendar.jsp">Calendar</a></li>
...
document.addEventListener(&quot;DOMContentLoaded&quot;, function () {
    ...
    <script src="../lib/vendor/fullcalendar/main.min.js">   </script>
    <script src="../lib/js/components-calendar.js"></script>
    <!-- Main Theme JS File-->
