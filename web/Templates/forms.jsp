<%-- 
    Document   : forms
    Created on : 20/12/2021, 01:35:45 PM
        ...
        <ul class="list-unstyled">
              ...
              <li class="sidebar-list-item"><a class="sidebar-link text-muted active" href="#" data-bs-target="#formsDropdown" role="button" aria-expanded="true" data-bs-toggle="collapse"> 
                ...
                <ul class="sidebar-menu list-unstyled collapse show" id="formsDropdown">
                  <li class="sidebar-list-item"><a class="sidebar-link active text-muted" href="forms.jsp">Basic forms</a></li>
          ...
          <section>
            <div class="row">
              ...
              <div class="col-lg-6 mb-5">
                <div class="card">
                  <div class="card-header">
                    <h4 class="card-heading">Basic Form</h4>
                  </div>
                  <div class="card-body">
              ...
              <div class="col-lg-6 mb-5">
                <div class="card">
                  <div class="card-header">
                    <h4 class="card-heading">Horizontal Form</h4>
                  </div>
                  <div class="card-body">
                    <p>Lorem ipsum dolor sit amet consectetur.</p>
                    <form class="form-horizontal">
                      <div class="row mb-3">
                        ...
                        <div class="col-md-9">
                          <input class="form-control form-control-success" id="inputHorizontalSuccess" type="email" placeholder="Email Address"><small class="form-text text-muted ms-3">Example help text that remains unchanged.</small>
                        </div>
                      </div>
                      <div class="row mb-3">
                        <label class="col-sm-3 form-label">Password</label>
                        <div class="col-md-9">
                          <input class="form-control form-control-warning" id="inputHorizontalWarning" type="password" placeholder="Pasword"><small class="form-text text-muted ms-3">Example help text that remains unchanged.</small>
                        </div>
                      </div>
                      <div class="row mb-3">
              ...
              <div class="col-lg-8 mb-5">                           
                <div class="card">
                  <div class="card-header">
                    <h4 class="card-heading">Inline Form</h4>
                  </div>
                  <div class="card-body">
                    <form class="row row-cols-lg-auto g-3 align-items-center">
                      ...
                      <div class="col-12">
                        <div class="input-group"><span class="input-group-text">@</span>
                          <input class="form-control" id="inlineFormInputGroupUsername2" type="text" placeholder="Email">
                        </div>
                      </div>
                      <div class="col-12">
              ...
              <div class="col-lg-6 mb-5">
                <div class="card">
                  <div class="card-header">
                    <h4 class="card-heading">Inputs with floating labels</h4>
                  </div>
                  <div class="card-body">
                    <form>   
              ...
              <div class="col-lg-4 mb-5">
                <div class="card">
                  <div class="card-header">
                    <h4 class="card-heading">Modal Form</h4>
                  </div>
                  <div class="card-body">
                    <button class="btn btn-primary" type="button" data-bs-toggle="modal" data-bs-target="#myModal">Form in a simple modal </button>
                    <!-- Modal-->
                    <div class="modal fade text-start" id="myModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          <div class="modal-header border-0 bg-gray-100">
                            <h3 class="h5 text-uppercase modal-title" id="exampleModalLabel">Signin Modal</h3>
              ...
              <div class="col-lg-12 mb-5">
                <div class="card">
                  <div class="card-header">
                    <h4 class="card-heading">All form elements</h4>
                  </div>
                  <div class="card-body">
                    <form class="form-horizontal">
                      <div class="row">
                        <label class="col-md-3 form-label">Normal</label>
                        <div class="col-md-9">
                      ...
                      <div class="row">
                        <label class="col-md-3 form-label">Help text</label>
                        <div class="col-md-9">
                          <input class="form-control" type="text"><small class="form-text text-muted">A block of help text that breaks onto a new line and may extend beyond one line.</small>
                        </div>
                      </div>
                      <hr class="bg-gray-400 my-4">
                      <div class="row">
                      ...
                      <hr class="bg-gray-400 my-4">
                      <div class="row">
                        <label class="col-md-3 form-label">Ranges</label>
                        <div class="col-md-9">
                          <label for="formControlRange">Example Range</label>
                          <input class="form-range" id="formControlRange" type="range">
                        </div>
                      </div>
                      <hr class="bg-gray-400 my-4">
                      <div class="row">
                      ...
                      <hr class="bg-gray-400 my-4">
                      <div class="row">
                        <label class="col-md-3 form-label">Checkboxes &amp; radios <br><small class="text-primary">Bootstrap 5 custom controls</small></label>
                        <div class="col-md-9">
                      ...
                      <hr class="bg-gray-400 my-4">
                      <div class="row">
                        <label class="col-md-3 form-label">Select</label>
                        ...
                        <div class="col-md-9 ms-auto select">
                          <select class="form-control rounded" multiple="">
                            <option>option 1</option>
                            <option>option 2</option>
                            <option>option 3</option>
                            <option>option 4</option>
                      ...
                      <hr class="bg-gray-400 my-4">
                      <div class="row">
                        <label class="col-md-3 form-label">Control sizing</label>
                        <div class="col-md-9">
                          <div class="mb-3">
                      ...
                      <hr class="bg-gray-400 my-4">
                      <div class="row">
                        <label class="col-md-3 form-label">Column sizing</label>
                        <div class="col-md-9">
                          <div class="row">
                            <div class="col-md-3">
                      ...
                      <hr class="bg-gray-400 my-4">
                      <div class="row">
                        <label class="col-md-3 form-label">Input groups</label>
                        <div class="col-md-9">
                          <div class="mb-3">
                          ...
                          <div class="mb-3">
                            <div class="input-group">
                              <input class="form-control" type="text" aria-label="Dollar amount (with dot and two decimal places)"><span class="input-group-text">$</span>
                            </div>
                          </div>
                          <div class="mb-3">
                            <div class="input-group mb-3"><span class="input-group-text">$</span>
                      ...
                      <hr class="bg-gray-400 my-4">
                      <div class="row">
                        <label class="col-md-3 form-label">Button addons</label>
                        <div class="col-md-9">
                          <div class="mb-3">
                            <div class="input-group mb-3">
                              <button class="btn btn-outline-primary" id="button-addon1" type="button">Button</button>
                          ...
                          <div class="mb-3">
                            <div class="input-group mb-3">
                              ...
                              <button class="btn btn-outline-info" id="button-addon2" type="button">Button</button>
                            </div>
                          </div>
                        </div>
                      </div>
                      <hr class="bg-gray-400 my-4">
                      <div class="row">
                        <label class="col-md-3 form-label">With dropdowns</label>
                        <div class="col-md-9">
                          <div class="input-group mb-3">
