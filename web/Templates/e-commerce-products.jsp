<%-- 
    Document   : e-commerce-products
    Created on : 20/12/2021, 01:31:05 PM
        ...
        <ul class="list-unstyled">
              ...
              <li class="sidebar-list-item"><a class="sidebar-link text-muted active" href="#" data-bs-target="#e-commerceDropdown" role="button" aria-expanded="true" data-bs-toggle="collapse"> 
                ...
                <ul class="sidebar-menu list-unstyled collapse show" id="e-commerceDropdown">
                  <li class="sidebar-list-item"><a class="sidebar-link active text-muted" href="e-commerce-products.jsp">Products</a></li>
      ...
      <div class="page-holder bg-gray-100">
        <div class="container-fluid px-lg-4 px-xl-5">
          ...
          <div class="page-header d-flex justify-content-between align-items-center">
            ...
            <div><a class="btn btn-primary text-uppercase" href="e-commerce-product-new.jsp"> <i class="fa fa-plus me-2"> </i>Add new</a></div>
          </div>
          <section class="mb-5">
                ...
                <table class="table table-hover table-borderless align-middle mb-0" id="productsDatatable">
                  ...
                  <tbody>
                    <tr class="align-middle">
                      ...
                      <td>$22.00</td>
                      <td>43</td>
                      <td class="text-muted">2021/03/05</td>
                      <td>
                    ...
                    <tr class="align-middle">
                      ...
                      <td>$22.00</td>
                      <td>44</td>
                      <td class="text-muted">2021/01/04</td>
                      <td>
                      </td>
                      <td><a class="me-3 text-lg text-success" href="#!"><i class="far fa-edit"></i></a><a class="text-lg text-danger" href="#!"><i class="far fa-trash-alt"></i></a></td>
                    </tr>
                    <tr class="align-middle">
                      ...
                      <td>$22.00</td>
                      <td>45</td>
                      <td class="text-muted">2021/01/22</td>
                      <td>
                    ...
                    <tr class="align-middle">
                      ...
                      <td>$22.00</td>
                      <td>46</td>
                      <td class="text-muted">2021/05/06</td>
                      <td>
                      </td>
                      <td><a class="me-3 text-lg text-success" href="#!"><i class="far fa-edit"></i></a><a class="text-lg text-danger" href="#!"><i class="far fa-trash-alt"></i></a></td>
                    </tr>
                    <tr class="align-middle">
                      ...
                      <td>$22.00</td>
                      <td>47</td>
                      <td class="text-muted">2021/11/17</td>
                      <td>
                      </td>
                      <td><a class="me-3 text-lg text-success" href="#!"><i class="far fa-edit"></i></a><a class="text-lg text-danger" href="#!"><i class="far fa-trash-alt"></i></a></td>
                    </tr>
                    <tr class="align-middle">
                      ...
                      <td>$22.00</td>
                      <td>48</td>
                      <td class="text-muted">2021/06/24</td>
                      <td>
                    ...
                    <tr class="align-middle">
                      <td>#2574</td>
                      <td> <img class="card-table-img img-fluid me-3" src="../lib/img/product/product-7.jpg" alt="" width="80"><a class="text-reset text-decoration-none" href="#!"><strong>Apple wireless keyboard</strong></a></td>
                      <td>$22.00</td>
                      <td>49</td>
                      <td class="text-muted">2021/04/03</td>
                      <td>
                      </td>
                      <td><a class="me-3 text-lg text-success" href="#!"><i class="far fa-edit"></i></a><a class="text-lg text-danger" href="#!"><i class="far fa-trash-alt"></i></a></td>
                    </tr>
                    <tr class="align-middle">
                      <td>#2575</td>
                      <td> <img class="card-table-img img-fluid me-3" src="../lib/img/product/product-8.jpg" alt="" width="80"><a class="text-reset text-decoration-none" href="#!"><strong>Black Canon EOS camera</strong></a></td>
                      <td>$22.00</td>
                      <td>50</td>
                    ...
                    <tr class="align-middle">
                      <td>#2576</td>
                      <td> <img class="card-table-img img-fluid me-3" src="../lib/img/product/product-9.jpg" alt="" width="80"><a class="text-reset text-decoration-none" href="#!"><strong>Silver round analog watch</strong></a></td>
                      <td>$22.00</td>
                      <td>51</td>
                      <td class="text-muted">2021/02/19</td>
                      <td>
                        <label class="badge badge-primary-light">New Arrival</label>
                      </td>
                      <td><a class="me-3 text-lg text-success" href="#!"><i class="far fa-edit"></i></a><a class="text-lg text-danger" href="#!"><i class="far fa-trash-alt"></i></a></td>
                    ...
                    <tr class="align-middle">
                      <td>#2577</td>
                      <td> <img class="card-table-img img-fluid me-3" src="../lib/img/product/product-10.jpg" alt="" width="80"><a class="text-reset text-decoration-none" href="#!"><strong>Apple Watch</strong></a></td>
                      <td>$22.00</td>
                      <td>52</td>
                      <td class="text-muted">2021/06/06</td>
                      <td>
                      </td>
                      <td><a class="me-3 text-lg text-success" href="#!"><i class="far fa-edit"></i></a><a class="text-lg text-danger" href="#!"><i class="far fa-trash-alt"></i></a></td>
                    </tr>
                    <tr class="align-middle">
                      <td>#2578</td>
                      <td> <img class="card-table-img img-fluid me-3" src="../lib/img/product/product-11.jpg" alt="" width="80"><a class="text-reset text-decoration-none" href="#!"><strong>Joemalone Women prefume</strong></a></td>
                      <td>$22.00</td>
                      <td>53</td>
                      <td class="text-muted">2021/10/14</td>
                      <td>
                        <label class="badge badge-info-light">Trending</label>
                      </td>
                      <td><a class="me-3 text-lg text-success" href="#!"><i class="far fa-edit"></i></a><a class="text-lg text-danger" href="#!"><i class="far fa-trash-alt"></i></a></td>
                    ...
                    <tr class="align-middle">
                      <td>#2579</td>
                      <td> <img class="card-table-img img-fluid me-3" src="../lib/img/product/product-12.jpg" alt="" width="80"><a class="text-reset text-decoration-none" href="#!"><strong>Nike air max 95</strong></a></td>
                      <td>$22.00</td>
                      <td>54</td>
                      <td class="text-muted">2021/01/23</td>
                      <td>
                      </td>
                      <td><a class="me-3 text-lg text-success" href="#!"><i class="far fa-edit"></i></a><a class="text-lg text-danger" href="#!"><i class="far fa-trash-alt"></i></a></td>
                    </tr>
                    <tr class="align-middle">
                      <td>#2580</td>
                      <td> <img class="card-table-img img-fluid me-3" src="../lib/img/product/product-13.jpg" alt="" width="80"><a class="text-reset text-decoration-none" href="#!"><strong>Red digital smartwatch</strong></a></td>
                      <td>$22.00</td>
                      <td>55</td>
                      <td class="text-muted">2021/01/14</td>
                      <td>
                        <label class="badge badge-danger-light">Soldout</label>
                      </td>
                      <td><a class="me-3 text-lg text-success" href="#!"><i class="far fa-edit"></i></a><a class="text-lg text-danger" href="#!"><i class="far fa-trash-alt"></i></a></td>
                    ...
                    <tr class="align-middle">
                      <td>#2581</td>
                      <td> <img class="card-table-img img-fluid me-3" src="../lib/img/product/product-14.jpg" alt="" width="80"><a class="text-reset text-decoration-none" href="#!"><strong>Air Jordan 12 gym red</strong></a></td>
                      <td>$22.00</td>
                      <td>56</td>
                      <td class="text-muted">2021/08/20</td>
                      <td>
                      </td>
                      <td><a class="me-3 text-lg text-success" href="#!"><i class="far fa-edit"></i></a><a class="text-lg text-danger" href="#!"><i class="far fa-trash-alt"></i></a></td>
                    </tr>
                    <tr class="align-middle">
                      <td>#2582</td>
                      <td> <img class="card-table-img img-fluid me-3" src="../lib/img/product/product-15.jpg" alt="" width="80"><a class="text-reset text-decoration-none" href="#!"><strong>Kui Ye Chen’s AirPods</strong></a></td>
                      <td>$22.00</td>
                      <td>57</td>
                      <td class="text-muted">2021/08/04</td>
                      <td>
                    ...
                    <tr class="align-middle">
                      ...
                      <td>$22.00</td>
                      <td>58</td>
                      <td class="text-muted">2021/06/11</td>
                      <td>
                      </td>
                      <td><a class="me-3 text-lg text-success" href="#!"><i class="far fa-edit"></i></a><a class="text-lg text-danger" href="#!"><i class="far fa-trash-alt"></i></a></td>
                    </tr>
