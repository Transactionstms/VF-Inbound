<%-- 
    Document   : forms-dropzone
    Created on : 20/12/2021, 01:32:50 PM
...
<html>
  ...
  <body>
        ...
        <ul class="list-unstyled">
              ...
              <li class="sidebar-list-item"><a class="sidebar-link text-muted active" href="#" data-bs-target="#formsDropdown" role="button" aria-expanded="true" data-bs-toggle="collapse"> 
                ...
                <ul class="sidebar-menu list-unstyled collapse show" id="formsDropdown">
                  ...
                  <li class="sidebar-list-item"><a class="sidebar-link active text-muted" href="forms-dropzone.jsp">Files upload</a></li>
      ...
      <div class="page-holder bg-gray-100">
        <div class="container-fluid px-lg-4 px-xl-5">
              ...
              <div class="page-header">
                <h1 class="page-heading">Multiple files upload</h1>
              </div>
          <section>
            <div class="card">
              <div class="card-header">
                <h4 class="card-heading">Multiple files upload - Dropzone.js</h4>
              </div>
              <div class="card-body">  
                ...
                <div class="collapse" id="codeSample4">
                  <pre class="code-sample"><code class="language-js">const dropzone = new Dropzone(&quot;#demo-upload&quot;, {
        parallelUploads: 2,
        thumbnailHeight: 120,
        thumbnailWidth: 120,
        maxFilesize: 3,
        ...
        thumbnail: function (file, dataUrl) {
            if (file.previewElement) {
                ...
                <div class="row">
                  <div class="col-xl-8">
                    <form class="dropzone" id="demo-upload" action="#">
    ...
    <!-- Dropzone Init-->
    <script src="../lib/js/forms-dropzone.js">    </script>
    <!-- Main Theme JS File-->
