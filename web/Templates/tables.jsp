<%-- 
    Document   : tables
    Created on : 20/12/2021, 01:45:15 PM
        ...
        <ul class="list-unstyled">
              ...
              <li class="sidebar-list-item"><a class="sidebar-link text-muted active" href="#" data-bs-target="#tablesDropdown" role="button" aria-expanded="true" data-bs-toggle="collapse"> 
                ...
                <ul class="sidebar-menu list-unstyled collapse show" id="tablesDropdown">
                  <li class="sidebar-list-item"><a class="sidebar-link active text-muted" href="tables.jsp">Bootstrap tables</a></li>
          ...
          <section>
            <div class="row">
              <div class="col-lg-6">
                <div class="card mb-4">
                  <div class="card-header">
                    <h4 class="card-heading">Basic Table</h4>
                  </div>
                  <div class="card-body">
              ...
              <div class="col-lg-6">
                <div class="card mb-4">
                  <div class="card-header">
                    <h4 class="card-heading">Striped Table</h4>
                  </div>
                  <div class="card-body">                           
              ...
              <div class="col-lg-6">
                <div class="card mb-4">
                  <div class="card-header">
                    <h4 class="card-heading">Striped table with hover effect</h4>
                  </div>
                  <div class="card-body">                           
              ...
              <div class="col-lg-6">
                <div class="card mb-4">
                  <div class="card-header">
                    <h4 class="card-heading">Compact Table</h4>
                  </div>
                  <div class="card-body">                          
