<%-- 
    Document   : forms-texteditor
    Created on : 20/12/2021, 01:34:49 PM
...
<html>
  <head>
    ...
    <link rel="stylesheet" href="../lib/vendor/quill/quill.bubble.css">
        ...
        <ul class="list-unstyled">
              ...
              <li class="sidebar-list-item"><a class="sidebar-link text-muted active" href="#" data-bs-target="#formsDropdown" role="button" aria-expanded="true" data-bs-toggle="collapse"> 
                ...
                <ul class="sidebar-menu list-unstyled collapse show" id="formsDropdown">
                  ...
                  <li class="sidebar-list-item"><a class="sidebar-link active text-muted" href="forms-texteditor.jsp">Text editor</a></li>
      ...
      <div class="page-holder bg-gray-100">
        <div class="container-fluid px-lg-4 px-xl-5">
              ...
              <div class="page-header">
                <h1 class="page-heading">Text editor</h1>
              </div>
          <section>
            <div class="card mb-4">
              <div class="card-header">
                <h4 class="card-heading">Text Editor - Quill</h4>
              </div>
              <div class="card-body">  
                <div class="row">
                  <div class="col-xl-10">        
                    <p class="text-muted">Your powerful rich text editor.  Supports all modern browsers on desktops, tablets and phones. Experience the same consistent behavior and produced HTML across platforms. Read more at <a href="https://quilljs.com/">https://quilljs.com/</a>.</p>
                    ...
                    <div class="collapse" id="codeSample4">
                      <pre class="code-sample"><code class="language-js">&quot;use strict&quot;;
...
document.addEventListener(&quot;DOMContentLoaded&quot;, function () {
    ...
    var quillBubble = new Quill(&quot;#editorBubble&quot;, {
        theme: &quot;bubble&quot;, // Specify theme in configuration
                    ...
                    <div class="my-4" id="editorWithToolbar">
                    ...
                    <div class="border" id="editorBubble" style="height: 300px;"></div>
                  </div>
                </div>
              </div>
            </div>
    ...
    <!-- Quill init-->
    <script src="../lib/js/forms-texteditor.js"></script>
    <!-- Main Theme JS File-->
