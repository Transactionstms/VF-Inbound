<%-- 
    Document   : index
    Created on : 20/12/2021, 01:15:46 PM
    ...
    <div class="d-flex align-items-stretch">
      <div class="sidebar py-3" id="sidebar">
        ...
        <ul class="list-unstyled">
              <li class="sidebar-list-item"><a class="sidebar-link text-muted active" href="index.jsp">
              ...
              <li class="sidebar-list-item"><a class="sidebar-link text-muted " href="#" data-bs-target="#pagesDropdown" role="button" aria-expanded="false" data-bs-toggle="collapse"> 
                      ...
                      </svg><span class="sidebar-link-title">Páginas </span></a>
              ...
              <li class="sidebar-list-item"><a class="sidebar-link text-muted " href="#" data-bs-target="#userDropdown" role="button" aria-expanded="false" data-bs-toggle="collapse"> 
                      ...
                      </svg><span class="sidebar-link-title">Usuarios </span></a>
              ...
              <li class="sidebar-list-item"><a class="sidebar-link text-muted " href="#" data-bs-target="#componentsDropdown" role="button" aria-expanded="false" data-bs-toggle="collapse"> 
                      ...
                      </svg><span class="sidebar-link-title">Componentes </span></a>
              ...
              <li class="sidebar-list-item"><a class="sidebar-link text-muted " href="#" data-bs-target="#chartsDropdown" role="button" aria-expanded="false" data-bs-toggle="collapse"> 
                      ...
                      </svg><span class="sidebar-link-title">Gráficas </span></a>
              ...
              <li class="sidebar-list-item"><a class="sidebar-link text-muted " href="#" data-bs-target="#formsDropdown" role="button" aria-expanded="false" data-bs-toggle="collapse"> 
                      ...
                      </svg><span class="sidebar-link-title">Formularios </span></a>
              ...
              <li class="sidebar-list-item"><a class="sidebar-link text-muted " href="#" data-bs-target="#tablesDropdown" role="button" aria-expanded="false" data-bs-toggle="collapse"> 
                      ...
                      </svg><span class="sidebar-link-title">Tablas </span></a>
      ...
      <div class="page-holder bg-gray-100">
        <div class="container-fluid px-lg-4 px-xl-5">
              ...
              <div class="col-xl-3 col-md-6 mb-4">
                <div class="card-widget h-100">
                  <div class="card-widget-body">
                    ...
                    <div class="text">
                      <h6 class="mb-0">Datos consumidos</h6><span class="text-gray-500">145,14 GB</span>
                    </div>
                  </div>
              ...
              <div class="col-xl-3 col-md-6 mb-4">
                <div class="card-widget h-100">
                  <div class="card-widget-body">
                    ...
                    <div class="text">
                      <h6 class="mb-0">Casos abiertos</h6><span class="text-gray-500">32</span>
                    </div>
                  </div>
              ...
              <div class="col-xl-3 col-md-6 mb-4">
                <div class="card-widget h-100">
                  <div class="card-widget-body">
                    ...
                    <div class="text">
                      <h6 class="mb-0">Órdenes de trabajo</h6><span class="text-gray-500">400</span>
                    </div>
                  </div>
              ...
              <div class="col-xl-3 col-md-6 mb-4">
                <div class="card-widget h-100">
                  <div class="card-widget-body">
                    ...
                    <div class="text">
                      <h6 class="mb-0">Nuevas facturas</h6><span class="text-gray-500">123</span>
                    </div>
                  </div>
          ...
          <section class="mb-4 mb-lg-5">
            <h2 class="section-heading section-heading-ms mb-4 mb-lg-5">Finanzas 💰</h2>
            <div class="row">
              <div class="col-lg-7 mb-4 mb-lg-0">
                <div class="card h-100">
                  <div class="card-header">
                    <h4 class="card-heading">El saldo de su cuenta</h4>
                  </div>
                  <div class="card-body">
                    ...
                    <div class="card-body d-flex">
                      <div class="row w-100 align-items-center">
                        <div class="col-sm-5 mb-4 mb-sm-0">
                          <h2 class="mb-0 d-flex align-items-center"><span>86.4</span><span class="dot bg-green d-inline-block ms-3"></span></h2><span class="text-muted text-uppercase small">Horas de Trabajo</span>
                          <hr><small class="text-muted">Horas trabajadas este mes</small>
                        </div>
                        <div class="col-sm-7">
                ...
                <div class="h-50 pt-lg-2">
                  <div class="card h-100">
                    <div class="card-body d-flex">
                      <div class="row w-100 align-items-center">
                        <div class="col-sm-5 mb-4 mb-sm-0">
                          <h2 class="mb-0 d-flex align-items-center"><span>325</span><span class="dot bg-indigo d-inline-block ms-3"></span></h2><span class="text-muted text-uppercase small">Tareas realizadas</span>
                          <hr><small class="text-muted">Tareas realizadas este mes</small>
                        </div>
                        <div class="col-sm-7">
          ...
          <section class="mb-4 mb-lg-5">
            <h2 class="section-heading section-heading-ms mb-4 mb-lg-5">Uso 📈   </h2>
            <div class="row">
              <div class="col-lg-5 mb-4 mb-lg-0">
                <div class="h-50 pb-4 pb-lg-2">
                  <div class="card h-100">
                    <div class="card-body d-flex">
                      <div class="row w-100 align-items-center">
                        <div class="col-sm-5 mb-4 mb-sm-0">
                          ...
                          <hr><small class="text-muted">Uso mensual permitido</small>
                        </div>
                        <div class="col-sm-7">
              ...
              <div class="col-lg-7">
                <div class="card">
                  <div class="card-header">
                    <h4 class="card-heading">Sus referencias</h4>
                  </div>
                  <div class="card-body">
          ...
          <section class="mb-4 mb-lg-5">
            <h2 class="section-heading section-heading-ms mb-4 mb-lg-5">Tarjetas vinculadas 💳 </h2>
                  ...
                  <div class="credict-card-content">
                    ...
                    <div class="credict-card-bottom">
                      <div class="text-uppercase flex-shrink-0 me-1 mb-1">
                        <div class="fw-bold">Número de tarjeta</div><small class="text-gray-500">1245 1478 1362 6985</small>
                      </div>
              ...
              <div class="col-md-6 col-xl-4 mb-4">
                <div class="card credit-card bg-hover-gradient-blue">
                  <div class="credict-card-content">
                    ...
                    <div class="credict-card-bottom">
                      <div class="text-uppercase flex-shrink-0 me-1 mb-1">
                        <div class="fw-bold">Número de la tarjeta</div><small class="text-gray-500">1245 1478 1362 6985</small>
                      </div>
          ...
          <section class="mb-4 mb-lg-5">
            <h2 class="section-heading section-heading-ms mb-4 mb-lg-5">Actualizaciones 🆕 </h2>
            <div class="row">
              <div class="col-lg-7 col-xl-6 mb-5 mb-lg-0">   
                <div class="card h-100"> 
                  <div class="card-header">
                    <h4 class="card-heading">Historial de transacciones</h4>
                  </div>
                  <div class="card-body">
          ...
          <section class="mb-4">
            ...
            <div class="row">
              <div class="col-sm-6 col-xl-12"><a class="message card px-5 py-3 mb-4 bg-hover-gradient-primary text-decoration-none text-reset" href="#">
                  <div class="row">
                    <div class="col-xl-3 d-flex align-items-center flex-column flex-xl-row text-center text-md-left"><strong class="h5 mb-0">24<sup class="text-xs text-gray-500 font-weight-normal ms-1">Apr</sup></strong><img class="avatar avatar-md p-1 mx-3 my-2 my-xl-0" src="../lib/img/avatar-1.jpg" alt="..." style="max-width: 3rem">
              ...
              <div class="col-sm-6 col-xl-12"><a class="message card px-5 py-3 mb-4 bg-hover-gradient-primary text-decoration-none text-reset" href="#">
                  <div class="row">
                    <div class="col-xl-3 d-flex align-items-center flex-column flex-xl-row text-center text-md-left"><strong class="h5 mb-0">24<sup class="text-xs text-gray-500 font-weight-normal ms-1">Nov</sup></strong><img class="avatar avatar-md p-1 mx-3 my-2 my-xl-0" src="../lib/img/avatar-2.jpg" alt="..." style="max-width: 3rem">
              ...
              <div class="col-sm-6 col-xl-12"><a class="message card px-5 py-3 mb-4 bg-hover-gradient-primary text-decoration-none text-reset" href="#">
                  <div class="row">
                    <div class="col-xl-3 d-flex align-items-center flex-column flex-xl-row text-center text-md-left"><strong class="h5 mb-0">17<sup class="text-xs text-gray-500 font-weight-normal ms-1">Aug</sup></strong><img class="avatar avatar-md p-1 mx-3 my-2 my-xl-0" src="../lib/img/avatar-3.jpg" alt="..." style="max-width: 3rem">
              ...
              <div class="col-sm-6 col-xl-12"><a class="message card px-5 py-3 mb-4 bg-hover-gradient-primary text-decoration-none text-reset" href="#">
                  <div class="row">
                    <div class="col-xl-3 d-flex align-items-center flex-column flex-xl-row text-center text-md-left"><strong class="h5 mb-0">15<sup class="text-xs text-gray-500 font-weight-normal ms-1">Sep</sup></strong><img class="avatar avatar-md p-1 mx-3 my-2 my-xl-0" src="../lib/img/avatar-4.jpg" alt="..." style="max-width: 3rem">
