<%-- 
    Document   : components-cards
    Created on : 20/12/2021, 01:24:18 PM
        ...
        <ul class="list-unstyled">
              ...
              <li class="sidebar-list-item"><a class="sidebar-link text-muted active" href="#" data-bs-target="#componentsDropdown" role="button" aria-expanded="true" data-bs-toggle="collapse"> 
                ...
                <ul class="sidebar-menu list-unstyled collapse show" id="componentsDropdown">
                  <li class="sidebar-list-item"><a class="sidebar-link active text-muted" href="components-cards.jsp">Cards</a></li>
          ...
          <section>
            <div class="row">
              <div class="col-md-6 col-lg-3">
                <!-- Simple card-->
                <div class="card mb-4"><img class="card-img-top img-fluid" src="../lib/img/mockup1.jpg" alt="Card image cap">
                  <div class="card-body">
                    <h5 class="card-title">Card title</h5>
                    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p><a class="btn btn-primary" href="#">Button</a>
                  </div>
                </div>
              </div>
              <!-- end col-->
              <div class="col-md-6 col-lg-3">
                <div class="card mb-4"><img class="card-img-top img-fluid" src="../lib/img/mockup3.jpg" alt="Card image cap">
                  <div class="card-body">
                    <h5 class="card-title">Card title</h5>
                    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                  </div>
                  <ul class="list-group list-group-flush">
                    <li class="list-group-item text-muted">Vice tote bag shabby chic  </li>
                    <li class="list-group-item text-muted">Portland Etsy craft beer</li>
                  </ul>
                  <div class="card-body"><a class="card-link" href="#">Card link</a><a class="card-link" href="#">Another link here</a></div>
                </div>
              </div>
              <!-- end col-->
              <div class="col-md-6 col-lg-3">
                <div class="card mb-4"><img class="card-img-top img-fluid" src="../lib/img/mockup4.jpg" alt="Card image cap">
                  <div class="card-body">
                    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                  </div>
                </div>
              ...
              <div class="col-md-6 col-lg-3">
                <div class="card mb-4">
                  ...
                  </div><img class="img-fluid" src="../lib/img/mockup5.jpg" alt="Card image cap">
                  <div class="card-body">
            ...
            <div class="row">
              ...
              <div class="col-md-4">
                <div class="card mb-4">
                  ...
                  <div class="card-body">
                    <h4 class="card-title">Special title treatment</h4>
                    <p class="card-text">With supporting text below as a natural lead-in to additional content.</p><a class="btn btn-dark" href="#">Go somewhere</a>
                  </div>
                  <div class="card-footer text-muted">2 days ago</div>
                </div>
              </div>
            ...
            <div class="row">
              <div class="col-md-4">
                <div class="card mb-4"><img class="card-img-top img-fluid" src="../lib/img/mockup6.jpg" alt="Card image cap">
                  <div class="card-body">
                    <h5 class="card-title">Card title</h5>
                    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
              ...
              <div class="col-md-4">
                <div class="card mb-4">
                  <div class="card-body">
                    ...
                    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                    <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>
                  </div><img class="card-img-bottom img-fluid" src="../lib/img/mockup7.jpg" alt="Card image cap">
                </div>
              </div>
              <div class="col-md-4">
                <div class="card card-inverse text-white mb-4"><img class="card-img img-fluid" src="../lib/img/mockup4.jpg" alt="Card image">
            ...
            <div class="row">
              <div class="col-md-4">
                <div class="card mb-4 bg-primary text-white">
                  <div class="card-header card-header-transparent card-heading">primary card</div>
                  <div class="card-body">
                    <h5 class="card-title">Some additional title here</h5>
                    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                  </div>
                </div>
              </div>
              <div class="col-md-4">
                <div class="card mb-4 bg-secondary text-white">
                  <div class="card-header card-header-transparent card-heading">secondary card</div>
                  <div class="card-body">
                    <h5 class="card-title">Some additional title here</h5>
                    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                  </div>
              ...
              <div class="col-md-4">
                <div class="card mb-4 bg-success text-white">
                  <div class="card-header card-header-transparent card-heading">success card</div>
                  <div class="card-body">
                    <h5 class="card-title">Some additional title here</h5>
                    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                  </div>
              ...
              <div class="col-md-4">
                <div class="card mb-4 bg-danger text-white">
                  <div class="card-header card-header-transparent card-heading">danger card</div>
                  <div class="card-body">
                    <h5 class="card-title">Some additional title here</h5>
                    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                  </div>
              ...
              <div class="col-md-4">
                <div class="card mb-4 bg-warning text-white">
                  <div class="card-header card-header-transparent card-heading">warning card</div>
                  <div class="card-body">
                    <h5 class="card-title">Some additional title here</h5>
                    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                  </div>
              ...
              <div class="col-md-4">
                <div class="card mb-4 bg-info text-white">
                  <div class="card-header card-header-transparent card-heading">info card</div>
                  <div class="card-body">
                    <h5 class="card-title">Some additional title here</h5>
                    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                  </div>
              ...
              <div class="col-md-4">
                <div class="card mb-4 bg-light">
                  <div class="card-header card-header-transparent card-heading">light card</div>
                  <div class="card-body">
                    <h5 class="card-title">Some additional title here</h5>
                    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                  </div>
              ...
              <div class="col-md-4">
                <div class="card mb-4 bg-dark text-white">
                  <div class="card-header card-header-transparent card-heading">dark card</div>
                  <div class="card-body">
                    <h5 class="card-title">Some additional title here</h5>
                    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                  </div>
            ...
            <div class="row">
              <div class="col-12">
                <div class="card-group mb-4">
                  <div class="card"><img class="card-img-top img-fluid" src="../lib/img/mockup4.jpg" alt="Card image cap">
                    <div class="card-body">
                      <h5 class="card-title">Card title</h5>
                  ...
                  <div class="card"><img class="card-img-top img-fluid" src="../lib/img/mockup3.jpg" alt="Card image cap">
                    <div class="card-body">
                      <h5 class="card-title">Card title</h5>
                  ...
                  <div class="card"><img class="card-img-top img-fluid" src="../lib/img/mockup1.jpg" alt="Card image cap">
                    <div class="card-body">
                      <h5 class="card-title">Card title</h5>
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="card text-center mb-4">
                  ...
                  <div class="card-body">
                    <h5 class="card-title">Special title treatment</h5>
                    <p class="card-text">With supporting text below as a natural lead-in to additional content.</p><a class="btn btn-secondary" href="#">Go somewhere</a>
                  </div>
                </div>
              </div>
            </div>
