<%-- 
    Document   : cms-media
    Created on : 20/12/2021, 01:20:48 PM
...
<html>
  <head>
    ...
    <!-- Lightbox gallery-->
    <link rel="stylesheet" href="../lib/vendor/glightbox/css/glightbox.min.css">
  ...
  <body>
        ...
        <ul class="list-unstyled">
              ...
              <li class="sidebar-list-item"><a class="sidebar-link text-muted active" href="#" data-bs-target="#cmsDropdown" role="button" aria-expanded="true" data-bs-toggle="collapse"> 
                ...
                <ul class="sidebar-menu list-unstyled collapse show" id="cmsDropdown">
                  ...
                  <li class="sidebar-list-item"><a class="sidebar-link active text-muted" href="cms-media.jsp">Media library</a></li>
                </ul>
              </li>
      ...
      <div class="page-holder bg-gray-100">
        <div class="container-fluid px-lg-4 px-xl-5">
          ...
          <div class="page-header d-flex justify-content-between align-items-center">
            <h1 class="page-heading mb-0">Media Library</h1>
            <div><a class="btn btn-primary text-uppercase text-nowrap" data-bs-toggle="collapse" href="#collapseMedia" role="button" aria-expanded="false" aria-controls="collapseMedia"><i class="fa fa-plus me-2"> </i>Add new</a></div>
          </div>
          <div class="collapse" id="collapseMedia">
            <div class="py-2">
              <form class="dropzone bg-transparent rounded-4 mb-5" id="demo-upload" action="#">
          ...
          <section class="mb-5">
            <div class="card mb-5">
              <div class="card-body">
                <div class="row"> 
                  <div class="col-sm-6">
                    <select class="form-select d-inline-block w-auto me-3 mb-1 mb-lg-0">
                    ...
                    <select class="form-select d-inline-block w-auto mb-1 mb-lg-0">
                  ...
                  <div class="col-sm-6 text-md-end">
                    <label class="form-label text-muted text-sm me-2 d-none d-lg-inline-block" for="media_search">Search</label>
                    <input class="form-control d-inline-block w-auto" id="media_search" type="search" placeholder="Fulltext search">
                  </div>
                </div>
              </div>
            </div>
            <div class="row">
              <div class="col-6 col-md-4 col-lg-3 col-xl-2">
                <div class="card position-relative mb-4"><img class="card-img-top" src="../lib/img/photos/w-600/soroush-zargar-zFSUhqGual8-unsplash.jpg" alt="Image 1">
                  <div class="card-body py-2 px-4">
                    <p class="card-text text-muted text-sm">Image 1</p>
                  </div><a class="glightbox stretched-link" href="img/photos/soroush-zargar-zFSUhqGual8-unsplash.jpg" data-gallery="gallery" data-title="Image 1"></a>
                </div>
              </div>
              <div class="col-6 col-md-4 col-lg-3 col-xl-2">
                <div class="card position-relative mb-4"><img class="card-img-top" src="../lib/img/photos/w-600/faruk-kaymak-CNVvDjVDiVI-unsplash.jpg" alt="Image 2">
                  <div class="card-body py-2 px-4">
                    <p class="card-text text-muted text-sm">Image 2</p>
                  </div><a class="glightbox stretched-link" href="img/photos/faruk-kaymak-CNVvDjVDiVI-unsplash.jpg" data-gallery="gallery" data-title="Image 2"></a>
                </div>
              </div>
              <div class="col-6 col-md-4 col-lg-3 col-xl-2">
                <div class="card position-relative mb-4"><img class="card-img-top" src="../lib/img/photos/w-600/aron-visuals-3jBU9TbKW7o-unsplash.jpg" alt="Image 3">
                  <div class="card-body py-2 px-4">
                    <p class="card-text text-muted text-sm">Image 3</p>
                  </div><a class="glightbox stretched-link" href="img/photos/aron-visuals-3jBU9TbKW7o-unsplash.jpg" data-gallery="gallery" data-title="Image 3"></a>
                </div>
              </div>
              <div class="col-6 col-md-4 col-lg-3 col-xl-2">
                <div class="card position-relative mb-4"><img class="card-img-top" src="../lib/img/photos/w-600/elizabeth-gottwald-dnIWYrliZfU-unsplash.jpg" alt="Image 4">
                  <div class="card-body py-2 px-4">
                    <p class="card-text text-muted text-sm">Image 4</p>
                  </div><a class="glightbox stretched-link" href="img/photos/elizabeth-gottwald-dnIWYrliZfU-unsplash.jpg" data-gallery="gallery" data-title="Image 4"></a>
                </div>
              </div>
              <div class="col-6 col-md-4 col-lg-3 col-xl-2">
                <div class="card position-relative mb-4"><img class="card-img-top" src="../lib/img/photos/w-600/willian-justen-de-vasconcellos-4hMET7vYTAQ-unsplash.jpg" alt="Image 5">
                  <div class="card-body py-2 px-4">
                    <p class="card-text text-muted text-sm">Image 5</p>
                  </div><a class="glightbox stretched-link" href="img/photos/willian-justen-de-vasconcellos-4hMET7vYTAQ-unsplash.jpg" data-gallery="gallery" data-title="Image 5"></a>
                </div>
              </div>
              <div class="col-6 col-md-4 col-lg-3 col-xl-2">
                <div class="card position-relative mb-4"><img class="card-img-top" src="../lib/img/photos/w-600/sorasak-_UIN-pFfJ7c-unsplash.jpg" alt="Image 6">
                  <div class="card-body py-2 px-4">
                    <p class="card-text text-muted text-sm">Image 6</p>
                  </div><a class="glightbox stretched-link" href="img/photos/sorasak-_UIN-pFfJ7c-unsplash.jpg" data-gallery="gallery" data-title="Image 6"></a>
                </div>
              </div>
              <div class="col-6 col-md-4 col-lg-3 col-xl-2">
                <div class="card position-relative mb-4"><img class="card-img-top" src="../lib/img/photos/w-600/montylov-ktZZiHb-GoI-unsplash.jpg" alt="Image 7">
                  <div class="card-body py-2 px-4">
                    <p class="card-text text-muted text-sm">Image 7</p>
                  </div><a class="glightbox stretched-link" href="img/photos/montylov-ktZZiHb-GoI-unsplash.jpg" data-gallery="gallery" data-title="Image 7"></a>
                </div>
              </div>
              <div class="col-6 col-md-4 col-lg-3 col-xl-2">
                <div class="card position-relative mb-4"><img class="card-img-top" src="../lib/img/photos/w-600/joseph-barrientos-Ji_G7Bu1MoM-unsplash.jpg" alt="Image 8">
                  <div class="card-body py-2 px-4">
                    <p class="card-text text-muted text-sm">Image 8</p>
                  </div><a class="glightbox stretched-link" href="img/photos/joseph-barrientos-Ji_G7Bu1MoM-unsplash.jpg" data-gallery="gallery" data-title="Image 8"></a>
                </div>
              </div>
              <div class="col-6 col-md-4 col-lg-3 col-xl-2">
                <div class="card position-relative mb-4"><img class="card-img-top" src="../lib/img/photos/w-600/henrique-ferreira-RKsLQoSnuTc-unsplash.jpg" alt="Image 9">
                  <div class="card-body py-2 px-4">
                    <p class="card-text text-muted text-sm">Image 9</p>
                  </div><a class="glightbox stretched-link" href="img/photos/henrique-ferreira-RKsLQoSnuTc-unsplash.jpg" data-gallery="gallery" data-title="Image 9"></a>
                </div>
              </div>
              <div class="col-6 col-md-4 col-lg-3 col-xl-2">
                <div class="card position-relative mb-4"><img class="card-img-top" src="../lib/img/photos/w-600/luca-bravo-O453M2Liufs-unsplash.jpg" alt="Image 10">
                  <div class="card-body py-2 px-4">
                    <p class="card-text text-muted text-sm">Image 10</p>
                  </div><a class="glightbox stretched-link" href="img/photos/luca-bravo-O453M2Liufs-unsplash.jpg" data-gallery="gallery" data-title="Image 10"></a>
                </div>
              </div>
              <div class="col-6 col-md-4 col-lg-3 col-xl-2">
                <div class="card position-relative mb-4"><img class="card-img-top" src="../lib/img/photos/w-600/mesut-kaya-eOcyhe5-9sQ-unsplash.jpg" alt="Image 11">
                  <div class="card-body py-2 px-4">
                    <p class="card-text text-muted text-sm">Image 11</p>
                  </div><a class="glightbox stretched-link" href="img/photos/mesut-kaya-eOcyhe5-9sQ-unsplash.jpg" data-gallery="gallery" data-title="Image 11"></a>
                </div>
              </div>
              <div class="col-6 col-md-4 col-lg-3 col-xl-2">
                <div class="card position-relative mb-4"><img class="card-img-top" src="../lib/img/photos/w-600/stefan-stefancik-0wMmxNB6Xzc-unsplash.jpg" alt="Image 12">
                  <div class="card-body py-2 px-4">
                    <p class="card-text text-muted text-sm">Image 12</p>
                  </div><a class="glightbox stretched-link" href="img/photos/stefan-stefancik-0wMmxNB6Xzc-unsplash.jpg" data-gallery="gallery" data-title="Image 12"></a>
                </div>
              </div>
              <div class="col-6 col-md-4 col-lg-3 col-xl-2">
                <div class="card position-relative mb-4"><img class="card-img-top" src="../lib/img/photos/w-600/soroush-zargar-zFSUhqGual8-unsplash.jpg" alt="Image 13">
                  <div class="card-body py-2 px-4">
                    <p class="card-text text-muted text-sm">Image 13</p>
                  </div><a class="glightbox stretched-link" href="img/photos/soroush-zargar-zFSUhqGual8-unsplash.jpg" data-gallery="gallery" data-title="Image 13"></a>
                </div>
              </div>
              <div class="col-6 col-md-4 col-lg-3 col-xl-2">
                <div class="card position-relative mb-4"><img class="card-img-top" src="../lib/img/photos/w-600/faruk-kaymak-CNVvDjVDiVI-unsplash.jpg" alt="Image 14">
                  <div class="card-body py-2 px-4">
                    <p class="card-text text-muted text-sm">Image 14</p>
                  </div><a class="glightbox stretched-link" href="img/photos/faruk-kaymak-CNVvDjVDiVI-unsplash.jpg" data-gallery="gallery" data-title="Image 14"></a>
                </div>
              </div>
              <div class="col-6 col-md-4 col-lg-3 col-xl-2">
                <div class="card position-relative mb-4"><img class="card-img-top" src="../lib/img/photos/w-600/aron-visuals-3jBU9TbKW7o-unsplash.jpg" alt="Image 15">
                  <div class="card-body py-2 px-4">
                    <p class="card-text text-muted text-sm">Image 15</p>
                  </div><a class="glightbox stretched-link" href="img/photos/aron-visuals-3jBU9TbKW7o-unsplash.jpg" data-gallery="gallery" data-title="Image 15"></a>
                </div>
              </div>
              <div class="col-6 col-md-4 col-lg-3 col-xl-2">
                <div class="card position-relative mb-4"><img class="card-img-top" src="../lib/img/photos/w-600/elizabeth-gottwald-dnIWYrliZfU-unsplash.jpg" alt="Image 16">
                  <div class="card-body py-2 px-4">
                    <p class="card-text text-muted text-sm">Image 16</p>
                  </div><a class="glightbox stretched-link" href="img/photos/elizabeth-gottwald-dnIWYrliZfU-unsplash.jpg" data-gallery="gallery" data-title="Image 16"></a>
                </div>
              </div>
              <div class="col-6 col-md-4 col-lg-3 col-xl-2">
                <div class="card position-relative mb-4"><img class="card-img-top" src="../lib/img/photos/w-600/willian-justen-de-vasconcellos-4hMET7vYTAQ-unsplash.jpg" alt="Image 17">
                  <div class="card-body py-2 px-4">
                    <p class="card-text text-muted text-sm">Image 17</p>
                  </div><a class="glightbox stretched-link" href="img/photos/willian-justen-de-vasconcellos-4hMET7vYTAQ-unsplash.jpg" data-gallery="gallery" data-title="Image 17"></a>
                </div>
              </div>
              <div class="col-6 col-md-4 col-lg-3 col-xl-2">
                <div class="card position-relative mb-4"><img class="card-img-top" src="../lib/img/photos/w-600/sorasak-_UIN-pFfJ7c-unsplash.jpg" alt="Image 18">
                  <div class="card-body py-2 px-4">
                    <p class="card-text text-muted text-sm">Image 18</p>
                  </div><a class="glightbox stretched-link" href="img/photos/sorasak-_UIN-pFfJ7c-unsplash.jpg" data-gallery="gallery" data-title="Image 18"></a>
                </div>
              </div>
              <div class="col-6 col-md-4 col-lg-3 col-xl-2">
                <div class="card position-relative mb-4"><img class="card-img-top" src="../lib/img/photos/w-600/montylov-ktZZiHb-GoI-unsplash.jpg" alt="Image 19">
                  <div class="card-body py-2 px-4">
                    <p class="card-text text-muted text-sm">Image 19</p>
                  </div><a class="glightbox stretched-link" href="img/photos/montylov-ktZZiHb-GoI-unsplash.jpg" data-gallery="gallery" data-title="Image 19"></a>
                </div>
              </div>
              <div class="col-6 col-md-4 col-lg-3 col-xl-2">
                <div class="card position-relative mb-4"><img class="card-img-top" src="../lib/img/photos/w-600/joseph-barrientos-Ji_G7Bu1MoM-unsplash.jpg" alt="Image 20">
                  <div class="card-body py-2 px-4">
                    <p class="card-text text-muted text-sm">Image 20</p>
                  </div><a class="glightbox stretched-link" href="img/photos/joseph-barrientos-Ji_G7Bu1MoM-unsplash.jpg" data-gallery="gallery" data-title="Image 20"></a>
                </div>
              </div>
              <div class="col-6 col-md-4 col-lg-3 col-xl-2">
                <div class="card position-relative mb-4"><img class="card-img-top" src="../lib/img/photos/w-600/henrique-ferreira-RKsLQoSnuTc-unsplash.jpg" alt="Image 21">
                  <div class="card-body py-2 px-4">
                    <p class="card-text text-muted text-sm">Image 21</p>
                  </div><a class="glightbox stretched-link" href="img/photos/henrique-ferreira-RKsLQoSnuTc-unsplash.jpg" data-gallery="gallery" data-title="Image 21"></a>
                </div>
              </div>
              <div class="col-6 col-md-4 col-lg-3 col-xl-2">
                <div class="card position-relative mb-4"><img class="card-img-top" src="../lib/img/photos/w-600/luca-bravo-O453M2Liufs-unsplash.jpg" alt="Image 22">
                  <div class="card-body py-2 px-4">
                    <p class="card-text text-muted text-sm">Image 22</p>
                  </div><a class="glightbox stretched-link" href="img/photos/luca-bravo-O453M2Liufs-unsplash.jpg" data-gallery="gallery" data-title="Image 22"></a>
                </div>
              </div>
              <div class="col-6 col-md-4 col-lg-3 col-xl-2">
                <div class="card position-relative mb-4"><img class="card-img-top" src="../lib/img/photos/w-600/mesut-kaya-eOcyhe5-9sQ-unsplash.jpg" alt="Image 23">
                  <div class="card-body py-2 px-4">
                    <p class="card-text text-muted text-sm">Image 23</p>
                  </div><a class="glightbox stretched-link" href="img/photos/mesut-kaya-eOcyhe5-9sQ-unsplash.jpg" data-gallery="gallery" data-title="Image 23"></a>
                </div>
              </div>
              <div class="col-6 col-md-4 col-lg-3 col-xl-2">
                <div class="card position-relative mb-4"><img class="card-img-top" src="../lib/img/photos/w-600/stefan-stefancik-0wMmxNB6Xzc-unsplash.jpg" alt="Image 24">
                  <div class="card-body py-2 px-4">
                    <p class="card-text text-muted text-sm">Image 24</p>
                  </div><a class="glightbox stretched-link" href="img/photos/stefan-stefancik-0wMmxNB6Xzc-unsplash.jpg" data-gallery="gallery" data-title="Image 24"></a>
                </div>
              </div>
            </div>
          </section>
    ...
    <!-- Dropzone.js-->
    <script src="../lib/vendor/dropzone/dropzone.js"></script>
    <!-- CMS Media JS-->
    <script src="../lib/js/cms-media.js"></script>
    <!-- Main Theme JS File-->
