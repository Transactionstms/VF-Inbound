<%-- 
    Document   : e-commerce-customers
    Created on : 20/12/2021, 01:28:44 PM
...
<html>
  ...
  <body>
        ...
        <ul class="list-unstyled">
              ...
              <li class="sidebar-list-item"><a class="sidebar-link text-muted active" href="#" data-bs-target="#e-commerceDropdown" role="button" aria-expanded="true" data-bs-toggle="collapse"> 
                ...
                <ul class="sidebar-menu list-unstyled collapse show" id="e-commerceDropdown">
                  ...
                  <li class="sidebar-list-item"><a class="sidebar-link active text-muted" href="e-commerce-customers.jsp">Customers</a></li>
                </ul>
              </li>
                ...
                <div class="table-responsive">
                  <table class="table table-hover mb-0" id="customersDatatable">
                    ...
                    <tbody>
                      ...
                      <tr class="align-middle text-muted text-sm">
                        <td class="text-dark text-base" style="min-width: 250px;">
                          <input class="me-2 mt-3 form-check-input" type="checkbox" id="check1"><a class="text-reset text-decoration-none" href="#!"><img class="avatar p-1 me-2" src="../lib/img/avatar-1.jpg" alt="Margret Cote"><strong>Margret Cote</strong></a>
                        </td>
                        <td>Foxworth</td>
                      ...
                      <tr class="align-middle text-muted text-sm">
                        <td class="text-dark text-base" style="min-width: 250px;">
                          <input class="me-2 mt-3 form-check-input" type="checkbox" id="check2"><a class="text-reset text-decoration-none" href="#!"><img class="avatar p-1 me-2" src="../lib/img/avatar-2.jpg" alt="Rachel Vinson"><strong>Rachel Vinson</strong></a>
                        </td>
                        <td>Eastmont</td>
                      ...
                      <tr class="align-middle text-muted text-sm">
                        <td class="text-dark text-base" style="min-width: 250px;">
                          <input class="me-2 mt-3 form-check-input" type="checkbox" id="check4"><a class="text-reset text-decoration-none" href="#!"><img class="avatar p-1 me-2" src="../lib/img/avatar-4.jpg" alt="Spears Collier"><strong>Spears Collier</strong></a>
                        </td>
                        <td>Hebron</td>
                      ...
                      <tr class="align-middle text-muted text-sm">
                        <td class="text-dark text-base" style="min-width: 250px;">
                          <input class="me-2 mt-3 form-check-input" type="checkbox" id="check5"><a class="text-reset text-decoration-none" href="#!"><img class="avatar p-1 me-2" src="../lib/img/avatar-5.jpg" alt="Keisha Thomas"><strong>Keisha Thomas</strong></a>
                        </td>
                        <td>Levant</td>
                      ...
                      <tr class="align-middle text-muted text-sm">
                        <td class="text-dark text-base" style="min-width: 250px;">
                          <input class="me-2 mt-3 form-check-input" type="checkbox" id="check7"><a class="text-reset text-decoration-none" href="#!"><img class="avatar p-1 me-2" src="../lib/img/avatar-7.jpg" alt="Patel Mack"><strong>Patel Mack</strong></a>
                        </td>
                      ...
                      <tr class="align-middle text-muted text-sm">
                        <td class="text-dark text-base" style="min-width: 250px;">
                          <input class="me-2 mt-3 form-check-input" type="checkbox" id="check8"><a class="text-reset text-decoration-none" href="#!"><img class="avatar p-1 me-2" src="../lib/img/avatar-8.jpg" alt="Erika Whitaker"><strong>Erika Whitaker</strong></a>
                        </td>
                        <td>Leola</td>
                      ...
                      <tr class="align-middle text-muted text-sm">
                        <td class="text-dark text-base" style="min-width: 250px;">
                          <input class="me-2 mt-3 form-check-input" type="checkbox" id="check10"><a class="text-reset text-decoration-none" href="#!"><img class="avatar p-1 me-2" src="../lib/img/avatar-10.jpg" alt="Townsend Sloan"><strong>Townsend Sloan</strong></a>
                        </td>
                        <td>Coultervillle</td>
                      ...
                      <tr class="align-middle text-muted text-sm">
                        <td class="text-dark text-base" style="min-width: 250px;">
                          <input class="me-2 mt-3 form-check-input" type="checkbox" id="check12"><a class="text-reset text-decoration-none" href="#!"><img class="avatar p-1 me-2" src="../lib/img/avatar-1.jpg" alt="Madelyn Brock"><strong>Madelyn Brock</strong></a>
                        </td>
                        <td>Ballico</td>
                      ...
                      <tr class="align-middle text-muted text-sm">
                        <td class="text-dark text-base" style="min-width: 250px;">
                          <input class="me-2 mt-3 form-check-input" type="checkbox" id="check13"><a class="text-reset text-decoration-none" href="#!"><img class="avatar p-1 me-2" src="../lib/img/avatar-2.jpg" alt="Jenkins Carney"><strong>Jenkins Carney</strong></a>
                        </td>
                        <td>Chesterfield</td>
                      ...
                      <tr class="align-middle text-muted text-sm">
                        <td class="text-dark text-base" style="min-width: 250px;">
                          <input class="me-2 mt-3 form-check-input" type="checkbox" id="check15"><a class="text-reset text-decoration-none" href="#!"><img class="avatar p-1 me-2" src="../lib/img/avatar-4.jpg" alt="Valencia Rivera"><strong>Valencia Rivera</strong></a>
                        </td>
                        <td>Kirk</td>
                      ...
                      <tr class="align-middle text-muted text-sm">
                        <td class="text-dark text-base" style="min-width: 250px;">
                          <input class="me-2 mt-3 form-check-input" type="checkbox" id="check16"><a class="text-reset text-decoration-none" href="#!"><img class="avatar p-1 me-2" src="../lib/img/avatar-5.jpg" alt="Helene Solomon"><strong>Helene Solomon</strong></a>
                        </td>
                        <td>Riverton</td>
                      ...
                      <tr class="align-middle text-muted text-sm">
                        <td class="text-dark text-base" style="min-width: 250px;">
                          <input class="me-2 mt-3 form-check-input" type="checkbox" id="check18"><a class="text-reset text-decoration-none" href="#!"><img class="avatar p-1 me-2" src="../lib/img/avatar-7.jpg" alt="Merrill Garrett"><strong>Merrill Garrett</strong></a>
                        </td>
                        <td>Utting</td>
                      ...
                      <tr class="align-middle text-muted text-sm">
                        <td class="text-dark text-base" style="min-width: 250px;">
                          <input class="me-2 mt-3 form-check-input" type="checkbox" id="check19"><a class="text-reset text-decoration-none" href="#!"><img class="avatar p-1 me-2" src="../lib/img/avatar-8.jpg" alt="Sallie Booth"><strong>Sallie Booth</strong></a>
                        </td>
                        <td>Waiohinu</td>
    ...
    <!-- CMS Category JS-->
    <script src="../lib/js/e-commerce-customers.js">    </script>
    <!-- Main Theme JS File-->
