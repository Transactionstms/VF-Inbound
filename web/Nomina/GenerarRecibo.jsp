<%-- 
    Document   : GenerarRecibo
    Created on : 29/12/2021, 06:06:51 PM
      ...
      <div class="page-holder bg-gray-100">
        <div class="container-fluid px-lg-4 px-xl-5">
            <div class="page-header">
                <h3 class="page-heading">Generar Recibo</h3>
            </div>
          <section>
            <!-- imask Input maps-->
            <div class="card mb-4">
            ...
            <div>
                <a class="btn btn-primary text-uppercase" href="List.jsp"> <i class="fa fa-angle-left"> </i>Regresar al listado</a>
                <a class="btn btn-primary text-uppercase" href="Upd.jsp"> <i class="fa fa-edit"> </i>Editar</a>
            </div>
          </section>
        </div>
