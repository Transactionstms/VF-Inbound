<%-- 
    Document   : Details
    Created on : 29/12/2021, 05:17:44 PM
            ...
            <div class="page-holder bg-gray-100">
                <div class="container-fluid px-lg-4 px-xl-5">
                    <div class="page-header">
                        <h3 class="page-heading">Detalle Producto</h3>
                    </div>
                    <section>
                        <!-- imask Input maps-->
                        <div class="card mb-4">
                            <div class="card-header">
                                <h4 class="card-heading"><i class="fas fa-info-circle"></i>&nbsp;Información del Concepto</h4>
                            </div>
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-12 col-md-2 text-md-right">
                                        <p class="text-muted mb-4"><strong class="text-body">Descripción:</strong></p>
                                        <p class="text-muted mb-4"><strong class="text-body">Valor Unitario:</strong></p>
                                        <p class="text-muted mb-4"><strong class="text-body">Fecha de Registro:</strong></p>
                                        <p class="text-muted mb-4"><strong class="text-body">IVA:</strong></p>
                                        <p class="text-muted mb-4"><strong class="text-body">IEPS:</strong></p>
                                        <p class="text-muted mb-4"><strong class="text-body">Clave de producto:</strong></p>
                                        <p class="text-muted mb-4"><strong class="text-body">Descripción:</strong></p>
                                        <p class="text-muted mb-4"><strong class="text-body">Clave Unidad:</strong></p>
                                        <p class="text-muted mb-4"><strong class="text-body">Descripción:</strong></p>
                                        <p class="text-muted mb-4"><strong class="text-body">Estatus:</strong></p>
                                    </div>
                                    <div class="col-12 col-md-4 text-md-left">
                                        <p class="text-muted mb-4">SERVICIO DE SISTEMA TRANSACTIONS-LWS</p>
                                        <p class="text-muted mb-4">$ 12000.000000</p>
                                        <p class="text-muted mb-4">04/07/2018</p>
                                        <p class="text-muted mb-4">16.000000%</p>
                                        <p class="text-muted mb-4">0.00</p>
                                        <p class="text-muted mb-4">81112200</p>
                                        <p class="text-muted mb-4">Mantenimiento y soporte de software</p>
                                        <p class="text-muted mb-4">E48</p>
                                        <p class="text-muted mb-4">Unidad de servicio</p>
                                        <p class="text-muted mb-4">Activo</p>
                                    </div>

                                    <div class="col-12 col-md-1 text-md-right">
                                        <p class="text-muted mb-4"><strong class="text-body">IEPS Ret:</strong></p>
                                        <p class="text-muted mb-4"><strong class="text-body">ISR:</strong></p>
                                        <p class="text-muted mb-4"><strong class="text-body">IVA Ret.:</strong></p>
                                    </div>
                                    <div class="col-12 col-md-5 text-md-left">
                                        <p class="text-muted mb-4">0.00</p>
                                        <p class="text-muted mb-4">0.000000%</p>
                                        <p class="text-muted mb-4">0.000000%</p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2">
                                <a class="btn btn-primary" href="Upd.jsp"> <i class="fa fa-edit"> </i>&nbsp;Editar</a>
                            </div>
                        </div> 
                    </section>
                </div>
                ...
                fetch("<%=request.getContextPath()%>/InsertarFacturacion?cliente_id=" + cliente_id +
                        ...
                        .then(data => {
                             ...
                             if (data === "true") {
                                 ...
                                 swal("Error", "El concepto no fue registrado", "error"); alertclose();
                            }
