<%-- 
    Document   : Add
    Created on : 29/12/2021, 04:08:24 PM
                            ...
                            <div class="col-lg-6">
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body text-muted">
                                            ...
                                            <div class="mb-3" id="valorunidadMedida">
                                                <label class="form-label" style="font-family: Arial; font-weight: bold; color:#707375;">Ingrese valor en unidad de medida:&nbsp;<label style="color:#db2a2a;">*</label></label>
                                                <input class="form-control input-datepicker-multiple" type="text" id="unidad_medida" name="unidad_medida" placeholder=".kg .lt .pza etc.." onkeypress="return soloNumeros(event)" autocomplete="off">
                                            </div>
        ...
        <script>
	     ...
	     tiporegistro(1);
            ...
            function tiporegistro(id_reg){
                ...
                if(id_reg == 1){
                    div = document.getElementById('valorunidadMedida');
                    div.style.display = '';
                }else{
                    div = document.getElementById('valorunidadMedida');
