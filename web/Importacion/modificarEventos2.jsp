                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 "> 
                                                <div class="mb-3">
                                                    ...
                                                    <input class="form-control" type="text" placeholder="..." value="<%=row[7]%>" readonly>
                                                </div>
                                            </div>  
                                            <div class="col-md-4 "> 
                                                <div class="mb-3">
                                           ...
                                           <!-- <div class="col-md-4 "> 
                                                <div class="mb-3">
                                                    <label class="form-label text-uppercase"><strong>Inbound notification</strong></label>
                                                    <input class="form-control" type="text" placeholder="..." value="<%=row[14]%>" name="" id="">
                                                </div>
                                            </div>  -->
                                            <div class="col-md-4 "> 
                                                <div class="mb-3">
