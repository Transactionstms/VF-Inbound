                            ...
                            <div class="col-lg-12 mb-4 mb-lg-0">
                                <div class="card h-100">
                                    <div class="col-md-12 card-header justify-content-between">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <h2 class="card-heading"> Reporte previos origen</h2>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card-body">
...
<th scope="col" class="font-titulo">FECHA_BOOKING_ORIGEN </th>
<th scope="col" class="font-titulo">FECHA_PREVIO_ORIGEN </th>
<th scope="col" class="font-titulo">NOTIFICACION_REPORTE_VF </th>
<th scope="col" class="font-titulo">REFERENCIA_AI </th>
<th scope="col" class="font-titulo">PO </th>
<th scope="col" class="font-titulo">DESCRIPCION_MERCANCIA </th>
<th scope="col" class="font-titulo">ESTILO </th>
<th scope="col" class="font-titulo">FABRICANTE </th>
<th scope="col" class="font-titulo">BULTOS_CARTONES </th>
<th scope="col" class="font-titulo">PIEZAS </th>
<th scope="col" class="font-titulo">LUGAR_INSPECCION </th>
<th scope="col" class="font-titulo">OBSERVACIONES </th>
<th scope="col" class="font-titulo">FACTURA_LLANES_TRADUCCION </th>
<th scope="col" class="font-titulo">COSTO_PREVIO_ORIGEN </th>
<th scope="col" class="font-titulo">TRADUCCION_FACTURA </th>
<th scope="col" class="font-titulo">FACTURA_LLANES </th>
<th scope="col" class="font-titulo">HOJAS_TRADUCIDAS </th>
<th scope="col" class="font-titulo">COSTO_TRADUCCION_FACTURA </th>
