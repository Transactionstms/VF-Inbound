<%-- 
    Document   : reporteCFDI
    Created on : Jan 2, 2024, 6:52:37 PM
    Author     : dan_i
--%>
...
<html>
                            ...
                            <div class="col-lg-12 mb-4 mb-lg-0">
                                <div class="card h-100">
                                    <div class="col-md-12 card-header justify-content-between">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <h2 class="card-heading">Seleccione las fechas del reporte CFDI</h2>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card-body" >
  ...
  function enviarForm() {
                       ...
                       window.location.href = '<%=request.getContextPath()%>/Logistica/reporteCFDI2.jsp?f1='+valor+'&f2='+valor2;
