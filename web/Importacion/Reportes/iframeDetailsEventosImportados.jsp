...
<html>
    ...
    <body style="margin: 0;">
        ...
        <div class="col-md-12">
            <div class="card mb-4 bg-white text-white">
                 <div class="card-header bg-blue card-heading">Reporte de Eventos Importados</div>
                <div class="card-body">

                    <div class="col-md-12 card-header justify-content-between">
                        <div class="row">
                            <div class="col-md-12">
                                <h2 class="card-heading">Reporte de Eventos Importados</h2>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="columna">
                                <a href="#" id="downloadLinkEventImport">Descargar Archivo</a>
                            </div>
                        </div
