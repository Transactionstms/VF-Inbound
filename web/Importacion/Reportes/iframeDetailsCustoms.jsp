                                    ...
                                    <div class="col-lg-12">
                                        <div class="mb-3">  
                                            <div class="row">
                                                ...
                                                <img src="<%=request.getContextPath()%>/img/loadingCloud.gif" id="idClouding" width="50px" height="50px" name="idClouding" title="Clouding" style="display: none; height: 50px; width: 50px;"/>
                                            </div> 
                                        </div>
                                    </div>
                                </div>  
