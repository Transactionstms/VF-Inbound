<%-- 
    Document   : iframeDetailsEventosImportados
    Created on : 24 ene 2024, 19:37:06
...
<%@page import="com.tacts.evidencias.inbound.CreatExcelReporteEventosImportados"%>
...
<html>
    <head>
        ...
        <title>Reporte de Eventos Importados</title>
    ...
    <style>
        ...
        .data-table-container {
            ...
            overflow: hidden; /* Evita que el contenedor se expanda infinitamente hacia abajo */
        }
    ...
    <body style="margin: 0;">
        <%
            try {
                ...
                CreatExcelReporteEventosImportados excel = new CreatExcelReporteEventosImportados();
                ...
                //Generación de Excel
                pathExcelImport = excel.crearAPartirDeArrayListReporteEventosImportados(AgentType, filterType, id, fechaInicial, fechaFinal);

        %>

        <div class="col-md-12 shadow-lg rounded">
            <div class="card" data-filter-type="<%= filterType%>" data-id="<%= id%>" data-agent-type="<%= AgentType%>">
                <div class="col-md-12 card-header justify-content-between">
                    <div class="card-header bg-primary text-white card-heading">Reporte de Eventos Importados</div>
                    ...
                    <div style="text-align: right;">
                        <div class="row">
                            ...
                            <div class="col-md-1 d-flex align-items-center justify-content-end">
                                <a href="#" id="downloadLinkEventImport">
                                    <i class="material-icons" style="margin: 15px 20px; font-size: 30px;">insert_drive_file</i>
                        ...
                        <div id="example_filter" class="dataTables_filter">
                            <label><font class="redtext1">Búsqueda:&nbsp; <input id="searchTerm" type="text" onkeyup="doSearch()" style="text-transform:uppercase;" data-mobile-responsive="true"/>
                                </font>&nbsp;&nbsp;
                            </label>
                        </div> 
                    </div>
                    ...
                    <div id="table-scroll" class="table-scroll">
                        <table id="main-table" class="main-table" style="table-layout:fixed; width:1500%;">
                            ...
                            <tbody id="detalleCustom">
                                <%
                                    if (db.doDB(fac.consultarReporteEventosImportados(AgentType, filterType, caramelo, fechaInicial, fechaFinal))) {
    ...
    <script>
        function onloadIframe() {
            ...
            document.getElementById('frameTableCustoms').src = "ReporteEventosImportados.jsp?filterType=" + filterType + "&id=" + id;
    ...
    <script>
        document.getElementById("downloadLinkEventImport").addEventListener("click", function () {
            // Realizar una solicitud al servlet para descargar el archivo
            var xhr = new XMLHttpRequest();
            xhr.open("GET", "<%=request.getContextPath()%>/DownloadExcelEventsImport", true);
            ...
            xhr.onload = function () {
                ...
                link.download = "ReporteEventosImportados.xls";
