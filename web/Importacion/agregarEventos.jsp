                        ...
                        <div class="col-lg-12 mb-5">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-heading">Agregar EVENTO</h4>
                                </div>
                                <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4 "> 
                                                <div class="mb-3">
                                                    ...
                                                    <input class="form-control" id="numEventoActual" name="numEventoActual" type="text"   onchange="validarNumEvento(this.value);">                                                    
                                                </div>
                                            </div>  
                                              <div class="col-md-4 "> 
                                                <div class="mb-3">
                                                    <label class="form-label text-uppercase"><strong>Container</strong></label>
                                                    <input class="form-control" type="text" id="containerActual" name="containerActual"  >
                                                </div>
                                            </div>  
                                            <div class="col-md-4 "> 
                                                <div class="mb-3">
                                                    <label class="form-label text-uppercase"><strong>BL/ AWB/ PRO</strong></label>
                                                    <input class="form-control" type="text" placeholder="..."   name="bl" id="bl" >
                                                </div>
                                            </div>     
                                            ...
                                            <div class="col-md-4 "> 
                                                <div class="mb-3">
                                                    ...
                                                    <input class="form-control" type="text" placeholder="..."   name="finaldes" id="finaldes">
                                                </div>
                                            </div> 
                                            <div class="col-md-4 "> 
                                                <div class="mb-3">
                                            ...
                                            <div class="col-md-4 "> 
                                                <div class="mb-3">
                                                    ...
                                                    <input class="form-control" type="text" placeholder="..."   name="shipmentIdActual" id="shipmentIdActual">
                                                </div>
                                            </div>   
                                            <div class="col-md-4 "> 
                                                <div class="mb-3">
 ...
 <!--*******************************************************-->
                                            ...
                                            <div class="col-md-4 "> 
                                                <div class="mb-3">
                                                    ...
                                                    <input class="form-control datepicker" type="text"    placeholder="MM/DD/YYYY"  name="est_departure_pol" id="est_departure_pol">
                                                </div>
                                            </div>  
                                            ...
                                            <div class="col-md-4 "> 
                                                <div class="mb-3">
                                                    ...
                                                    <input class="form-control datepicker" type="text" placeholder="..."   name="eta_port_discharge" id="eta_port_discharge">
                                                </div>
                                            </div>  
                                            <div class="col-md-4 "> 
                                                <div class="mb-3">
                                            ...
                                            <div class="col-md-4 "> 
                                                <div class="mb-3">
                                                    ...
                                                    <input class="form-control datepicker" type="text" placeholder="..."  name="eta_plus2" id="eta_plus2" onchange="diasEtaDc(2);">
                                                </div>
                                            </div>  
 ...
 <!--*******************************************************-->
                                            ...
                                            <div class="col-md-4 "> 
                                                <div class="mb-3">
                                                    ...
                                                    <input class="form-control datepicker" type="text" placeholder="..."   name="eta_plus" id="eta_plus">
                                                </div>
                                            </div>  
...
<!--*******************************************************-->
                                        ...
                                        <div class="mb-3">       
                                            <button class="btn btn-primary" type="button" onclick="Guardar()">Agregar</button>
                                        </div>
                                    </form>
...
async function Guardar() {
    ...
    try {
        const data = await fetchData('../NuevoEvento?numEventoActual=' + numEventoActual + '&ShipmentActual=' + shipmentIdActual + '&containerActual=' + containerActual + '&responsable=' + responsable + '&finaldes=' + finalDestination + '&Brand=' + brandDivision + '&sbu_name=' + division + '&Load1=' + loadType + '&quantity=' + quantity + '&pod=' + pod + '&est_departure_pol=' + estDeparturePol + '&eta_port_discharge=' + etaRealPort + '&max_flete=' + max_flete + '&eta_plus2=' + eta_plus2 + '&eta_plus=' + eta_plus + '&pol=' + pol + '&observaciones=' + observaciones + '&bl=' + bl + '&actual_crd=' + actual_crd + '&reg1='+reg1+'&reg2='+reg2+'&reg3='+reg3+'&mat2='+mat2+'&carr2='+carr2+'&tcon2='+tcon2+'&peso2='+peso2);
