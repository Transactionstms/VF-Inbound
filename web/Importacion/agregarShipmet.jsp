<%-- 
    Document   : agregarShipmet
    Created on : 27/jul/2023, 11:28:29 AM
    Author     : grecendiz
--%>
...
String sql2= "WITH sum_quantity AS ("
        ...
        <script>
            ...
            function editarEvento(id,ship,conteiner) {
                ...
                window.location.href = '<%=request.getContextPath()%>/Importacion/agregarShipmet2.jsp?id=' + id+"&ship="+ship+"&con="+conteiner;
