        ...
        <%
            try {
                ...
                String sql2 = "WITH sum_quantity AS ("
                        ...
                        + "   tip2.NOMBRE_POL,"
                        + "   NVL(taa.agente_aduanal_nombre, ' ') AS agente_aduanal,"//16
                        + "   gtn.plantilla_id,"
                                                    ...
                                                    <tbody>
                                                        ...
                                                        %>
                                                         <tr>
                                                            ...
                                                            <td><center><button type="button" class="btn btn-primary" onclick="saveObservaciones('<%=row[0]%>')">Modificar</button></center></td>
                                                    </tr>
                                                    <%
                                                            }
                                                        }
