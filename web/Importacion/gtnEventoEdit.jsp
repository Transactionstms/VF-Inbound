                                                    ...
                                                    <tbody>
                                                        ...
                                                        <%
                                                            String sql = " select "
                                                                    ...
                                                                    + " POL                           , "
                                                                    + " POD                           , "
                                                                    + " to_char(ACTUAL_CRD                    ,'MM/DD/YYYY'), "
                                                                    + " to_char(RECEIVED_VENDOR               ,'MM/DD/YYYY'), "
                                                                    + " to_char(EST_DEPARTURE_POL             ,'MM/DD/YYYY'), "
                                                                    + " to_char(DEPARTED_POL                  ,'MM/DD/YYYY'), "
                                                                    + " to_char(DOCS_PROVIDED_BROKER          ,'MM/DD/YYYY'), "
                                                                    + " to_char(ETA_PORT_DISCHARGE            ,'MM/DD/YYYY'), "
                                                                    + " to_char(ETA_POD                       ,'MM/DD/YYYY'), "
                                                                    + " to_char(ARRIVED_POD                   ,'MM/DD/YYYY'), "
                                                                    + " to_char(OUTLOOK_ETA                   ,'MM/DD/YYYY'), "
                                                                    + " nvl(DELIVERED_FINAL_DEST,' ')          , "
                                                                    + " nvl(RECEIVED_FINAL_DEST ,' ')          , "
                                                                    + " VIEW_DOCS                     , "
                                                                    + " ESTATUS                       , "
                                                                    + " FECHA_CAPTURA                 , "
                                                                    + " BODEGA_ID                     , "
                                                                    + " CBDIV_ID                      , "
                                                                    + " PLANTILLA_ID                   "
                                                                    + " from TRA_INC_GTN_TEST where PLANTILLA_ID in "
