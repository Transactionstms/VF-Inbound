...
(function(u) {
	var e=function() {
		...
		function l(e, t) {
			...
			;
			if(e) {
				for(s=(e=e.split("/")).length-1, y.nodeIdCompat&&b.test(e[s])&&(e[s]=e[s].replace(b, "")), "."===e[0].charAt(0)&&h&&(e=h.slice(0, h.length-1).concat(e)), u=0;
				u<e.length;
				u++)if("."===(p=e[u]))e.splice(u, 1), --u;
				else if(".."===p) {
			...
			if((h||g)&&f) {
				for(u=(n=e.split("/")).length;
				0<u;
				--u) {
					if(r=n.slice(0, u).join("/"), h)for(d=h.length;
					0<d;
					--d)if(i=(i=f[h.slice(0, d).join("/")])&&i[r]) {
						o=i, a=u;
						break
					}
					if(o)break;
		...
		, o=function(e, t, n, r) {
			...
			if(c=S(r=r||e), "undefined"==p||"function"==p) {
				...
				l<t.length;
				l+=1)if("require"===(o=(a=f(t[l], c)).f))d[l]=g.require(e);
