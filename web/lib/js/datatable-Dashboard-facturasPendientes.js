...
document.addEventListener("DOMContentLoaded", function () {
    const dataTable = new simpleDatatables.DataTable("#dashFacturasDatatable", {
        columns: [
    ...
    dataTable.on("datatable.init", function (args) {
        document.getElementById("dashFacturasDatatable").closest(".preload-wrapper").classList.add("opacity-10");
    });
});
