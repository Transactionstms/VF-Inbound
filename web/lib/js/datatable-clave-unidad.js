...
document.addEventListener("DOMContentLoaded", function () {
    const dataTable = new simpleDatatables.DataTable("#unidadDatatable", {
        columns: [
    ...
    dataTable.on("datatable.init", function (args) {
        document.getElementById("unidadDatatable").closest(".preload-wrapper").classList.add("opacity-10");
    });
});
