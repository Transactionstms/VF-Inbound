...
document.addEventListener("DOMContentLoaded", function () {
    const dataTable = new simpleDatatables.DataTable("#dashPagosDatatable", {
        columns: [
    ...
    dataTable.on("datatable.init", function (args) {
        document.getElementById("dashPagosDatatable").closest(".preload-wrapper").classList.add("opacity-10");
    });
});
