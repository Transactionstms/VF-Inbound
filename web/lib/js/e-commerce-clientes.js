...
document.addEventListener("DOMContentLoaded", function () {
    const dataTable = new simpleDatatables.DataTable("#clientDatatable", {
        columns: [
    ...
    dataTable.on("datatable.init", function (args) {
        document.getElementById("clientDatatable").closest(".preload-wrapper").classList.add("opacity-10");
    });
});
