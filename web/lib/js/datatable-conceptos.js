...
document.addEventListener("DOMContentLoaded", function () {
    const dataTable = new simpleDatatables.DataTable("#conceptosDatatable", {
        columns: [
    ...
    dataTable.on("datatable.init", function (args) {
        document.getElementById("uuidDatatable").closest(".preload-wrapper").classList.add("opacity-10");
    });
});
