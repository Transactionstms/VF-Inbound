                            ...
                            <div class="col-lg-12 mb-4 mb-lg-0">
                                <div class="card h-100">
                                    ...
                                    <div class="card-body">
                                        <form id="uploadFileFormData" name="uploadFileFormData">
                                            ...
                                            <div id="table-scroll" class="table-scroll">
                                                <table id="main-table" className="main-table">
                                                    <thead>
                                                        <tr>
                                                            <th scope="col" class="font-titulo">No.</th>
                                        ...
                                        <!--button-->
                                        <a class="btn btn-primary text-nowrap" id="uploadBtnid" name="uploadBtnid" role="button" onclick="save()" style="margin-top:7px; align-items: center ">Aceptar</a>
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    </div>
                                </div>
                            </div>
