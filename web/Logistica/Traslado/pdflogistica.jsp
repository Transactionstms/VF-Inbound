...
%><%
            try {
                ...
                try {
                    ...
                    String sql=" SELECT OE.EMBARQUE_TCUSTODIA,TTC.TC_DESCRIPCION, OE.NOMBRE_CUSTODIO, OE.NOMBRE_CUSTODIO2 FROM"
                + " TRA_INB_EMBARQUE_TRASLADO OE" 
                ...
                + " WHERE OE.EMBARQUE_AGRUPADOR ='"+agrupador+"'";
                        ...
                        if (e_cuentaPdf.equals("100")) {
                            ...
                            bd.addCell(talu);
                              ...
                              String  sql2 = " SELECT nvl(EMBARQUE_OBSERVACIONES,' ') "
                                      + "FROM TRA_INB_EMBARQUE_TRASLADO  where  embarque_agrupador='"+agrupador+"'  " ;
...
" FROM TRA_INB_EMBARQUE_TRASLADO e  \n" +
...
" WHERE e.embarque_agrupador='"+agrupador+"'" ;
  ...
  System.out.println("rowc[18]emit"+rowc[18]);
                  ...
                  + "  ";
                      ...
                      String    sql5 = "SELECT  COUNT(DISTINCT ode.destino_nombre)"
                        ...
                        for (int i = 0; i < bytes.length; i++) {
                           ...
                           Email correot = new Email();
                            ...
                            boolean correoPdf=true;
                             ...
                             if (db.doDB("select DISTINCT EMBARQUE_T_ID,EMBARQUE_AGRUPADOR from TRA_INB_EMBARQUE_TRASLADO where EMBARQUE_AGRUPADOR='"+agrupador+"'")) {
