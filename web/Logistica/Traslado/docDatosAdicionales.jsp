...
<div class="row">
    ...
    <script>
                                                            ...
                                                            function insertaEmbarque1(id, nom, banCus, idc, nomc) {
                                                                ...
                                                                document.getElementById('pdfiframe').src = "<%=request.getContextPath()%>/Logistica/Traslado/pdflogistica.jsp?a=<%=opciones%>&email=t&LTRANSPORTE_ID=" + id + "&nameLTransporte=" + nom + "&bc=" + banCus + "&idc=" + idc + "&nomc=" + nomc;
