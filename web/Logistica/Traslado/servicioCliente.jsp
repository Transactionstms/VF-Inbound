<%-- 
    ...
    Created on : 12/06/2023, 05:40:58 AM
    Author     : luis_
--%>
...
<html>
    ...
    <body>
        ...
        <div class="d-flex align-items-stretch">
            ...
            + " WHERE TIE.EMBARQUE_T_ID IN ('"+ embarque_id +"') "
            + " AND TIE.EMBARQUE_ESTADO_ID IN (1,4) ";
                                                        if (db.doDB(sql)) {
                                                           for (String[] row : db.getResultado()) {
                                                               
                                                               if (row[4].equals("1")) {
                                                                   href = request.getContextPath()+"/Logistica/Traslado/detalle_guia_embarque.jsp?embarque_id="+row[0];
                                                                   msj = "";
                                                               } else {
                                                                   href = "#";
