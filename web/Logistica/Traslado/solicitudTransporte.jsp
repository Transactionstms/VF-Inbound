...
<html>
    <head>
        ...
        <link href="<%=request.getContextPath()%>/lib/css/loader.css" rel="stylesheet" type="text/css"/> 
    ...
    <body>
                            ...
                            <div class="col-lg-12 mb-4 mb-lg-0">
                                <div class="card h-100">
                                    ...
                                    <div class="card-body " style="auto">
                                        <form class="col-sm-5 col-4" id="" name="" action="../Logistica/Traslado/plantillaSolicitudTransporte.jsp">
       ...
       window.location.href =  '<%=request.getContextPath()%>/Logistica/Traslado/plantillaSolicitudTransporte.jsp?tcarga='+tcarga+'&shipment='+shipment+'&container='+container+'&evento='+evento;
