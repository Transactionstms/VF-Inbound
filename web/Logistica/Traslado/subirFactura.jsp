...
<html lang="es">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="mb-3">  
                                            <div class="row">
                                                ...
                                                <%
                                                    if (db.doDB(" select EMBARQUE_T_ID from TRA_INB_EMBARQUE_TRASLADO where EMBARQUE_T_ID='" + op + "' ")) {
 ...
 <script>
                         ...
                         let formulario  = document.getElementById("miform1");
                             formulario.setAttribute('action', '<%=request.getContextPath()%>/Logistica/Traslado/subircfdi.jsp?documento=<%=op%>');
