...
String agrupa = "";
 ...
 String sqlEmb="select"
                    + " EMBARQUE_AGRUPADOR,"
         + " EMBARQUE_TRANSPORTISTA,"
         + " TO_CHAR(EMBARQUE_FEC_ENRAMPE, 'MM/DD/YYYY') ,"
         + " TO_CHAR(EMBARQUE_FEC_INICIO,  'MM/DD/YYYY') ,"
         + " EMBARQUE_TCUSTODIA,"
         + " CAMION_ID,UTRANSPORTE_ID,"
         + " NVL(CHOFER_ID,' '),"
         + " DSPMOV_ID,"
         + " EMBARQUE_FEC_REVISION,"
         + " EMBARQUE_FEC_FIN,"
         + " NVL(EMBARQUE_SELLO_CAJA,' '),"
         + " EMBARQUE_RELACION_ENT,"
                    ...
                    agrupa=row[0];
                                         ...
                                         <div class="container">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4 mb-4">
                                                        ...
                                                        <div class="input-group date" id="datepicker">
                                                            <input type="text" value="<%=row[2]%>" name="f_enrampe" id="f_enrampe" class="datepicker form-control"  autocomplete="off" size="10" required="required" >                                                        </div>
                                                    </div>

                                                    <div class="col-md-4 mb-4">
                                                        <label class="form-label" >Fecha de entrega</label>
                                                        <div class="input-group date" id="datepicker">
                                                            <input type="text" value="<%=row[3]%>" name="f_inicio" id="f_inicio" class="datepicker form-control"  autocomplete="off" size="10" required="required" >
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-md-3 mb-4">
                                                ...
                                                <input type="text" value="<%=row[5]%>" class="form-control" id="camiones">
                                            </div>
                                            <div class="col-md-3 mb-4">
                                            ...
                                            <div class="col-md-6 mb-4">
                                                ...
                                                <input type="text" class="form-control" id="chofer" value="<%=row[7]%>">
                                            </div>
                                            <div class="col-md-6 mb-4">
                                                <label class="form-label" for="dispositivos">Dispositivos</label>
                                                <input type="number" class="form-control" id="dispositivos" value="<%=row[8]%>">
                                            </div> 
                                         ...
                                         <!--   <div class="col-md-6 mb-4">
                                            ...
                                            <div class="col-md-6 mb-4">
                                                ...
                                                <input type="text" class="form-control" id="selloCaja" autocomplete="false" value="<%=row[11]%>">
                                            </div>
                                            <div class="col-md-6 mb-4">
                                          ...
                                          <!--  <div class="col-md-6 mb-4">
                                            ...
                                            <div class="col-md-6 mb-4">
                                                ...
                                                <div class="input-group date" id="datepicker">
                                                    <input type="text" name="date3" value="<%=row[13]%>" id="packingList" class="form-control" autocomplete="off" size="10" required="required">
                                                </div>   
                                            </div>
                                            <div class="col-md-6 mb-4">
                                            ...
                                            <div class="col-md-6 mb-4">
                                                ...
                                                <textarea type="text" class="form-control" id="observaciones" autocomplete="false"><%=row[15]%></textarea>
                                            </div>
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="row">                                                    
                                                    <div class="col-md-12" id="iframeid" style="display: none;">
                                                        ...
                                                        <script>
    // Suponiendo que `valorDefecto` es el valor traído de la base de datos
    const valorDefecto = 9;

    // Selecciona el <select> por su ID
    const selectOrigen = document.getElementById('origen');
    const tipoUnidadS = document.getElementById('tipoUnidad');
    const relacionEntregaS = document.getElementById('relacionEntrega');
    const autorS = document.getElementById('autor');

    // Establece la opción seleccionada usando el valor de `valorDefecto`
    selectOrigen.value     =  '<%=row[16]%>';
    tipoUnidadS.value      =  '<%=row[6]%>';
    relacionEntregaS.value =  '<%=row[12]%>';
    autorS.value           =  '<%=row[14]%>';
</script>
