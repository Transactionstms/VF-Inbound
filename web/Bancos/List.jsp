<%-- 
    Document   : List
    Created on : 29/12/2021, 05:57:11 PM
  ...
  <body>
    ...
    <header class="header">
      <!--<nav class="navbar navbar-expand-lg px-4 py-2 bg-white shadow">
          <a class="sidebar-toggler text-gray-500 me-4 me-lg-5 lead" href="#"><i class="fas fa-align-left"></i></a><a class="navbar-brand fw-bold text-uppercase text-base" href="index.jsp"><span class="d-none d-brand-partial"></span><span class="d-none d-sm-inline">Bancos</span></a>
      </nav>-->
    </header>
      ...
      <div class="page-holder bg-gray-100">
        <div class="container-fluid px-lg-4 px-xl-5">
            <div class="page-header">
                <h3 class="page-heading">Bancos</h3>
            </div>
          <section class="mb-5">
              <div class="row">
                  <div class="col-lg-10">
                      <a class="btn btn-primary" href="../Clientes/List.jsp"><i class="fas fa-long-arrow-alt-left"></i>&nbsp;Regresar a Clientes</a>  
                  </div>
                  <div class="col-lg-2">
                      <a class="btn btn-primary" href="Create.jsp"> <i class="fa fa-plus me-2"> </i>&nbsp;Agregar</a>
                  </div>
              </div>   
                ...
                <table class="table table-hover table-borderless align-middle mb-0" id="productsDatatable">
                  ...
                  <tbody>
                    <tr class="align-middle">
                      <td>11</td>
                      <td>MNM150227D32</td>
                      <td>COVESTRO S.A. DE C.V.</td>
                      <td><a class="me-3 text-lg text-info" href="Edit.jsp"><i class="far fa-edit"></i></a><a class="me-3 text-lg text-info" onclick="eliminar();"><i class="far fa-trash-alt"></i></a></td>
                    </tr>
                    <tr class="align-middle">
                      <td>11</td>
                      <td>MNM150227D32</td>
