<%-- 
    Document   : test
    Created on : 15/06/2023, 08:11:38 AM
    Author     : luis_
--%>
...
<head>
  ...
  <link href="../lib/SupportChosen/css/style.css" rel="stylesheet" type="text/css"/>
  <link href="../lib/SupportChosen/css/prism.css" rel="stylesheet" type="text/css"/>
  <link href="../lib/SupportChosen/css/chosen.css" rel="stylesheet" type="text/css"/>
...
<body>
  <form>
    <div id="container">
      ...
      <ul class="credits">
        <li>Concept and development by <a href="https://patrickfiller.com">Patrick Filler</a> for <a href="https://getharvest.com">Harvest</a>.</li>
        <li>Design and CSS by <a href="https://matthewlettini.com">Matthew Lettini</a>.</li>
      ...
      <footer>
        &copy; 2011&ndash;2016 <a href="https://www.getharvest.com/">Harvest</a>. Chosen is licensed under the <a href="https://github.com/harvesthq/chosen/blob/master/LICENSE.md">MIT license</a>.
      </footer>

    </div>
  </div>
  <script src="../lib/SupportChosen/js/jquery-3.2.1.min.js" type="text/javascript"></script>
  <script src="../lib/SupportChosen/js/chosen.jquery.js" type="text/javascript"></script>
  <script src="../lib/SupportChosen/js/prism.js" type="text/javascript"></script>
  <script src="../lib/SupportChosen/js/init.js" type="text/javascript"></script>
  </form>
  <div class="oss-bar">
    <ul>
      <li><a class="fork" href="https://github.com/harvesthq/chosen">Fork on Github</a></li>
      <li><a class="harvest" href="https://www.getharvest.com/">Built by Harvest</a></li>
    </ul>
  </div>
</body>
</html>
