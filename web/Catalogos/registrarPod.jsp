<%-- 
    Document   : registrarPod
    Created on : Oct 23, 2024, 3:45:42 PM
    Author     : HP
--%>
    ...
    <body>
                            ...
                            <div class="col-lg-12 mb-4 mb-lg-0">
                                <div class="card h-100">
                                    <div class="col-md-12 card-header justify-content-between">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <h2 class="card-heading">Registrar POD</h2>
                                                <br>
                                                <u>(Seleccione 'Fijar' unicamente para igual al POD de la lista)</u>
                                            </div>
                                        </div>
                                    </div>                                    
                                    <div class="card-body">
                                        ...
                                        <div class="contenedor">
                                            <div class="columna1">
                                                <select class="form-control" id="agente_aduanal_id" name="agente_aduanal_id">
                                                    <option value="0">-- Seleccione un agente aduanal --</option>
                                                    <%
                                                        if (db.doDB("SELECT DISTINCT AGENTE_ADUANAL_ID, AGENTE_ADUANAL_NOMBRE FROM TRA_INB_AGENTE_ADUANAL ORDER BY AGENTE_ADUANAL_ID ASC")) {
                                        ...
                                        <br>   
                                        <div class="row">
                                            <button class="btn btn-success" style="width:200px;" id="btn" name="btn" onclick="insertarPOD()">REGISTRAR</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <script>
            ...
            function autocompleteSearch(txt) {
                fetch("<%=request.getContextPath()%>/AutocompletePOD?txt=" + txt, {
                    method: 'POST'
                }).then(r => r.text())
                        .then(data => {
                            if (data === "0") {
            ...
            function pod(value) {
                ...
                let agente_aduanal_id = document.getElementById("agente_aduanal_id").value;
                
                fetch("<%=request.getContextPath()%>/InsertarPOD?nombre_pod=" + value + "&id_pod=" + id_pod + "&agente_aduanal_id="+ agente_aduanal_id, {
                    method: 'POST'
                }).then(r => r.text())
                        .then(data => {
                            if (data === "true") {
            ...
            function position(contador) {
                id_pod = document.getElementById("pod" + contador).value;
            }
