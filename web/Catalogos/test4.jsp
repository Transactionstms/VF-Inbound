<%-- 
    Document   : test4
    Created on : 15/06/2023, 09:40:23 AM
    Author     : luis_
--%>
    ...
    <body>
        ...
        <div class="multiselect-container">
          ...
          <div class="multiselect-controls">
            ...
            <button id="clearSelection">Desmarcar</button>
          </div>
        </div>
        <script>
...
// Obtener los botones de agregar, eliminar y desmarcar opciones
...
// Manejar el evento de clic en el botón "Desmarcar"
