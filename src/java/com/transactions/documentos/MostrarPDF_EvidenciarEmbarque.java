 ...
 * @author luis_
 */
@WebServlet(name = "MostrarPDF_EvidenciarEmbarque", urlPatterns = {"/MostrarPDF_EvidenciarEmbarque"})
public class MostrarPDF_EvidenciarEmbarque extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            String sql = " SELECT DISTINCT "
                       + " NVL(URL_POD,'SIN INFORMACIÓN') "
                       + " FROM TRA_INC_GTN_TEST "
                       + " WHERE SHIPMENT_ID = TRIM('" + shipmentId + "')";
            try {
