 ...
 * @author luis_
 */
@WebServlet(name = "MostrarPDF_EvidenciaCFDI", urlPatterns = {"/MostrarPDF_EvidenciaCFDI"})
public class MostrarPDF_EvidenciaCFDI extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            String embarqueAgrupador = request.getParameter("embarqueAgrupador");
            
            String sql = " SELECT DISTINCT "
                       + " NVL(URL_CFDI,'SIN INFORMACIÓN') "
                       + " FROM TRA_INB_EMBARQUE "
                       + " WHERE EMBARQUE_AGRUPADOR = TRIM('" + embarqueAgrupador + "')";
            try {
