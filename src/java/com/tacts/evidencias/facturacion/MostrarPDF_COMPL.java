 ...
 */
@WebServlet(name = "MostrarPDF_COMPL", urlPatterns = {"/MostrarPDF_COMPL"})
public class MostrarPDF_COMPL extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            String stringImg = "";
                String nomArchivo = "";
                nomArchivo = "D:\\Servicios\\Facturacion\\ReciboDePago\\VisualizacionReciboPago.pdf";
