 ...
 * @author luis_
 */
@WebServlet(name = "MostrarPDF_FILE", urlPatterns = {"/MostrarPDF_FILE"})
public class MostrarPDF_FILE extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            String nomArchivo = "";
            nomArchivo = "D:\\Servicios\\Facturacion\\Cfdi\\" + id + ".pdf";
