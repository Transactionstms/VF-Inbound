 ...
 * @author luis_
 */
@WebServlet(name = "MostrarPDFTicket_FACT", urlPatterns = {"/MostrarPDFTicket_FACT"})
public class MostrarPDFTicket_FACT extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            String stringImg = "";
                String nomArchivo = "";
                nomArchivo = "D:\\Servicios\\Facturacion\\Tickets\\VisualizacionFacturaTickets.pdf";
