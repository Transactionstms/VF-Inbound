 ...
 * @author luis_
 */
public class GeneratePDFCartaPorte {
     ...
     */
    public void createPDFCartaPorte(File pdfNewFile, String id) throws SQLException {
        ...
        try {
            ...
            documento.close();
            System.out.println("¡Se ha generado el PDF Carta Porte!");
