 ...
 * @author luis_
 */
@WebServlet(name = "MostrarPDF_FACT", urlPatterns = {"/MostrarPDF_FACT"})
public class MostrarPDF_FACT extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            String stringImg = "";
                String nomArchivo = "";
                nomArchivo = "D:\\Servicios\\Facturacion\\Cfdi\\VisualizacionFactura.pdf";
