...
@WebServlet(name = "DownloadExcelEventsImport", urlPatterns = { "/DownloadExcelEventsImport" })
public class DownloadExcelEventsImport extends HttpServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        String filePath = "D:\\Servicios\\VFINBOUND\\ReporteEventosImportados.xls"; // Ruta del archivo en el servidor

        // Establecer el tipo de contenido y la longitud del archivo a descargar
        response.setContentType("application/octet-stream");
        // sresponse.setContentLengthLong(Long.BYTES);

        // Establecer encabezados para la descarga de archivos
        String headerKey = "Content-Disposition";
        String headerValue = String.format("attachment; filename=\"%s\"", "ReporteEventosImportados.xls");
