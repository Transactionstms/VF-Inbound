...
public class CreatExcelCustoms {  
    ...
    public static String crearAPartirDeArrayListCustoms(String agenteId, String estatusSemaforo, String tipoCorreo) {
        ...
        try {
            ...
            Statement stmt = dao.conectar().prepareStatement(fac.consultarCustomsSemaforo(agenteId,estatusSemaforo));
            ResultSet rs = stmt.executeQuery(fac.consultarCustomsSemaforo(agenteId,estatusSemaforo));
            while(rs.next()){
                personas.add(new ModelCustom(
        ...
        for (int i = 0; i < personas.size(); i++) {
            ...
            ModelCustom persona = personas.get(i);
