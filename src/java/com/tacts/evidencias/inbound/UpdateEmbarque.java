 ...
 // Verificar si el string no está vacío
        if (!origen.isEmpty()) {
            ...
            if (firstChar == 'M') {
                 ...
                 String sqlGtn="update tra_inc_gtn_test set STATUS_EMBARQUE=0,EMBARQUE_AGRUPADOR=null where EMBARQUE_AGRUPADOR=( select EMBARQUE_AGRUPADOR from tra_inb_embarque_traslado  WHERE EMBARQUE_T_ID = '"+origen+"') ";
           
                    update1=db.doDB(sqlGtn); 
