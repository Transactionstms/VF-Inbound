...
import com.tacts.model.inbound.excelReporteEventosImportados;
 ...
 */
public class CreatExcelReporteEventosImportados {

    public static String crearAPartirDeArrayListReporteEventosImportados(String tipoAgente, String tipoFiltro, String id, String fechaInicial, String fechaFinal) {

        ArrayList<excelReporteEventosImportados> importados = new ArrayList<>();
        ServiceDAO dao = new ServiceDAO();
        ConsultasQuery fac = new ConsultasQuery();

        try {

            Statement stmt = dao.conectar().prepareStatement(fac.consultarReporteEventosImportados(tipoAgente, tipoFiltro, id, fechaInicial, fechaFinal));
            ResultSet rs = stmt.executeQuery(fac.consultarReporteEventosImportados(tipoAgente, tipoFiltro, id, fechaInicial, fechaFinal));
            while (rs.next()) {
                importados.add(new excelReporteEventosImportados(
        ...
        final String nombreArchivo = "ReporteEventosImportados.xls";
        Sheet hoja = workbook.createSheet("Detalle Eventos Importados " + tipoAgente);
        ...
        for (int i = 0; i < importados.size(); i++) {
            ...
            excelReporteEventosImportados persona = importados.get(i);
