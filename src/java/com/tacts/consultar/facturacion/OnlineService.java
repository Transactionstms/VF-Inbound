...
import com.onest.security.menu.MenuFactory;
import com.onest.train.security.Authenticate;
import com.onest.train.security.ObtenerCuentas;
...
public class OnlineService extends HttpServlet {
    ...
    private String targetOk = "/OnlineService.jsp";
