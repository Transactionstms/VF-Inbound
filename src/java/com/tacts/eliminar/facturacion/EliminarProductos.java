...
public class EliminarProductos extends HttpServlet {
    ...
    try (PrintWriter out = response.getWriter()) {
        ...
        String modificarClie =" UPDATE TRA_PRODUCTOS_SERVICIOS SET ESTADO_ID = '"+ estatus_id +"' WHERE CLVREG_ID = '" + clvreg_id + "' AND CBDIV_ID = '" + cve + "' ";
        boolean oraOut = oraDB.execute(modificarClie);
