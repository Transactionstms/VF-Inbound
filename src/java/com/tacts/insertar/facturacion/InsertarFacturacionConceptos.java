 ...
 * @author luis_
 */
public class InsertarFacturacionConceptos extends HttpServlet {
    ...
    try (PrintWriter out = response.getWriter()) {
        ...
        String insertarConceptos = "";
        boolean oraOut = oraDB.execute(insertarConceptos);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(InsertarFacturacionConceptos.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
