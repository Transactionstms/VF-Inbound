 ...
 * @author Sistemas
 */
@WebServlet(name = "GraficaTiendas", urlPatterns = {"/GraficaTiendas"})
public class GraficaTiendas extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            try {
                ...
                String oracleQuery = "DECLARE Pcuentas "+PropertiesUtil.getDbConexionProperties(PropertiesUtil.ORACLE_KEY_USER)+".ARRAY_INT; BEGIN Pcuentas:="+PropertiesUtil.getDbConexionProperties(PropertiesUtil.ORACLE_KEY_USER)+".ARRAY_INT();Pcuentas.EXTEND(10);"+sqlText+"  ? := tra_fn_grafica_embarques_tdas(Pcuentas); END;";
