 ...
 * @author Sistemas
 */
@WebServlet(name = "GraficaEmbarquesDiarios", urlPatterns = {"/GraficaEmbarquesDiarios"})
public class GraficaEmbarquesDiarios extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            try {
                ...
                String oracleQuery = "DECLARE Pcuentas "+PropertiesUtil.getDbConexionProperties(PropertiesUtil.ORACLE_KEY_USER)+".ARRAY_INT; BEGIN Pcuentas:="+PropertiesUtil.getDbConexionProperties(PropertiesUtil.ORACLE_KEY_USER)+".ARRAY_INT();Pcuentas.EXTEND(10);"+sqlText+"  ? := ONTMS_FN_GRAFICA_EMBARQUES_DC(Pcuentas); END;";
