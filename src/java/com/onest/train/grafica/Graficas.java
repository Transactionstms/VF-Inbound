 ...
 */
package com.onest.train.grafica;
...
public class Graficas extends HttpServlet {
 ...
 String sqlText="";
                ...
                String oracleQuery = "DECLARE Pcuentas "+PropertiesUtil.getDbConexionProperties(PropertiesUtil.ORACLE_KEY_USER)+".ARRAY_INT; BEGIN Pcuentas:="+PropertiesUtil.getDbConexionProperties(PropertiesUtil.ORACLE_KEY_USER)+".ARRAY_INT();Pcuentas.EXTEND(10);"+sqlText+"  ? := ONTMS_FN_GRAFICA_EMBARQUES_D(Pcuentas); END;";

                //String oracleQuery = "BEGIN ? := ONTMS_FN_GRAFICA_EMBARQUES_D; END;";
