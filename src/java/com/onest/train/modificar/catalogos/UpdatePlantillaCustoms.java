 ...
 */
public class UpdatePlantillaCustoms extends HttpServlet {

    private Conexion cnBaseDeDatos;

    public UpdatePlantillaCustoms() {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                if (agente_id.equals("4006")) {              //Plantilla Administrador
                    ...
                    sp1 = Upltd_gtnConShipmentId.SP_INB_SUBIRCUSTOMS_ADMIN(this.cnBaseDeDatos, pNUMERO_DE_EVENTO, pSHIPMENT_ID, pCONTAINER_ID, pREFERENCIA_AA, pPRIORIDAD, pPAIS_ORIGEN, pSIZE_CONTAINER, pVALOR_USD, pETA_PORT_OF_DISCHARGE, pAGENTE_ADUANAL, pPEDIMENTO_A1, pPEDIMENTO_R1, pMOTIVO_RECTIFICACION_1, pPEDIMENTO_R1_2DO, pMOTIVO_RECTIFICACION_2, pFECHA_RECEPCION_DOCUMENTOS, pRECINTO, pNAVIERA_FORWARDER, pBUQUE, pFECHA_REVALID_LIBE_BL, pFECHA_PREVIO_ORIGEN, pFECHA_PREVIO_DESTINO, pFECHA_RESULTADO_PREVIO, pPROFORMA_FINAL, pREQUIERE_PERMISO, pFECHA_ENVIO_FICHAS_NOTAS, pFEC_RECEPCION_PERMISOS_TRAMIT, pFEC_ACT_PERMISOS, pFEC_PERM_AUT, pCO_APLIC_PREF_ARANCELARIA, pAPLIC_PREF_ARANCELARIA_CO, pREQUIERE_UVA, pREQUIERE_CA, pFECHA_RECEPCION_CA, pNÚMERO_CONSTANCIA_CA, pMONTO_CA, pFECHA_DOCUMENTOS_COMPLETOS, pFECHA_PAGO_PEDIMENTO, pFECHA_SOLICITUD_TRANSPORTE, pFECHA_MODULACION, pMODALIDAD_CAMION_TREN, pRESULT_MODULACION_VERDE_ROJO, pFECHA_RECONOCIMIENTO, pFECHA_LIBERACION, pSELLO_ORIGEN, pSELLO_FINAL, pFECHA_RETENCION_AUTORIDAD, pFECHA_LIB_POR_RET_AUT, pESTATUS_OPERACION, pMOTIVO_ATRASO, pOBSERVACIONES, pLLEGADA_A_NOVA, pLLEGADA_A_GLOBE_TRADE_SD, pARCHIVO_M, pFECHA_ARCHIVO_M, pFECHA_SOLICIT_MANIP, pFECHA_VENCIM_MANIP, pFECHA_CONFIRM_CLAVE_PEDIM, pFECHA_RECEP_INCREMENT, pT_E, pFECHA_VENCIM_INBOUND, pNO_BULTOS, pPESO_KG, pTRANSFERENCIA, pFECHA_INICIO_ETIQUETADO, pFECHA_TERMINO_ETIQUETADO, pHORA_TERMINO_ETIQUETADO, pPROVEEDOR, pPROVEEDOR_CARGA, pFY);
                    sp1.execute();
                    ...
                    sp1 = Upltd_gtnConShipmentId.SP_INB_SUBIRCUSTOMS_GRAL(this.cnBaseDeDatos, pNUMERO_DE_EVENTO, pSHIPMENT_ID, pCONTAINER_ID, pREFERENCIA_AA, pPRIORIDAD, pPAIS_ORIGEN, pSIZE_CONTAINER, pVALOR_USD, pETA_PORT_OF_DISCHARGE, pAGENTE_ADUANAL, pPEDIMENTO_A1, pPEDIMENTO_R1, pMOTIVO_RECTIFICACION_1, pPEDIMENTO_R1_2DO, pMOTIVO_RECTIFICACION_2, pFECHA_RECEPCION_DOCUMENTOS, pRECINTO, pNAVIERA_FORWARDER, pBUQUE, pFECHA_REVALID_LIBE_BL, pFECHA_PREVIO_ORIGEN, pFECHA_PREVIO_DESTINO, pFECHA_RESULTADO_PREVIO, pPROFORMA_FINAL, pREQUIERE_PERMISO, pFECHA_ENVIO_FICHAS_NOTAS, pFEC_RECEPCION_PERMISOS_TRAMIT, pFEC_ACT_PERMISOS, pFEC_PERM_AUT, pCO_APLIC_PREF_ARANCELARIA, pAPLIC_PREF_ARANCELARIA_CO, pREQUIERE_UVA, pREQUIERE_CA, pFECHA_RECEPCION_CA, pNÚMERO_CONSTANCIA_CA, pMONTO_CA, pFECHA_DOCUMENTOS_COMPLETOS, pFECHA_PAGO_PEDIMENTO, pFECHA_SOLICITUD_TRANSPORTE, pFECHA_MODULACION, pMODALIDAD_CAMION_TREN, pRESULT_MODULACION_VERDE_ROJO, pFECHA_RECONOCIMIENTO, pFECHA_LIBERACION, pSELLO_ORIGEN, pSELLO_FINAL, pFECHA_RETENCION_AUTORIDAD, pFECHA_LIB_POR_RET_AUT, pESTATUS_OPERACION, pMOTIVO_ATRASO, pOBSERVACIONES, pFY);
                    sp1.execute();
                    ...
                    sp1 = Upltd_gtnConShipmentId.SP_INB_SUBIRCUSTOMS_CUSA(this.cnBaseDeDatos, pNUMERO_DE_EVENTO, pSHIPMENT_ID, pCONTAINER_ID, pREFERENCIA_AA, pPRIORIDAD, pPAIS_ORIGEN, pSIZE_CONTAINER, pVALOR_USD, pETA_PORT_OF_DISCHARGE, pAGENTE_ADUANAL, pPEDIMENTO_A1, pPEDIMENTO_R1, pMOTIVO_RECTIFICACION_1, pPEDIMENTO_R1_2DO, pMOTIVO_RECTIFICACION_2, pFECHA_RECEPCION_DOCUMENTOS, pRECINTO, pNAVIERA_FORWARDER, pBUQUE, pFECHA_REVALID_LIBE_BL, pFECHA_PREVIO_ORIGEN, pFECHA_PREVIO_DESTINO, pFECHA_RESULTADO_PREVIO, pPROFORMA_FINAL, pREQUIERE_PERMISO, pFECHA_ENVIO_FICHAS_NOTAS, pFEC_RECEPCION_PERMISOS_TRAMIT, pFEC_ACT_PERMISOS, pFEC_PERM_AUT, pCO_APLIC_PREF_ARANCELARIA, pAPLIC_PREF_ARANCELARIA_CO, pREQUIERE_UVA, pREQUIERE_CA, pFECHA_RECEPCION_CA, pNÚMERO_CONSTANCIA_CA, pMONTO_CA, pFECHA_DOCUMENTOS_COMPLETOS, pFECHA_PAGO_PEDIMENTO, pFECHA_SOLICITUD_TRANSPORTE, pFECHA_MODULACION, pMODALIDAD_CAMION_TREN, pRESULT_MODULACION_VERDE_ROJO, pFECHA_RECONOCIMIENTO, pFECHA_LIBERACION, pSELLO_ORIGEN, pSELLO_FINAL, pFECHA_RETENCION_AUTORIDAD, pFECHA_LIB_POR_RET_AUT, pESTATUS_OPERACION, pMOTIVO_ATRASO, pOBSERVACIONES, pNO_BULTOS, pPESO_KG, pTRANSFERENCIA, pFECHA_INICIO_ETIQUETADO, pFECHA_TERMINO_ETIQUETADO, pHORA_TERMINO_ETIQUETADO, pPROVEEDOR, pPROVEEDOR_CARGA, pFY);
                    sp1.execute();
                    ...
                    sp1 = Upltd_gtnConShipmentId.SP_INB_SUBIRCUSTOMS_LOGIX(this.cnBaseDeDatos, pNUMERO_DE_EVENTO, pSHIPMENT_ID, pCONTAINER_ID, pREFERENCIA_AA, pPRIORIDAD, pPAIS_ORIGEN, pSIZE_CONTAINER, pVALOR_USD, pETA_PORT_OF_DISCHARGE, pAGENTE_ADUANAL, pPEDIMENTO_A1, pPEDIMENTO_R1, pMOTIVO_RECTIFICACION_1, pPEDIMENTO_R1_2DO, pMOTIVO_RECTIFICACION_2, pFECHA_RECEPCION_DOCUMENTOS, pRECINTO, pNAVIERA_FORWARDER, pBUQUE, pFECHA_REVALID_LIBE_BL, pFECHA_PREVIO_ORIGEN, pFECHA_PREVIO_DESTINO, pFECHA_RESULTADO_PREVIO, pPROFORMA_FINAL, pREQUIERE_PERMISO, pFECHA_ENVIO_FICHAS_NOTAS, pFEC_RECEPCION_PERMISOS_TRAMIT, pFEC_ACT_PERMISOS, pFEC_PERM_AUT, pCO_APLIC_PREF_ARANCELARIA, pAPLIC_PREF_ARANCELARIA_CO, pREQUIERE_UVA, pREQUIERE_CA, pFECHA_RECEPCION_CA, pNÚMERO_CONSTANCIA_CA, pMONTO_CA, pFECHA_DOCUMENTOS_COMPLETOS, pFECHA_PAGO_PEDIMENTO, pFECHA_SOLICITUD_TRANSPORTE, pFECHA_MODULACION, pMODALIDAD_CAMION_TREN, pRESULT_MODULACION_VERDE_ROJO, pFECHA_RECONOCIMIENTO, pFECHA_LIBERACION, pSELLO_ORIGEN, pSELLO_FINAL, pFECHA_RETENCION_AUTORIDAD, pFECHA_LIB_POR_RET_AUT, pESTATUS_OPERACION, pMOTIVO_ATRASO, pOBSERVACIONES, pLLEGADA_A_NOVA, pLLEGADA_A_GLOBE_TRADE_SD, pARCHIVO_M, pFECHA_ARCHIVO_M, pFECHA_SOLICIT_MANIP, pFECHA_VENCIM_MANIP, pFECHA_CONFIRM_CLAVE_PEDIM, pFECHA_RECEP_INCREMENT, pT_E, pFECHA_VENCIM_INBOUND, pFY);
                    sp1.execute();
                }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(UpdatePlantillaCustoms.class.getName()).log(Level.SEVERE, null, ex);
        } catch (Exception ex) {
            Logger.getLogger(UpdatePlantillaCustoms.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
