...
public class ConsultarCustomsBacheo extends HttpServlet {
    ...
    /*  ----------------------------- FILTROS MULTISELECT ENCABEZADOS  -----------------------------  */  
        ...
        /*10*/ + " SQ.SUMA, "
        /*11*/ + " TIP1.NOMBRE_POD, "
        /*12*/ + " CASE WHEN nvl(to_char(GTN.EST_DEPARTURE_POL, 'MM/DD/YYYY'), ' ') =  '12/30/1899' THEN ' ' WHEN  nvl(to_char(GTN.EST_DEPARTURE_POL, 'MM/DD/YYYY'), ' ') =  '12/30/1999' THEN ' ' ELSE NVL(TO_CHAR(TO_DATE(GTN.EST_DEPARTURE_POL, 'MM/DD/YYYY'), 'Mon/DD/YY'),' ')  END, "  
        /*13*/ + " CASE WHEN nvl(to_char(GTN.ETA_PORT_DISCHARGE, 'MM/DD/YYYY'), ' ') =  '12/30/1899' THEN ' ' WHEN  nvl(to_char(GTN.ETA_PORT_DISCHARGE, 'MM/DD/YYYY'), ' ') =  '12/30/1999' THEN ' ' ELSE NVL(TO_CHAR(TO_DATE(GTN.ETA_PORT_DISCHARGE, 'MM/DD/YYYY'), 'Mon/DD/YY'),' ')  END, "  
        /*14*/ + " NVL(GTN.MAX_FLETE, 0) AS EST_ETA_DC, "
        /*15*/ + " CASE WHEN nvl(to_char(GTN.FECHA_CAPTURA, 'MM/DD/YYYY'), ' ') =  '12/30/1899' THEN ' ' WHEN  nvl(to_char(GTN.FECHA_CAPTURA, 'MM/DD/YYYY'), ' ') =  '12/30/1999' THEN ' '  ELSE NVL(TO_CHAR(TO_DATE(GTN.FECHA_CAPTURA, 'MM/DD/YYYY'), 'Mon/DD/YY'),' ')  END, "  
        /*16*/ + " TIP2.NOMBRE_POL, "
        ...
        /*21*/ + " TIP2.NOMBRE_POL, "
        /*22*/ + " TIBD.NOMBRE_BD, "
        /*23*/ + " CASE WHEN nvl(to_char(GTN.ETA_PLUS2, 'MM/DD/YYYY'), ' ') =  '12/30/1899' THEN ' ' WHEN  nvl(to_char(GTN.ETA_PLUS2, 'MM/DD/YYYY'), ' ') =  '12/30/1999' THEN ' ' ELSE NVL(TO_CHAR(TO_DATE(tic.eta_port_of_discharge, 'MM/DD/YYYY'), 'Mon/DD/YY'),' ')  END, "  
        /*24*/ + " CASE WHEN nvl(to_char(TIE.EST_ETA_DC, 'MM/DD/YYYY'), ' ') =  '12/30/1899' THEN ' ' WHEN  nvl(to_char(TIE.EST_ETA_DC, 'MM/DD/YYYY'), ' ') =  '12/30/1999' THEN ' '  ELSE NVL(TO_CHAR(TO_DATE(tic.eta_port_of_discharge, 'MM/DD/YYYY'), 'Mon/DD/YY'),' ')  END , "  
        /*25*/ + " CASE WHEN nvl(to_char(GTN.ETA_PLUS, 'MM/DD/YYYY'), ' ') =  '12/30/1899' THEN ' ' WHEN  nvl(to_char(GTN.ETA_PLUS, 'MM/DD/YYYY'), ' ') =  '12/30/1999' THEN ' ' ELSE NVL(TO_CHAR(TO_DATE(tic.eta_port_of_discharge, 'MM/DD/YYYY'), 'Mon/DD/YY'),' ')  END, "  
        /*26*/ + " NVL(TIE.OBSERVACIONES, ' ') AS OBSERVACIONES, "
        /*27*/ + " TIE.ESTATUS_EVENTO, "
        /*28*/ + " NVL(TIE.REFERENCIA_AA,' '), "
        /*29*/ + " CASE WHEN nvl(to_char(TIE.FECHA_CAPTURA, 'MM/DD/YYYY'), ' ') =  '12/30/1899' THEN ' ' WHEN  nvl(to_char(TIE.FECHA_CAPTURA, 'MM/DD/YYYY'), ' ') =  '12/30/1999' THEN ' '  ELSE NVL(TO_CHAR(TO_DATE(TIE.FECHA_CAPTURA, 'MM/DD/YYYY'), 'Mon/DD/YY'),' ')  END, "  
        /*30*/ + " NVL(TIE.PRIORIDAD,' '), "
        /*31*/ + " NVL(TIC.REFERENCIA_AA,' '), "
        /*32*/ + " NVL(TIC.PAIS_ORIGEN,' '), "
        /*33*/ + " NVL(TIC.SIZE_CONTAINER,' '), "
        /*34*/ + " NVL(TIC.VALOR_USD,' '), "
        /*35*/ + " CASE WHEN nvl(to_char(TIC.ETA_PORT_OF_DISCHARGE, 'MM/DD/YYYY'), ' ') =  '12/30/1899' THEN ' ' WHEN  nvl(to_char(TIC.ETA_PORT_OF_DISCHARGE, 'MM/DD/YYYY'), ' ') =  '12/30/1999' THEN ' '  ELSE NVL(TO_CHAR(TO_DATE(TIC.ETA_PORT_OF_DISCHARGE, 'MM/DD/YYYY'), 'Mon/DD/YY'),' ')  END, "  
        ...
        /*42*/ + " CASE WHEN nvl(to_char(TIC.FECHA_RECEPCION_DOCUMENTOS, 'MM/DD/YYYY'), ' ') =  '12/30/1899' THEN ' ' WHEN  nvl(to_char(TIC.FECHA_RECEPCION_DOCUMENTOS, 'MM/DD/YYYY'), ' ') =  '12/30/1999' THEN ' '  ELSE NVL(TO_CHAR(TO_DATE(TIC.FECHA_RECEPCION_DOCUMENTOS, 'MM/DD/YYYY'), 'Mon/DD/YY'),' ')  END, "  
        /*43*/ + " NVL(TIC.RECINTO,' '), "
        /*44*/ + " NVL(TIC.NAVIERA_FORWARDER,' '), "
        /*45*/ + " NVL(TIC.BUQUE,' '), "
        /*46*/ + " CASE WHEN nvl(to_char(TIC.FECHA_REVALID_LIBE_BL, 'MM/DD/YYYY'), ' ') =  '12/30/1899' THEN ' ' WHEN  nvl(to_char(TIC.FECHA_REVALID_LIBE_BL, 'MM/DD/YYYY'), ' ') =  '12/30/1999' THEN ' ' ELSE NVL(TO_CHAR(TO_DATE(TIC.FECHA_REVALID_LIBE_BL, 'MM/DD/YYYY'), 'Mon/DD/YY'),' ')  END, "  
        /*47*/ + " CASE WHEN nvl(to_char(TIC.FECHA_PREVIO_ORIGEN, 'MM/DD/YYYY'), ' ') =  '12/30/1899' THEN ' ' WHEN  nvl(to_char(TIC.FECHA_PREVIO_ORIGEN, 'MM/DD/YYYY'), ' ') =  '12/30/1999' THEN ' ' ELSE NVL(TO_CHAR(TO_DATE(TIC.FECHA_PREVIO_ORIGEN, 'MM/DD/YYYY'), 'Mon/DD/YY'),' ')  END, "  
        /*48*/ + " CASE WHEN nvl(to_char(TIC.FECHA_PREVIO_DESTINO, 'MM/DD/YYYY'), ' ') =  '12/30/1899' THEN ' ' WHEN  nvl(to_char(TIC.FECHA_PREVIO_DESTINO, 'MM/DD/YYYY'), ' ') =  '12/30/1999' THEN ' '  ELSE NVL(TO_CHAR(TO_DATE(TIC.FECHA_PREVIO_DESTINO, 'MM/DD/YYYY'), 'Mon/DD/YY'),' ')  END, "  
        /*49*/ + " CASE WHEN nvl(to_char(TIC.FECHA_RESULTADO_PREVIO, 'MM/DD/YYYY'), ' ') =  '12/30/1899' THEN ' '  WHEN  nvl(to_char(TIC.FECHA_RESULTADO_PREVIO, 'MM/DD/YYYY'), ' ') =  '12/30/1999' THEN ' ' ELSE NVL(TO_CHAR(TO_DATE(TIC.FECHA_RESULTADO_PREVIO, 'MM/DD/YYYY'), 'Mon/DD/YY'),' ')  END, "  
        /*50*/ + " CASE WHEN nvl(to_char(TIC.PROFORMA_FINAL, 'MM/DD/YYYY'), ' ') =  '12/30/1899' THEN ' ' WHEN  nvl(to_char(TIC.PROFORMA_FINAL, 'MM/DD/YYYY'), ' ') =  '12/30/1999' THEN ' '  ELSE NVL(TO_CHAR(TO_DATE(TIC.PROFORMA_FINAL, 'MM/DD/YYYY'), 'Mon/DD/YY'),' ')  END, "  
        /*51*/ + " NVL(TIC.REQUIERE_PERMISO,' '), "
        /*52*/ + " CASE WHEN nvl(to_char(TIC.FECHA_ENVIO_FICHAS_NOTAS, 'MM/DD/YYYY'), ' ') =  '12/30/1899' THEN ' ' WHEN  nvl(to_char(TIC.FECHA_ENVIO_FICHAS_NOTAS, 'MM/DD/YYYY'), ' ') =  '12/30/1999' THEN ' '  ELSE NVL(TO_CHAR(TO_DATE(TIC.FECHA_ENVIO_FICHAS_NOTAS, 'MM/DD/YYYY'), 'Mon/DD/YY'),' ')  END, "  
        /*53*/ + " CASE WHEN nvl(to_char(TIC.FEC_RECEPCION_PERMISOS_TRAMIT, 'MM/DD/YYYY'), ' ') =  '12/30/1899' THEN ' ' WHEN  nvl(to_char(TIC.FEC_RECEPCION_PERMISOS_TRAMIT, 'MM/DD/YYYY'), ' ') =  '12/30/1999' THEN ' '  ELSE NVL(TO_CHAR(TO_DATE(TIC.FEC_RECEPCION_PERMISOS_TRAMIT, 'MM/DD/YYYY'), 'Mon/DD/YY'),' ')  END, "  
        /*54*/ + " CASE WHEN nvl(to_char(TIC.FEC_ACT_PERMISOS, 'MM/DD/YYYY'), ' ') =  '12/30/1899' THEN ' ' WHEN  nvl(to_char(TIC.FEC_ACT_PERMISOS, 'MM/DD/YYYY'), ' ') =  '12/30/1999' THEN ' '  ELSE NVL(TO_CHAR(TO_DATE(TIC.FEC_ACT_PERMISOS, 'MM/DD/YYYY'), 'Mon/DD/YY'),' ')  END, "  
        /*55*/ + " CASE WHEN nvl(to_char(TIC.FEC_PERM_AUT, 'MM/DD/YYYY'), ' ') =  '12/30/1899' THEN ' ' WHEN  nvl(to_char(TIC.FEC_PERM_AUT, 'MM/DD/YYYY'), ' ') =  '12/30/1999' THEN ' ' ELSE NVL(TO_CHAR(TO_DATE(TIC.FEC_PERM_AUT, 'MM/DD/YYYY'), 'Mon/DD/YY'),' ')  END, "  
        /*56*/ + " NVL(TIC.CO_APLIC_PREF_ARANCELARIA,' '), "
        /*57*/ + " NVL(TIC.APLIC_PREF_ARANCELARIA_CO,' '), "
        /*58*/ + " NVL(TIC.REQUIERE_UVA,' '), "
        /*59*/ + " NVL(TIC.REQUIERE_CA,' '), "
        /*60*/ + " CASE WHEN nvl(to_char(TIC.FECHA_RECEPCION_CA, 'MM/DD/YYYY'), ' ') =  '12/30/1899' THEN ' ' WHEN  nvl(to_char(TIC.FECHA_RECEPCION_CA, 'MM/DD/YYYY'), ' ') =  '12/30/1999' THEN ' ' ELSE NVL(TO_CHAR(TO_DATE(TIC.FECHA_RECEPCION_CA, 'MM/DD/YYYY'), 'Mon/DD/YY'),' ')  END, "  
        /*61*/ + " NVL(TIC.NÚMERO_CONSTANCIA_CA,' '), "
        /*62*/ + " NVL(TIC.MONTO_CA,' '), "
        /*63*/ + " CASE WHEN nvl(to_char(TIC.FECHA_DOCUMENTOS_COMPLETOS, 'MM/DD/YYYY'), ' ') =  '12/30/1899' THEN ' '  WHEN  nvl(to_char(TIC.FECHA_DOCUMENTOS_COMPLETOS, 'MM/DD/YYYY'), ' ') =  '12/30/1999' THEN ' ' ELSE NVL(TO_CHAR(TO_DATE(TIC.FECHA_DOCUMENTOS_COMPLETOS, 'MM/DD/YYYY'), 'Mon/DD/YY'),' ')  END, "  
        /*64*/ + " CASE WHEN nvl(to_char(TIC.FECHA_PAGO_PEDIMENTO, 'MM/DD/YYYY'), ' ') =  '12/30/1899' THEN ' ' WHEN  nvl(to_char(TIC.FECHA_PAGO_PEDIMENTO, 'MM/DD/YYYY'), ' ') =  '12/30/1999' THEN ' '   ELSE NVL(TO_CHAR(TO_DATE(TIC.FECHA_PAGO_PEDIMENTO, 'MM/DD/YYYY'), 'Mon/DD/YY'),' ')  END,"  
        /*65*/ + " CASE WHEN nvl(to_char(TIC.FECHA_SOLICITUD_TRANSPORTE, 'MM/DD/YYYY'), ' ') =  '12/30/1899' THEN ' ' WHEN  nvl(to_char(TIC.FECHA_SOLICITUD_TRANSPORTE, 'MM/DD/YYYY'), ' ') =  '12/30/1999' THEN ' '  ELSE NVL(TO_CHAR(TO_DATE(TIC.FECHA_SOLICITUD_TRANSPORTE, 'MM/DD/YYYY'), 'Mon/DD/YY'),' ')  END,"  
        /*66*/ + " CASE WHEN nvl(to_char(TIC.FECHA_MODULACION, 'MM/DD/YYYY'), ' ') =  '12/30/1899' THEN ' ' WHEN  nvl(to_char(TIC.FECHA_MODULACION, 'MM/DD/YYYY'), ' ') =  '12/30/1999' THEN ' ' ELSE NVL(TO_CHAR(TO_DATE(TIC.FECHA_MODULACION, 'MM/DD/YYYY'), 'Mon/DD/YY'),' ')  END,"  
        /*67*/ + " NVL(TIC.MODALIDAD_CAMION_TREN,' '), "
        /*68*/ + " NVL(TIC.RESULT_MODULACION_VERDE_ROJO,' '), "
        /*69*/ + " CASE WHEN nvl(to_char(TIC.FECHA_RECONOCIMIENTO, 'MM/DD/YYYY'), ' ') =  '12/30/1899' THEN ' ' WHEN  nvl(to_char(TIC.FECHA_RECONOCIMIENTO, 'MM/DD/YYYY'), ' ') =  '12/30/1999' THEN ' '   ELSE NVL(TO_CHAR(TO_DATE(TIC.FECHA_RECONOCIMIENTO, 'MM/DD/YYYY'), 'Mon/DD/YY'),' ')  END, "  
        /*70*/ + " CASE WHEN nvl(to_char(TIC.FECHA_LIBERACION, 'MM/DD/YYYY'), ' ') =  '12/30/1899' THEN ' ' WHEN  nvl(to_char(TIC.FECHA_LIBERACION, 'MM/DD/YYYY'), ' ') =  '12/30/1999' THEN ' '  ELSE NVL(TO_CHAR(TO_DATE(TIC.FECHA_LIBERACION, 'MM/DD/YYYY'), 'Mon/DD/YY'),' ')  END, "  
        /*71*/ + " NVL(TIC.SELLO_ORIGEN,' '), "
        /*72*/ + " NVL(TIC.SELLO_FINAL,' '), "
        /*73*/ + " CASE WHEN nvl(to_char(TIC.FECHA_RETENCION_AUTORIDAD, 'MM/DD/YYYY'), ' ') =  '12/30/1899' THEN ' ' WHEN  nvl(to_char(TIC.FECHA_RETENCION_AUTORIDAD, 'MM/DD/YYYY'), ' ') =  '12/30/1999' THEN ' '  ELSE NVL(TO_CHAR(TO_DATE(TIC.FECHA_RETENCION_AUTORIDAD, 'MM/DD/YYYY'), 'Mon/DD/YY'),' ')  END, "  
        /*74*/ + " CASE WHEN nvl(to_char(TIC.FECHA_LIB_POR_RET_AUT, 'MM/DD/YYYY'), ' ') =  '12/30/1899' THEN ' ' WHEN  nvl(to_char(TIC.FECHA_LIB_POR_RET_AUT, 'MM/DD/YYYY'), ' ') =  '12/30/1999' THEN ' '  ELSE NVL(TO_CHAR(TO_DATE(TIC.FECHA_LIB_POR_RET_AUT, 'MM/DD/YYYY'), 'Mon/DD/YY'),' ')  END, "      
        /*75*/ + " NVL(TEC.DESCRIPCION_ESTADO,' '), "
        /*76*/ + " NVL(TIC.MOTIVO_ATRASO,' '), "
        /*77*/ + " NVL(TIC.OBSERVACIONES,' '), "
        /*78*/ + " CASE WHEN nvl(to_char(TIC.LLEGADA_A_NOVA, 'MM/DD/YYYY'), ' ') =  '12/30/1899' THEN ' '  WHEN  nvl(to_char(TIC.LLEGADA_A_NOVA, 'MM/DD/YYYY'), ' ') =  '12/30/1999' THEN ' '  ELSE NVL(TO_CHAR(TO_DATE(TIC.LLEGADA_A_NOVA, 'MM/DD/YYYY'), 'Mon/DD/YY'),' ')  END, "  
        /*79*/ + " CASE WHEN nvl(to_char(TIC.LLEGADA_A_GLOBE_TRADE_SD, 'MM/DD/YYYY'), ' ') =  '12/30/1899' THEN ' '  WHEN  nvl(to_char(TIC.LLEGADA_A_GLOBE_TRADE_SD, 'MM/DD/YYYY'), ' ') =  '12/30/1999' THEN ' ' ELSE NVL(TO_CHAR(TO_DATE(TIC.LLEGADA_A_GLOBE_TRADE_SD, 'MM/DD/YYYY'), 'Mon/DD/YY'),' ')  END, "  
        /*80*/ + " NVL(TIC.ARCHIVO_M,' '), "
        /*81*/ + " CASE WHEN nvl(to_char(TIC.FECHA_ARCHIVO_M, 'MM/DD/YYYY'), ' ') =  '12/30/1899' THEN ' ' WHEN  nvl(to_char(TIC.FECHA_ARCHIVO_M, 'MM/DD/YYYY'), ' ') =  '12/30/1999' THEN ' ' ELSE NVL(TO_CHAR(TO_DATE(TIC.FECHA_ARCHIVO_M, 'MM/DD/YYYY'), 'Mon/DD/YY'),' ')  END, "  
        /*82*/ + " CASE WHEN nvl(to_char(TIC.FECHA_SOLICIT_MANIP, 'MM/DD/YYYY'), ' ') =  '12/30/1899' THEN ' ' WHEN  nvl(to_char(TIC.FECHA_SOLICIT_MANIP, 'MM/DD/YYYY'), ' ') =  '12/30/1999' THEN ' '  ELSE NVL(TO_CHAR(TO_DATE(TIC.FECHA_SOLICIT_MANIP, 'MM/DD/YYYY'), 'Mon/DD/YY'),' ')  END, "  
        /*83*/ + " CASE WHEN nvl(to_char(TIC.FECHA_VENCIM_MANIP, 'MM/DD/YYYY'), ' ') =  '12/30/1899' THEN ' '  WHEN  nvl(to_char(TIC.FECHA_VENCIM_MANIP, 'MM/DD/YYYY'), ' ') =  '12/30/1999' THEN ' '   ELSE NVL(TO_CHAR(TO_DATE(TIC.FECHA_VENCIM_MANIP, 'MM/DD/YYYY'), 'Mon/DD/YY'),' ')  END, "  
        /*84*/ + " CASE WHEN nvl(to_char(TIC.FECHA_CONFIRM_CLAVE_PEDIM, 'MM/DD/YYYY'), ' ') =  '12/30/1899' THEN ' '  WHEN  nvl(to_char(TIC.FECHA_CONFIRM_CLAVE_PEDIM, 'MM/DD/YYYY'), ' ') =  '12/30/1999' THEN ' ' ELSE NVL(TO_CHAR(TO_DATE(TIC.FECHA_CONFIRM_CLAVE_PEDIM, 'MM/DD/YYYY'), 'Mon/DD/YY'),' ')  END, "  
        /*85*/ + " CASE WHEN nvl(to_char(TIC.FECHA_RECEP_INCREMENT, 'MM/DD/YYYY'), ' ') =  '12/30/1899' THEN ' ' WHEN  nvl(to_char(TIC.FECHA_RECEP_INCREMENT, 'MM/DD/YYYY'), ' ') =  '12/30/1999' THEN ' '   ELSE NVL(TO_CHAR(TO_DATE(TIC.FECHA_RECEP_INCREMENT, 'MM/DD/YYYY'), 'Mon/DD/YY'),' ')  END, "  
        /*86*/ + " NVL(TIC.T_E,' '), "
        /*87*/ + " CASE WHEN nvl(to_char(TIC.FECHA_VENCIM_INBOUND, 'MM/DD/YYYY'), ' ') =  '12/30/1899' THEN ' ' WHEN  nvl(to_char(TIC.FECHA_VENCIM_INBOUND, 'MM/DD/YYYY'), ' ') =  '12/30/1999' THEN ' '  ELSE NVL(TO_CHAR(TO_DATE(TIC.FECHA_VENCIM_INBOUND, 'MM/DD/YYYY'), 'Mon/DD/YY'),' ')  END, "  
       /*88*/ + " NVL(TIC.NO_BULTOS,' '), "
        /*89*/ + " NVL(TIC.PESO_KG,' '), "
        /*90*/ + " NVL(TIC.TRANSFERENCIA,' '), "
        /*91*/ + " CASE WHEN nvl(to_char(TIC.FECHA_INICIO_ETIQUETADO, 'MM/DD/YYYY'), ' ') =  '12/30/1899' THEN ' ' WHEN  nvl(to_char(TIC.FECHA_INICIO_ETIQUETADO, 'MM/DD/YYYY'), ' ') =  '12/30/1999' THEN ' '  ELSE NVL(TO_CHAR(TO_DATE(TIC.FECHA_INICIO_ETIQUETADO, 'MM/DD/YYYY'), 'Mon/DD/YY'),' ')  END, "  
        /*92*/ + " CASE WHEN nvl(to_char(TIC.FECHA_TERMINO_ETIQUETADO, 'MM/DD/YYYY'), ' ') =  '12/30/1899' THEN ' ' WHEN  nvl(to_char(TIC.FECHA_TERMINO_ETIQUETADO, 'MM/DD/YYYY'), ' ') =  '12/30/1999' THEN ' '  ELSE NVL(TO_CHAR(TO_DATE(TIC.FECHA_TERMINO_ETIQUETADO, 'MM/DD/YYYY'), 'Mon/DD/YY'),' ')  END, "  
