...
public class ConsultarCustomsBacheo extends HttpServlet {
    ...
    /*  ----------------------------- FILTROS MULTISELECT ENCABEZADOS  -----------------------------  */  
        ...
        /*10*/ + " SQ.SUMA, "
        /*11*/ + " TIP1.NOMBRE_POD, "
        /*12*/ + " CASE WHEN NVL(TO_CHAR(GTN.EST_DEPARTURE_POL, 'DD/MM/YYYY'), ' ') =  '30/12/1899' THEN ' ' WHEN NVL(TO_CHAR(GTN.EST_DEPARTURE_POL, 'DD/MM/YYYY'), ' ') =  '30/12/1999' THEN ' ' ELSE TO_CHAR(NVL(TO_DATE(GTN.EST_DEPARTURE_POL, 'DD/MM/YYYY'), NULL), 'Mon/DD/YY') END, "
        /*13*/ + " CASE WHEN NVL(TO_CHAR(GTN.ETA_PORT_DISCHARGE, 'DD/MM/YYYY'), ' ') =  '30/12/1899' THEN ' ' WHEN NVL(TO_CHAR(GTN.ETA_PORT_DISCHARGE, 'DD/MM/YYYY'), ' ') =  '30/12/1999' THEN ' ' ELSE TO_CHAR(NVL(TO_DATE(GTN.ETA_PORT_DISCHARGE, 'DD/MM/YYYY'), NULL), 'Mon/DD/YY') END, "
        /*14*/ + " NVL(GTN.MAX_FLETE, 0), "
        /*15*/ + " CASE WHEN NVL(TO_CHAR(GTN.FECHA_CAPTURA, 'DD/MM/YYYY'), ' ') =  '30/12/1899' THEN ' ' WHEN NVL(TO_CHAR(GTN.FECHA_CAPTURA, 'DD/MM/YYYY'), ' ') =  '30/12/1999' THEN ' ' ELSE TO_CHAR(NVL(TO_DATE(GTN.FECHA_CAPTURA, 'DD/MM/YYYY'), NULL), 'Mon/DD/YY') END, "
        /*16*/ + " TIP2.NOMBRE_POL, "
        /*17*/ + " NVL(TAA.AGENTE_ADUANAL_NOMBRE, ' '), "
        /*18*/ + " GTN.PLANTILLA_ID, "
        /*19*/ + " SYSDATE, "
        /*20*/ + " TIP1.NOMBRE_POD, "
        /*21*/ + " TIP2.NOMBRE_POL, "
        /*22*/ + " TIBD.NOMBRE_BD, "
        /*23*/ + " CASE WHEN NVL(TO_CHAR(GTN.ETA_PLUS2, 'DD/MM/YYYY'), ' ') =  '30/12/1899' THEN ' ' WHEN NVL(TO_CHAR(GTN.ETA_PLUS2, 'DD/MM/YYYY'), ' ') =  '30/12/1999' THEN ' ' ELSE TO_CHAR(NVL(TO_DATE(tic.eta_port_of_discharge, 'DD/MM/YYYY'), NULL), 'Mon/DD/YY') END, "
        /*24*/ + " CASE WHEN NVL(TO_CHAR(TIE.EST_ETA_DC, 'DD/MM/YYYY'), ' ') =  '30/12/1899' THEN ' ' WHEN NVL(TO_CHAR(TIE.EST_ETA_DC, 'DD/MM/YYYY'), ' ') =  '30/12/1999' THEN ' ' ELSE TO_CHAR(NVL(TO_DATE(tic.eta_port_of_discharge, 'DD/MM/YYYY'), NULL), 'Mon/DD/YY') END, "
        /*25*/ + " CASE WHEN NVL(TO_CHAR(GTN.ETA_PLUS, 'DD/MM/YYYY'), ' ') =  '30/12/1899' THEN ' ' WHEN NVL(TO_CHAR(GTN.ETA_PLUS, 'DD/MM/YYYY'), ' ') =  '30/12/1999' THEN ' ' ELSE TO_CHAR(NVL(TO_DATE(tic.eta_port_of_discharge, 'DD/MM/YYYY'), NULL), 'Mon/DD/YY') END, "
        /*26*/ + " NVL(TIE.OBSERVACIONES, ' '), "
        /*27*/ + " TIE.ESTATUS_EVENTO, "
        /*28*/ + " NVL(TIE.REFERENCIA_AA,' '), "
        /*29*/ + " CASE WHEN NVL(TO_CHAR(TIE.FECHA_CAPTURA, 'DD/MM/YYYY'), ' ') =  '30/12/1899' THEN ' ' WHEN NVL(TO_CHAR(TIE.FECHA_CAPTURA, 'DD/MM/YYYY'), ' ') =  '30/12/1999' THEN ' ' ELSE TO_CHAR(NVL(TO_DATE(TIE.FECHA_CAPTURA, 'DD/MM/YYYY'), NULL), 'Mon/DD/YY') END, "
        /*30*/ + " NVL(TIE.PRIORIDAD,' '), "
        /*31*/ + " NVL(TIC.REFERENCIA_AA,' '), "
        /*32*/ + " NVL(TIC.PAIS_ORIGEN,' '), "
        /*33*/ + " NVL(TIC.SIZE_CONTAINER,' '), "
        /*34*/ + " NVL(TIC.VALOR_USD,' '), "
        /*35*/ + " CASE WHEN NVL(TO_CHAR(TIC.ETA_PORT_OF_DISCHARGE, 'DD/MM/YYYY'), ' ') =  '30/12/1899' THEN ' ' WHEN NVL(TO_CHAR(TIC.ETA_PORT_OF_DISCHARGE, 'DD/MM/YYYY'), ' ') =  '30/12/1999' THEN ' ' ELSE TO_CHAR(NVL(TO_DATE(TIC.ETA_PORT_OF_DISCHARGE, 'DD/MM/YYYY'), NULL), 'Mon/DD/YY') END, "
        ...
        /*42*/ + " CASE WHEN NVL(TO_CHAR(TIC.FECHA_RECEPCION_DOCUMENTOS, 'DD/MM/YYYY'), ' ') =  '30/12/1899'  THEN ' ' WHEN NVL(TO_CHAR(TIC.FECHA_RECEPCION_DOCUMENTOS, 'DD/MM/YYYY'), ' ') =  '30/12/1999' THEN ' ' ELSE TO_CHAR(NVL(TO_DATE(TIC.FECHA_RECEPCION_DOCUMENTOS, 'DD/MM/YYYY'), NULL), 'Mon/DD/YY') END, "
        /*43*/ + " NVL(TIC.RECINTO,' '), "
        /*44*/ + " NVL(TIC.NAVIERA_FORWARDER,' '), "
        /*45*/ + " NVL(TIC.BUQUE,' '), "
        /*46*/ + " CASE WHEN NVL(TO_CHAR(TIC.FECHA_REVALID_LIBE_BL, 'DD/MM/YYYY'), ' ') =  '30/12/1899' THEN ' ' WHEN NVL(TO_CHAR(TIC.FECHA_REVALID_LIBE_BL, 'DD/MM/YYYY'), ' ') =  '30/12/1999' THEN ' ' ELSE TO_CHAR(NVL(TO_DATE(TIC.FECHA_REVALID_LIBE_BL, 'DD/MM/YYYY'), NULL), 'Mon/DD/YY') END, "
        /*47*/ + " CASE WHEN NVL(TO_CHAR(TIC.FECHA_PREVIO_ORIGEN, 'DD/MM/YYYY'), ' ') =  '30/12/1899' THEN ' ' WHEN NVL(TO_CHAR(TIC.FECHA_PREVIO_ORIGEN, 'DD/MM/YYYY'), ' ') =  '30/12/1999' THEN ' ' ELSE TO_CHAR(NVL(TO_DATE(TIC.FECHA_PREVIO_ORIGEN, 'DD/MM/YYYY'), NULL), 'Mon/DD/YY') END, "
        /*48*/ + " CASE WHEN NVL(TO_CHAR(TIC.FECHA_PREVIO_DESTINO, 'DD/MM/YYYY'), ' ') =  '30/12/1899' THEN ' ' WHEN NVL(TO_CHAR(TIC.FECHA_PREVIO_DESTINO, 'DD/MM/YYYY'), ' ') =  '30/12/1999' THEN ' ' ELSE TO_CHAR(NVL(TO_DATE(TIC.FECHA_PREVIO_DESTINO, 'DD/MM/YYYY'), NULL), 'Mon/DD/YY') END, "
        /*49*/ + " CASE WHEN NVL(TO_CHAR(TIC.FECHA_RESULTADO_PREVIO, 'DD/MM/YYYY'), ' ') =  '30/12/1899' THEN ' ' WHEN NVL(TO_CHAR(TIC.FECHA_RESULTADO_PREVIO, 'DD/MM/YYYY'), ' ') =  '30/12/1999' THEN ' ' ELSE TO_CHAR(NVL(TO_DATE(TIC.FECHA_RESULTADO_PREVIO, 'DD/MM/YYYY'), NULL), 'Mon/DD/YY') END, "
        /*50*/ + " CASE WHEN NVL(TO_CHAR(TIC.PROFORMA_FINAL, 'DD/MM/YYYY'), ' ') =  '30/12/1899' THEN ' ' WHEN NVL(TO_CHAR(TIC.PROFORMA_FINAL, 'DD/MM/YYYY'), ' ') =  '30/12/1999' THEN ' ' ELSE TO_CHAR(NVL(TO_DATE(TIC.PROFORMA_FINAL, 'DD/MM/YYYY'), NULL), 'Mon/DD/YY') END, "
        /*51*/ + " NVL(TIC.REQUIERE_PERMISO,' '), "
        /*52*/ + " CASE WHEN NVL(TO_CHAR(TIC.FECHA_ENVIO_FICHAS_NOTAS, 'DD/MM/YYYY'), ' ') =  '30/12/1899' THEN ' ' WHEN NVL(TO_CHAR(TIC.FECHA_ENVIO_FICHAS_NOTAS, 'DD/MM/YYYY'), ' ') =  '30/12/1999' THEN ' ' ELSE TO_CHAR(NVL(TO_DATE(TIC.FECHA_ENVIO_FICHAS_NOTAS, 'DD/MM/YYYY'), NULL), 'Mon/DD/YY') END, "
        /*53*/ + " CASE WHEN NVL(TO_CHAR(TIC.FEC_RECEPCION_PERMISOS_TRAMIT, 'DD/MM/YYYY'), ' ') =  '30/12/1899' THEN ' ' WHEN NVL(TO_CHAR(TIC.FEC_RECEPCION_PERMISOS_TRAMIT, 'DD/MM/YYYY'), ' ') =  '30/12/1999'  THEN ' ' ELSE TO_CHAR(NVL(TO_DATE(TIC.FEC_RECEPCION_PERMISOS_TRAMIT, 'DD/MM/YYYY'), NULL), 'Mon/DD/YY') END, "
        /*54*/ + " CASE WHEN NVL(TO_CHAR(TIC.FEC_ACT_PERMISOS, 'DD/MM/YYYY'), ' ') =  '30/12/1899' THEN ' ' WHEN NVL(TO_CHAR(TIC.FEC_ACT_PERMISOS, 'DD/MM/YYYY'), ' ') =  '30/12/1999' THEN ' ' ELSE TO_CHAR(NVL(TO_DATE(TIC.FEC_ACT_PERMISOS, 'DD/MM/YYYY'), NULL), 'Mon/DD/YY') END, "
        /*55*/ + " CASE WHEN NVL(TO_CHAR(TIC.FEC_PERM_AUT, 'DD/MM/YYYY'), ' ') =  '30/12/1899' THEN ' ' WHEN NVL(TO_CHAR(TIC.FEC_PERM_AUT, 'DD/MM/YYYY'), ' ') =  '30/12/1999' THEN ' ' ELSE TO_CHAR(NVL(TO_DATE(TIC.FEC_PERM_AUT, 'DD/MM/YYYY'), NULL), 'Mon/DD/YY') END, "
        /*56*/ + " NVL(TIC.CO_APLIC_PREF_ARANCELARIA,' '), "
        /*57*/ + " NVL(TIC.APLIC_PREF_ARANCELARIA_CO,' '), "
        /*58*/ + " NVL(TIC.REQUIERE_UVA,' '), "
        /*59*/ + " NVL(TIC.REQUIERE_CA,' '), "
        /*60*/ + " CASE WHEN NVL(TO_CHAR(TIC.FECHA_RECEPCION_CA, 'DD/MM/YYYY'), ' ') =  '30/12/1899' THEN ' ' WHEN NVL(TO_CHAR(TIC.FECHA_RECEPCION_CA, 'DD/MM/YYYY'), ' ') =  '30/12/1999' THEN ' ' ELSE TO_CHAR(NVL(TO_DATE(TIC.FECHA_RECEPCION_CA, 'DD/MM/YYYY'), NULL), 'Mon/DD/YY') END, "
        /*61*/ + " NVL(TIC.NUMERO_CONSTANCIA_CA,' '), "
        /*62*/ + " NVL(TIC.MONTO_CA,' '), "
        /*63*/ + " CASE WHEN NVL(TO_CHAR(TIC.FECHA_DOCUMENTOS_COMPLETOS, 'DD/MM/YYYY'), ' ') =  '30/12/1899' THEN ' ' WHEN NVL(TO_CHAR(TIC.FECHA_DOCUMENTOS_COMPLETOS, 'DD/MM/YYYY'), ' ') =  '30/12/1999' THEN ' ' ELSE TO_CHAR(NVL(TO_DATE(TIC.FECHA_DOCUMENTOS_COMPLETOS, 'DD/MM/YYYY'), NULL), 'Mon/DD/YY') END, "
        /*64*/ + " CASE WHEN NVL(TO_CHAR(TIC.FECHA_PAGO_PEDIMENTO, 'DD/MM/YYYY'), ' ') =  '30/12/1899' THEN ' ' WHEN NVL(TO_CHAR(TIC.FECHA_PAGO_PEDIMENTO, 'DD/MM/YYYY'), ' ') =  '30/12/1999' THEN ' ' ELSE TO_CHAR(NVL(TO_DATE(TIC.FECHA_PAGO_PEDIMENTO, 'DD/MM/YYYY'), NULL), 'Mon/DD/YY') END, "
        /*65*/ + " CASE WHEN NVL(TO_CHAR(TIC.FECHA_SOLICITUD_TRANSPORTE, 'DD/MM/YYYY'), ' ') =  '30/12/1899' THEN ' ' WHEN NVL(TO_CHAR(TIC.FECHA_SOLICITUD_TRANSPORTE, 'DD/MM/YYYY'), ' ') =  '30/12/1999' THEN ' ' ELSE TO_CHAR(NVL(TO_DATE(TIC.FECHA_SOLICITUD_TRANSPORTE, 'DD/MM/YYYY'), NULL), 'Mon/DD/YY') END, "
        /*66*/ + " CASE WHEN NVL(TO_CHAR(TIC.FECHA_MODULACION, 'DD/MM/YYYY'), ' ') =  '30/12/1899' THEN ' ' WHEN NVL(TO_CHAR(TIC.FECHA_MODULACION, 'DD/MM/YYYY'), ' ') =  '30/12/1999' THEN ' ' ELSE TO_CHAR(NVL(TO_DATE(TIC.FECHA_MODULACION, 'DD/MM/YYYY'), NULL), 'Mon/DD/YY') END, "
        /*67*/ + " NVL(TIC.MODALIDAD_CAMION_TREN,' '), "
        /*68*/ + " NVL(TIC.RESULT_MODULACION_VERDE_ROJO,' '), "
        /*69*/ + " CASE WHEN NVL(TO_CHAR(TIC.FECHA_RECONOCIMIENTO, 'DD/MM/YYYY'), ' ') =  '30/12/1899' THEN ' ' WHEN NVL(TO_CHAR(TIC.FECHA_RECONOCIMIENTO, 'DD/MM/YYYY'), ' ') =  '30/12/1999' THEN ' ' ELSE TO_CHAR(NVL(TO_DATE(TIC.FECHA_RECONOCIMIENTO, 'DD/MM/YYYY'), NULL), 'Mon/DD/YY') END, "
        /*70*/ + " CASE WHEN NVL(TO_CHAR(TIC.FECHA_LIBERACION, 'DD/MM/YYYY'), ' ') =  '30/12/1899' THEN ' ' WHEN NVL(TO_CHAR(TIC.FECHA_LIBERACION, 'DD/MM/YYYY'), ' ') =  '30/12/1999' THEN ' ' ELSE TO_CHAR(NVL(TO_DATE(TIC.FECHA_LIBERACION, 'DD/MM/YYYY'), NULL), 'Mon/DD/YY') END, "
        /*71*/ + " NVL(TIC.SELLO_ORIGEN,' '), "
        /*72*/ + " NVL(TIC.SELLO_FINAL,' '), "
        /*73*/ + " CASE WHEN NVL(TO_CHAR(TIC.FECHA_RETENCION_AUTORIDAD, 'DD/MM/YYYY'), ' ') =  '30/12/1899' THEN ' ' WHEN NVL(TO_CHAR(TIC.FECHA_RETENCION_AUTORIDAD, 'DD/MM/YYYY'), ' ') =  '30/12/1999' THEN ' ' ELSE TO_CHAR(NVL(TO_DATE(TIC.FECHA_RETENCION_AUTORIDAD, 'DD/MM/YYYY'), NULL), 'Mon/DD/YY') END, "
        /*74*/ + " CASE WHEN NVL(TO_CHAR(TIC.FECHA_LIB_POR_RET_AUT, 'DD/MM/YYYY'), ' ') =  '30/12/1899' THEN ' ' WHEN NVL(TO_CHAR(TIC.FECHA_LIB_POR_RET_AUT, 'DD/MM/YYYY'), ' ') =  '30/12/1999' THEN ' ' ELSE TO_CHAR(NVL(TO_DATE(TIC.FECHA_LIB_POR_RET_AUT, 'DD/MM/YYYY'), NULL), 'Mon/DD/YY') END, "
        /*75*/ + " NVL(TEC.DESCRIPCION_ESTADO,' '), "
        /*76*/ + " NVL(TIC.MOTIVO_ATRASO,' '), "
        /*77*/ + " NVL(TIC.OBSERVACIONES,' '), "
        /*78*/ + " CASE WHEN NVL(TO_CHAR(TIC.LLEGADA_A_NOVA, 'DD/MM/YYYY'), ' ') =  '30/12/1899' THEN ' ' WHEN NVL(TO_CHAR(TIC.LLEGADA_A_NOVA, 'DD/MM/YYYY'), ' ') =  '30/12/1999' THEN ' ' ELSE TO_CHAR(NVL(TO_DATE(TIC.LLEGADA_A_NOVA, 'DD/MM/YYYY'), NULL), 'Mon/DD/YY') END, "
        /*79*/ + " CASE WHEN NVL(TO_CHAR(TIC.LLEGADA_A_GLOBE_TRADE_SD, 'DD/MM/YYYY'), ' ') =  '30/12/1899' THEN ' ' WHEN NVL(TO_CHAR(TIC.LLEGADA_A_GLOBE_TRADE_SD, 'DD/MM/YYYY'), ' ') =  '30/12/1999' THEN ' ' ELSE TO_CHAR(NVL(TO_DATE(TIC.LLEGADA_A_GLOBE_TRADE_SD, 'DD/MM/YYYY'), NULL), 'Mon/DD/YY') END, "
        /*80*/ + " NVL(TIC.ARCHIVO_M,' '), "
        /*81*/ + " CASE WHEN NVL(TO_CHAR(TIC.FECHA_ARCHIVO_M, 'DD/MM/YYYY'), ' ') =  '30/12/1899' THEN ' ' WHEN NVL(TO_CHAR(TIC.FECHA_ARCHIVO_M, 'DD/MM/YYYY'), ' ') =  '30/12/1999' THEN ' ' ELSE TO_CHAR(NVL(TO_DATE(TIC.FECHA_ARCHIVO_M, 'DD/MM/YYYY'), NULL), 'Mon/DD/YY') END, "
        /*82*/ + " CASE WHEN NVL(TO_CHAR(TIC.FECHA_SOLICIT_MANIP, 'DD/MM/YYYY'), ' ') =  '30/12/1899' THEN ' ' WHEN NVL(TO_CHAR(TIC.FECHA_SOLICIT_MANIP, 'DD/MM/YYYY'), ' ') =  '30/12/1999' THEN ' ' ELSE TO_CHAR(NVL(TO_DATE(TIC.FECHA_SOLICIT_MANIP, 'DD/MM/YYYY'), NULL), 'Mon/DD/YY') END, "
        /*83*/ + " CASE WHEN NVL(TO_CHAR(TIC.FECHA_VENCIM_MANIP, 'DD/MM/YYYY'), ' ') =  '30/12/1899' THEN ' ' WHEN NVL(TO_CHAR(TIC.FECHA_VENCIM_MANIP, 'DD/MM/YYYY'), ' ') =  '30/12/1999' THEN ' ' ELSE TO_CHAR(NVL(TO_DATE(TIC.FECHA_VENCIM_MANIP, 'DD/MM/YYYY'), NULL), 'Mon/DD/YY') END, "
        /*84*/ + " CASE WHEN NVL(TO_CHAR(TIC.FECHA_CONFIRM_CLAVE_PEDIM, 'DD/MM/YYYY'), ' ') =  '30/12/1899' THEN ' ' WHEN NVL(TO_CHAR(TIC.FECHA_CONFIRM_CLAVE_PEDIM, 'DD/MM/YYYY'), ' ') =  '30/12/1999' THEN ' ' ELSE TO_CHAR(NVL(TO_DATE(TIC.FECHA_CONFIRM_CLAVE_PEDIM, 'DD/MM/YYYY'), NULL), 'Mon/DD/YY') END, "
        /*85*/ + " CASE WHEN NVL(TO_CHAR(TIC.FECHA_RECEP_INCREMENT, 'DD/MM/YYYY'), ' ') =  '30/12/1899' THEN ' ' WHEN NVL(TO_CHAR(TIC.FECHA_RECEP_INCREMENT, 'DD/MM/YYYY'), ' ') =  '30/12/1999' THEN ' ' ELSE TO_CHAR(NVL(TO_DATE(TIC.FECHA_RECEP_INCREMENT, 'DD/MM/YYYY'), NULL), 'Mon/DD/YY') END, "
        /*86*/ + " NVL(TIC.T_E,' '), "
        /*87*/ + " CASE WHEN NVL(TO_CHAR(TIC.FECHA_VENCIM_INBOUND, 'DD/MM/YYYY'), ' ') =  '30/12/1899' THEN ' ' WHEN NVL(TO_CHAR(TIC.FECHA_VENCIM_INBOUND, 'DD/MM/YYYY'), ' ') =  '30/12/1999' THEN ' ' ELSE TO_CHAR(NVL(TO_DATE(TIC.FECHA_VENCIM_INBOUND, 'DD/MM/YYYY'), NULL), 'Mon/DD/YY') END, "
        /*88*/ + " NVL(TIC.NO_BULTOS,' '), "
        /*89*/ + " NVL(TIC.PESO_KG,' '), "
        /*90*/ + " NVL(TIC.TRANSFERENCIA,' '), "
        /*91*/ + " CASE WHEN NVL(TO_CHAR(TIC.FECHA_INICIO_ETIQUETADO, 'DD/MM/YYYY'), ' ') =  '30/12/1899' THEN ' ' WHEN NVL(TO_CHAR(TIC.FECHA_INICIO_ETIQUETADO, 'DD/MM/YYYY'), ' ') =  '30/12/1999' THEN ' ' ELSE TO_CHAR(NVL(TO_DATE(TIC.FECHA_INICIO_ETIQUETADO, 'DD/MM/YYYY'), NULL), 'Mon/DD/YY') END, "
        /*92*/ + " CASE WHEN NVL(TO_CHAR(TIC.FECHA_TERMINO_ETIQUETADO, 'DD/MM/YYYY'), ' ') =  '30/12/1899' THEN ' ' WHEN NVL(TO_CHAR(TIC.FECHA_TERMINO_ETIQUETADO, 'DD/MM/YYYY'), ' ') =  '30/12/1999' THEN ' ' ELSE TO_CHAR(NVL(TO_DATE(TIC.FECHA_TERMINO_ETIQUETADO, 'DD/MM/YYYY'), NULL), 'Mon/DD/YY') END, "
        ...
        + " AND tie.id_evento >= 240000 ";
            ...
            if (!caramelo_inboundNotification.equals("")) { //Inbound notification
                sql += " AND TO_DATE(trunc(GTN.FECHA_CAPTURA),'DD/MM/YYYY') = TO_DATE(" + caramelo_inboundNotification + ",'DD/MM/YYYY') ";
            }
