...
public class ConsultarCustomsBacheo extends HttpServlet {
    ...
    /*  ----------------------------- FILTROS MULTISELECT ENCABEZADOS  -----------------------------  */  
        ...
        /*10*/ + " SQ.SUMA, "
        /*11*/ + " TIP1.NOMBRE_POD, "
        /*12*/ + " CASE WHEN nvl(to_char(GTN.EST_DEPARTURE_POL, 'MM/DD/YYYY'), ' ') =  '12/30/1899' THEN ' ' WHEN  nvl(to_char(GTN.EST_DEPARTURE_POL, 'MM/DD/YYYY'), ' ') =  '12/30/1999' THEN ' ' ELSE nvl(to_char(GTN.EST_DEPARTURE_POL, 'Mon/DD/YYYY'),  ' ') END, "  
        /*13*/ + " CASE WHEN nvl(to_char(GTN.ETA_PORT_DISCHARGE, 'MM/DD/YYYY'), ' ') =  '12/30/1899' THEN ' ' WHEN  nvl(to_char(GTN.ETA_PORT_DISCHARGE, 'MM/DD/YYYY'), ' ') =  '12/30/1999' THEN ' ' ELSE nvl(to_char(GTN.ETA_PORT_DISCHARGE, 'Mon/DD/YYYY'),  ' ') END, "  
        /*14*/ + " NVL(GTN.MAX_FLETE, 0) AS EST_ETA_DC, "
        /*15*/ + " CASE WHEN nvl(to_char(GTN.FECHA_CAPTURA, 'MM/DD/YYYY'), ' ') =  '12/30/1899' THEN ' ' WHEN  nvl(to_char(GTN.FECHA_CAPTURA, 'MM/DD/YYYY'), ' ') =  '12/30/1999' THEN ' '  ELSE nvl(to_char(GTN.FECHA_CAPTURA, 'Mon/DD/YYYY'),  ' ') END, "  
        /*16*/ + " TIP2.NOMBRE_POL, "
        ...
        /*21*/ + " TIP2.NOMBRE_POL, "
        /*22*/ + " TIBD.NOMBRE_BD, "
        /*23*/ + " CASE WHEN nvl(to_char(GTN.ETA_PLUS2, 'MM/DD/YYYY'), ' ') =  '12/30/1899' THEN ' ' WHEN  nvl(to_char(GTN.ETA_PLUS2, 'MM/DD/YYYY'), ' ') =  '12/30/1999' THEN ' ' ELSE nvl(to_char(tic.eta_port_of_discharge, 'Mon/DD/YYYY'),  ' ') END, "  
        /*24*/ + " CASE WHEN nvl(to_char(TIE.EST_ETA_DC, 'MM/DD/YYYY'), ' ') =  '12/30/1899' THEN ' ' WHEN  nvl(to_char(TIE.EST_ETA_DC, 'MM/DD/YYYY'), ' ') =  '12/30/1999' THEN ' '  ELSE nvl(to_char(tic.eta_port_of_discharge, 'Mon/DD/YYYY'),  ' ') END , "  
        /*25*/ + " CASE WHEN nvl(to_char(GTN.ETA_PLUS, 'MM/DD/YYYY'), ' ') =  '12/30/1899' THEN ' ' WHEN  nvl(to_char(GTN.ETA_PLUS, 'MM/DD/YYYY'), ' ') =  '12/30/1999' THEN ' ' ELSE nvl(to_char(tic.eta_port_of_discharge, 'Mon/DD/YYYY'),  ' ') END, "  
        /*26*/ + " NVL(TIE.OBSERVACIONES, ' ') AS OBSERVACIONES, "
        /*27*/ + " TIE.ESTATUS_EVENTO, "
        /*28*/ + " NVL(TIE.REFERENCIA_AA,' '), "
        /*29*/ + " CASE WHEN nvl(to_char(TIE.FECHA_CAPTURA, 'MM/DD/YYYY'), ' ') =  '12/30/1899' THEN ' ' WHEN  nvl(to_char(TIE.FECHA_CAPTURA, 'MM/DD/YYYY'), ' ') =  '12/30/1999' THEN ' '  ELSE nvl(to_char(TIE.FECHA_CAPTURA, 'Mon/DD/YYYY'),  ' ') END, "  
        /*30*/ + " NVL(TIE.PRIORIDAD,' '), "
        /*31*/ + " NVL(TIC.REFERENCIA_AA,' '), "
        /*32*/ + " NVL(TIC.PAIS_ORIGEN,' '), "
        /*33*/ + " NVL(TIC.SIZE_CONTAINER,' '), "
        /*34*/ + " NVL(TIC.VALOR_USD,' '), "
        /*35*/ + " CASE WHEN nvl(to_char(TIC.ETA_PORT_OF_DISCHARGE, 'MM/DD/YYYY'), ' ') =  '12/30/1899' THEN ' ' WHEN  nvl(to_char(TIC.ETA_PORT_OF_DISCHARGE, 'MM/DD/YYYY'), ' ') =  '12/30/1999' THEN ' '  ELSE nvl(to_char(TIC.ETA_PORT_OF_DISCHARGE, 'Mon/DD/YYYY'),  ' ') END, "  
        ...
        /*42*/ + " CASE WHEN nvl(to_char(TIC.FECHA_RECEPCION_DOCUMENTOS, 'MM/DD/YYYY'), ' ') =  '12/30/1899' THEN ' ' WHEN  nvl(to_char(TIC.FECHA_RECEPCION_DOCUMENTOS, 'MM/DD/YYYY'), ' ') =  '12/30/1999' THEN ' '  ELSE nvl(to_char(TIC.FECHA_RECEPCION_DOCUMENTOS, 'Mon/DD/YYYY'),  ' ') END, "  
        /*43*/ + " NVL(TIC.RECINTO,' '), "
        /*44*/ + " NVL(TIC.NAVIERA_FORWARDER,' '), "
        /*45*/ + " NVL(TIC.BUQUE,' '), "
        /*46*/ + " CASE WHEN nvl(to_char(TIC.FECHA_REVALID_LIBE_BL, 'MM/DD/YYYY'), ' ') =  '12/30/1899' THEN ' ' WHEN  nvl(to_char(TIC.FECHA_REVALID_LIBE_BL, 'MM/DD/YYYY'), ' ') =  '12/30/1999' THEN ' ' ELSE nvl(to_char(TIC.FECHA_REVALID_LIBE_BL, 'Mon/DD/YYYY'),  ' ') END, "  
        /*47*/ + " CASE WHEN nvl(to_char(TIC.FECHA_PREVIO_ORIGEN, 'MM/DD/YYYY'), ' ') =  '12/30/1899' THEN ' ' WHEN  nvl(to_char(TIC.FECHA_PREVIO_ORIGEN, 'MM/DD/YYYY'), ' ') =  '12/30/1999' THEN ' ' ELSE nvl(to_char(TIC.FECHA_PREVIO_ORIGEN, 'Mon/DD/YYYY'),  ' ') END, "  
        /*48*/ + " CASE WHEN nvl(to_char(TIC.FECHA_PREVIO_DESTINO, 'MM/DD/YYYY'), ' ') =  '12/30/1899' THEN ' ' WHEN  nvl(to_char(TIC.FECHA_PREVIO_DESTINO, 'MM/DD/YYYY'), ' ') =  '12/30/1999' THEN ' '  ELSE nvl(to_char(TIC.FECHA_PREVIO_DESTINO, 'Mon/DD/YYYY'),  ' ') END, "  
        /*49*/ + " CASE WHEN nvl(to_char(TIC.FECHA_RESULTADO_PREVIO, 'MM/DD/YYYY'), ' ') =  '12/30/1899' THEN ' '  WHEN  nvl(to_char(TIC.FECHA_RESULTADO_PREVIO, 'MM/DD/YYYY'), ' ') =  '12/30/1999' THEN ' ' ELSE nvl(to_char(TIC.FECHA_RESULTADO_PREVIO, 'Mon/DD/YYYY'),  ' ') END, "  
        /*50*/ + " CASE WHEN nvl(to_char(TIC.PROFORMA_FINAL, 'MM/DD/YYYY'), ' ') =  '12/30/1899' THEN ' ' WHEN  nvl(to_char(TIC.PROFORMA_FINAL, 'MM/DD/YYYY'), ' ') =  '12/30/1999' THEN ' '  ELSE nvl(to_char(TIC.PROFORMA_FINAL, 'Mon/DD/YYYY'),  ' ') END, "  
        /*51*/ + " NVL(TIC.REQUIERE_PERMISO,' '), "
        /*52*/ + " CASE WHEN nvl(to_char(TIC.FECHA_ENVIO_FICHAS_NOTAS, 'MM/DD/YYYY'), ' ') =  '12/30/1899' THEN ' ' WHEN  nvl(to_char(TIC.FECHA_ENVIO_FICHAS_NOTAS, 'MM/DD/YYYY'), ' ') =  '12/30/1999' THEN ' '  ELSE nvl(to_char(TIC.FECHA_ENVIO_FICHAS_NOTAS, 'Mon/DD/YYYY'),  ' ') END, "  
        /*53*/ + " CASE WHEN nvl(to_char(TIC.FEC_RECEPCION_PERMISOS_TRAMIT, 'MM/DD/YYYY'), ' ') =  '12/30/1899' THEN ' ' WHEN  nvl(to_char(TIC.FEC_RECEPCION_PERMISOS_TRAMIT, 'MM/DD/YYYY'), ' ') =  '12/30/1999' THEN ' '  ELSE nvl(to_char(TIC.FEC_RECEPCION_PERMISOS_TRAMIT, 'Mon/DD/YYYY'),  ' ') END, "  
        /*54*/ + " CASE WHEN nvl(to_char(TIC.FEC_ACT_PERMISOS, 'MM/DD/YYYY'), ' ') =  '12/30/1899' THEN ' ' WHEN  nvl(to_char(TIC.FEC_ACT_PERMISOS, 'MM/DD/YYYY'), ' ') =  '12/30/1999' THEN ' '  ELSE nvl(to_char(TIC.FEC_ACT_PERMISOS, 'Mon/DD/YYYY'),  ' ') END, "  
        /*55*/ + " CASE WHEN nvl(to_char(TIC.FEC_PERM_AUT, 'MM/DD/YYYY'), ' ') =  '12/30/1899' THEN ' ' WHEN  nvl(to_char(TIC.FEC_PERM_AUT, 'MM/DD/YYYY'), ' ') =  '12/30/1999' THEN ' ' ELSE nvl(to_char(TIC.FEC_PERM_AUT, 'Mon/DD/YYYY'),  ' ') END, "  
        /*56*/ + " NVL(TIC.CO_APLIC_PREF_ARANCELARIA,' '), "
        /*57*/ + " NVL(TIC.APLIC_PREF_ARANCELARIA_CO,' '), "
        /*58*/ + " NVL(TIC.REQUIERE_UVA,' '), "
        /*59*/ + " NVL(TIC.REQUIERE_CA,' '), "
        /*60*/ + " CASE WHEN nvl(to_char(TIC.FECHA_RECEPCION_CA, 'MM/DD/YYYY'), ' ') =  '12/30/1899' THEN ' ' WHEN  nvl(to_char(TIC.FECHA_RECEPCION_CA, 'MM/DD/YYYY'), ' ') =  '12/30/1999' THEN ' ' ELSE nvl(to_char(TIC.FECHA_RECEPCION_CA, 'Mon/DD/YYYY'),  ' ') END, "  
        /*61*/ + " NVL(TIC.NÚMERO_CONSTANCIA_CA,' '), "
        /*62*/ + " NVL(TIC.MONTO_CA,' '), "
        /*63*/ + " CASE WHEN nvl(to_char(TIC.FECHA_DOCUMENTOS_COMPLETOS, 'MM/DD/YYYY'), ' ') =  '12/30/1899' THEN ' '  WHEN  nvl(to_char(TIC.FECHA_DOCUMENTOS_COMPLETOS, 'MM/DD/YYYY'), ' ') =  '12/30/1999' THEN ' ' ELSE nvl(to_char(TIC.FECHA_DOCUMENTOS_COMPLETOS, 'Mon/DD/YYYY'),  ' ') END, "  
        /*64*/ + " CASE WHEN nvl(to_char(TIC.FECHA_PAGO_PEDIMENTO, 'MM/DD/YYYY'), ' ') =  '12/30/1899' THEN ' ' WHEN  nvl(to_char(TIC.FECHA_PAGO_PEDIMENTO, 'MM/DD/YYYY'), ' ') =  '12/30/1999' THEN ' '   ELSE nvl(to_char(TIC.FECHA_PAGO_PEDIMENTO, 'Mon/DD/YYYY'),  ' ') END,"  
        /*65*/ + " CASE WHEN nvl(to_char(TIC.FECHA_SOLICITUD_TRANSPORTE, 'MM/DD/YYYY'), ' ') =  '12/30/1899' THEN ' ' WHEN  nvl(to_char(TIC.FECHA_SOLICITUD_TRANSPORTE, 'MM/DD/YYYY'), ' ') =  '12/30/1999' THEN ' '  ELSE nvl(to_char(TIC.FECHA_SOLICITUD_TRANSPORTE, 'Mon/DD/YYYY'),  ' ') END,"  
        /*66*/ + " CASE WHEN nvl(to_char(TIC.FECHA_MODULACION, 'MM/DD/YYYY'), ' ') =  '12/30/1899' THEN ' ' WHEN  nvl(to_char(TIC.FECHA_MODULACION, 'MM/DD/YYYY'), ' ') =  '12/30/1999' THEN ' ' ELSE nvl(to_char(TIC.FECHA_MODULACION, 'Mon/DD/YYYY'),  ' ') END,"  
        /*67*/ + " NVL(TIC.MODALIDAD_CAMION_TREN,' '), "
        /*68*/ + " NVL(TIC.RESULT_MODULACION_VERDE_ROJO,' '), "
        /*69*/ + " CASE WHEN nvl(to_char(TIC.FECHA_RECONOCIMIENTO, 'MM/DD/YYYY'), ' ') =  '12/30/1899' THEN ' ' WHEN  nvl(to_char(TIC.FECHA_RECONOCIMIENTO, 'MM/DD/YYYY'), ' ') =  '12/30/1999' THEN ' '   ELSE nvl(to_char(TIC.FECHA_RECONOCIMIENTO, 'Mon/DD/YYYY'),  ' ') END, "  
        /*70*/ + " CASE WHEN nvl(to_char(TIC.FECHA_LIBERACION, 'MM/DD/YYYY'), ' ') =  '12/30/1899' THEN ' ' WHEN  nvl(to_char(TIC.FECHA_LIBERACION, 'MM/DD/YYYY'), ' ') =  '12/30/1999' THEN ' '  ELSE nvl(to_char(TIC.FECHA_LIBERACION, 'Mon/DD/YYYY'),  ' ') END, "  
        /*71*/ + " NVL(TIC.SELLO_ORIGEN,' '), "
        /*72*/ + " NVL(TIC.SELLO_FINAL,' '), "
        /*73*/ + " CASE WHEN nvl(to_char(TIC.FECHA_RETENCION_AUTORIDAD, 'MM/DD/YYYY'), ' ') =  '12/30/1899' THEN ' ' WHEN  nvl(to_char(TIC.FECHA_RETENCION_AUTORIDAD, 'MM/DD/YYYY'), ' ') =  '12/30/1999' THEN ' '  ELSE nvl(to_char(TIC.FECHA_RETENCION_AUTORIDAD, 'Mon/DD/YYYY'),  ' ') END, "  
        /*74*/ + " CASE WHEN nvl(to_char(TIC.FECHA_LIB_POR_RET_AUT, 'MM/DD/YYYY'), ' ') =  '12/30/1899' THEN ' ' WHEN  nvl(to_char(TIC.FECHA_LIB_POR_RET_AUT, 'MM/DD/YYYY'), ' ') =  '12/30/1999' THEN ' '  ELSE nvl(to_char(TIC.FECHA_LIB_POR_RET_AUT, 'Mon/DD/YYYY'),  ' ') END, "      
        /*75*/ + " NVL(TEC.DESCRIPCION_ESTADO,' '), "
        /*76*/ + " NVL(TIC.MOTIVO_ATRASO,' '), "
        /*77*/ + " NVL(TIC.OBSERVACIONES,' '), "
        /*78*/ + " CASE WHEN nvl(to_char(TIC.LLEGADA_A_NOVA, 'MM/DD/YYYY'), ' ') =  '12/30/1899' THEN ' '  WHEN  nvl(to_char(TIC.LLEGADA_A_NOVA, 'MM/DD/YYYY'), ' ') =  '12/30/1999' THEN ' '  ELSE nvl(to_char(TIC.LLEGADA_A_NOVA, 'Mon/DD/YYYY'),  ' ') END, "  
        /*79*/ + " CASE WHEN nvl(to_char(TIC.LLEGADA_A_GLOBE_TRADE_SD, 'MM/DD/YYYY'), ' ') =  '12/30/1899' THEN ' '  WHEN  nvl(to_char(TIC.LLEGADA_A_GLOBE_TRADE_SD, 'MM/DD/YYYY'), ' ') =  '12/30/1999' THEN ' ' ELSE nvl(to_char(TIC.LLEGADA_A_GLOBE_TRADE_SD, 'Mon/DD/YYYY'),  ' ') END, "  
        /*80*/ + " NVL(TIC.ARCHIVO_M,' '), "
        /*81*/ + " CASE WHEN nvl(to_char(TIC.FECHA_ARCHIVO_M, 'MM/DD/YYYY'), ' ') =  '12/30/1899' THEN ' ' WHEN  nvl(to_char(TIC.FECHA_ARCHIVO_M, 'MM/DD/YYYY'), ' ') =  '12/30/1999' THEN ' ' ELSE nvl(to_char(TIC.FECHA_ARCHIVO_M, 'Mon/DD/YYYY'),  ' ') END, "  
        /*82*/ + " CASE WHEN nvl(to_char(TIC.FECHA_SOLICIT_MANIP, 'MM/DD/YYYY'), ' ') =  '12/30/1899' THEN ' ' WHEN  nvl(to_char(TIC.FECHA_SOLICIT_MANIP, 'MM/DD/YYYY'), ' ') =  '12/30/1999' THEN ' '  ELSE nvl(to_char(TIC.FECHA_SOLICIT_MANIP, 'Mon/DD/YYYY'),  ' ') END, "  
        /*83*/ + " CASE WHEN nvl(to_char(TIC.FECHA_VENCIM_MANIP, 'MM/DD/YYYY'), ' ') =  '12/30/1899' THEN ' '  WHEN  nvl(to_char(TIC.FECHA_VENCIM_MANIP, 'MM/DD/YYYY'), ' ') =  '12/30/1999' THEN ' '   ELSE nvl(to_char(TIC.FECHA_VENCIM_MANIP, 'Mon/DD/YYYY'),  ' ') END, "  
        /*84*/ + " CASE WHEN nvl(to_char(TIC.FECHA_CONFIRM_CLAVE_PEDIM, 'MM/DD/YYYY'), ' ') =  '12/30/1899' THEN ' '  WHEN  nvl(to_char(TIC.FECHA_CONFIRM_CLAVE_PEDIM, 'MM/DD/YYYY'), ' ') =  '12/30/1999' THEN ' ' ELSE nvl(to_char(TIC.FECHA_CONFIRM_CLAVE_PEDIM, 'Mon/DD/YYYY'),  ' ') END, "  
        /*85*/ + " CASE WHEN nvl(to_char(TIC.FECHA_RECEP_INCREMENT, 'MM/DD/YYYY'), ' ') =  '12/30/1899' THEN ' ' WHEN  nvl(to_char(TIC.FECHA_RECEP_INCREMENT, 'MM/DD/YYYY'), ' ') =  '12/30/1999' THEN ' '   ELSE nvl(to_char(TIC.FECHA_RECEP_INCREMENT, 'Mon/DD/YYYY'),  ' ') END, "  
        /*86*/ + " NVL(TIC.T_E,' '), "
        /*87*/ + " CASE WHEN nvl(to_char(TIC.FECHA_VENCIM_INBOUND, 'MM/DD/YYYY'), ' ') =  '12/30/1899' THEN ' ' WHEN  nvl(to_char(TIC.FECHA_VENCIM_INBOUND, 'MM/DD/YYYY'), ' ') =  '12/30/1999' THEN ' '  ELSE nvl(to_char(TIC.FECHA_VENCIM_INBOUND, 'Mon/DD/YYYY'),  ' ') END, "  
       /*88*/ + " NVL(TIC.NO_BULTOS,' '), "
        /*89*/ + " NVL(TIC.PESO_KG,' '), "
        /*90*/ + " NVL(TIC.TRANSFERENCIA,' '), "
        /*91*/ + " CASE WHEN nvl(to_char(TIC.FECHA_INICIO_ETIQUETADO, 'MM/DD/YYYY'), ' ') =  '12/30/1899' THEN ' ' WHEN  nvl(to_char(TIC.FECHA_INICIO_ETIQUETADO, 'MM/DD/YYYY'), ' ') =  '12/30/1999' THEN ' '  ELSE nvl(to_char(TIC.FECHA_INICIO_ETIQUETADO, 'Mon/DD/YYYY'),  ' ') END, "  
        /*92*/ + " CASE WHEN nvl(to_char(TIC.FECHA_TERMINO_ETIQUETADO, 'MM/DD/YYYY'), ' ') =  '12/30/1899' THEN ' ' WHEN  nvl(to_char(TIC.FECHA_TERMINO_ETIQUETADO, 'MM/DD/YYYY'), ' ') =  '12/30/1999' THEN ' '  ELSE nvl(to_char(TIC.FECHA_TERMINO_ETIQUETADO, 'Mon/DD/YYYY'),  ' ') END, "  
