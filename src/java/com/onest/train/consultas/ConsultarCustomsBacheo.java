...
public class ConsultarCustomsBacheo extends HttpServlet {
    ...
    /*  ----------------------------- FILTROS MULTISELECT ENCABEZADOS  -----------------------------  */  
        ...
        /*64*/ + " CASE WHEN nvl(to_char(TIC.FECHA_PAGO_PEDIMENTO, 'DD/MM/YYYY'), ' ') =  '12/30/1899' THEN ' ' WHEN  nvl(to_char(TIC.FECHA_PAGO_PEDIMENTO, 'DD/MM/YYYY'), ' ') =  '12/30/1999' THEN ' '   ELSE TO_CHAR(TO_DATE(TIC.FECHA_PAGO_PEDIMENTO, 'MM/DD/YYYY'), 'Mon/DD/YY') END,"  
        ...
        /*66*/ + " CASE WHEN nvl(to_char(TIC.FECHA_MODULACION, 'DD/MM/YYYY'), ' ') =  '12/30/1899' THEN ' ' WHEN  nvl(to_char(TIC.FECHA_MODULACION, 'DD/MM/YYYY'), ' ') =  '12/30/1999' THEN ' ' ELSE TO_CHAR(TO_DATE(TIC.FECHA_MODULACION, 'MM/DD/YYYY'), 'Mon/DD/YY') END,"  
        ...
        /*70*/ + " CASE WHEN nvl(to_char(TIC.FECHA_LIBERACION, 'DD/MM/YYYY'), ' ') =  '12/30/1899' THEN ' ' WHEN  nvl(to_char(TIC.FECHA_LIBERACION, 'DD/MM/YYYY'), ' ') =  '12/30/1999' THEN ' '  ELSE TO_CHAR(TO_DATE(TIC.FECHA_LIBERACION, 'MM/DD/YYYY'), 'Mon/DD/YY') END, "  
