 ...
 */
public class ConsultarReporteCustoms extends HttpServlet {
            ...
            /*  ----------------------------- CUERPO/DATA DE TABLA  -----------------------------  */
                    ...
                    if (!excluirShipment) {
                        salida += "<tr id=\"tr<" + cont + "\">"
                                ...
                                + " <th contenteditable=\"false\" oninput=\"validarTextoAlfanumericoReferenciaAA(this,'referenciaAA'," + cont + ")\" onkeydown=\"tabuladorVertical(event,'referenciaAA'," + cont + ")\"  id=\"referenciaAA[" + cont + "]\">" + row[30] + "</th> "
                                ...
                                + " <td contenteditable=\"false\" oninput=\"validarTextoPais(this," + cont + ")\" onkeydown=\"tabuladorVertical(event,'pais_origen'," + cont + ")\" id=\"pais_origen[" + cont + "]\" onpaste=\"handlePasteText(event)\">" + row[31] + "</td> "
                                + " <td contenteditable=\"false\" oninput=\"validarTextoAlfanumerico(this,'size_container'," + cont + ")\" onkeydown=\"tabuladorVertical(event,'size_container'," + cont + ")\" onpaste=\"handlePasteAlfanumerico(event)\" id=\"size_container[" + cont + "]\">" + row[32] + "</td> "
                                + " <td contenteditable=\"false\" oninput=\"validarNumero(event)\" onkeydown=\"tabuladorVertical(event,'valor_usd'," + cont + ")\" onpaste=\"handlePasteNumber(event)\" id=\"valor_usd[" + cont + "]\">" + row[33] + "</td> "
                                + " <td contenteditable=\"false\" oninput=\"formatoFecha(event)\" id=\"eta_port_discharge[" + cont + "]\" onkeydown=\"tabuladorVertical(event,'eta_port_discharge'," + cont + ")\" ondblclick=\"show_eta_port_discharge('" + row[34] + "'," + cont + ")\" onpaste=\"handlePasteFechaEtaPortDischarge(event," + cont + ")\">" + row[34] + "</td> "
                                + " <td contenteditable=\"false\" oninput=\"validarTextoParametrizacion(this,'agente_aduanal'," + cont + ")\" onkeydown=\"tabuladorVertical(event,'agente_aduanal'," + cont + ")\" onpaste=\"handlePasteText(event)\" id=\"agente_aduanal[" + cont + "]\">" + row[35] + "</td> "
                                + " <td contenteditable=\"false\" onkeypress=\"formatoNumero(event,'" + cont + "','pedimento_a1')\" onkeydown=\"tabuladorVertical(event,'pedimento_a1'," + cont + ")\" onpaste=\"handlePasteNumberPedimento(event,'" + cont + "','pedimento_a1')\" id=\"pedimento_a1[" + cont + "]\">" + row[36] + "</td> "
                                + " <td contenteditable=\"false\" onkeypress=\"formatoNumero(event,'" + cont + "','pedimento_r1_1er')\" onkeydown=\"tabuladorVertical(event,'pedimento_r1_1er'," + cont + ")\" onpaste=\"handlePasteNumberPedimento(event,'" + cont + "','pedimento_r1_1er')\" id=\"pedimento_r1_1er[" + cont + "]\">" + row[37] + "</td> "
                                + " <td contenteditable=\"false\" oninput=\"validarTextoAlfanumericoMotivoRectificacion(this,'motivo_rectificacion_1er'," + cont + ")\" onkeydown=\"tabuladorVertical(event,'motivo_rectificacion_1er'," + cont + ")\" onpaste=\"handlePasteAlfanumericoMotivoRectificacion(event)\" id=\"motivo_rectificacion_1er[" + cont + "]\">" + row[38] + "</td> "
                                + " <td contenteditable=\"false\" onkeypress=\"formatoNumero(event,'" + cont + "','pedimento_r1_2do')\" onkeydown=\"tabuladorVertical(event,'pedimento_r1_2do'," + cont + ")\" onpaste=\"handlePasteNumberPedimento(event,'" + cont + "','pedimento_r1_2do')\" id=\"pedimento_r1_2do[" + cont + "]\">" + row[39] + "</td> "
                                + " <td contenteditable=\"false\" oninput=\"validarTextoAlfanumericoMotivoRectificacion(this,'motivo_rectificacion_2do'," + cont + ")\" onkeydown=\"tabuladorVertical(event,'motivo_rectificacion_2do'," + cont + ")\" onpaste=\"handlePasteAlfanumericoMotivoRectificacion(event)\" id=\"motivo_rectificacion_2do[" + cont + "]\">" + row[40] + "</td> "
                                + " <td contenteditable=\"false\" oninput=\"formatoFecha(event)\" id=\"fecha_recepcion_doc[" + cont + "]\" onkeydown=\"tabuladorVertical(event,'fecha_recepcion_doc'," + cont + ")\" ondblclick=\"show_fecha_recepcion_doc('" + row[41] + "'," + cont + ")\" onpaste=\"handlePasteFecha(event)\">" + row[41] + "</td> "
                                + " <td contenteditable=\"false\" oninput=\"validarTextoParametrizacion(this,'recinto'," + cont + ")\" onkeydown=\"tabuladorVertical(event,'recinto'," + cont + ")\" onpaste=\"handlePasteText(event)\" id=\"recinto[" + cont + "]\">" + row[42] + "</td> "
                                + " <td contenteditable=\"false\" oninput=\"validarTextoParametrizacion(this,'naviera'," + cont + ")\" onkeydown=\"tabuladorVertical(event,'naviera'," + cont + ")\" onpaste=\"handlePasteText(event)\" id=\"naviera[" + cont + "]\">" + row[43] + "</td> "
                                + " <td contenteditable=\"false\" oninput=\"validarTextoParametrizacion(this,'buque'," + cont + ")\" onkeydown=\"tabuladorVertical(event,'buque'," + cont + ")\" onpaste=\"handlePasteText(event)\" id=\"buque[" + cont + "]\">" + row[44] + "</td> "
                                + " <td contenteditable=\"false\" oninput=\"formatoFecha(event)\" id=\"fecha_revalidacion[" + cont + "]\" onkeydown=\"tabuladorVertical(event,'fecha_revalidacion'," + cont + ")\" ondblclick=\"show_fecha_revalidacion('" + row[45] + "'," + cont + ")\" onpaste=\"handlePasteFecha(event)\">" + row[45] + "</td> "
                                + " <td contenteditable=\"false\" oninput=\"formatoFecha(event)\" id=\"fecha_previo_origen[" + cont + "]\" onkeydown=\"tabuladorVertical(event,'fecha_previo_origen'," + cont + ")\" ondblclick=\"show_fecha_previo_origen('" + row[46] + "'," + cont + ")\" onpaste=\"handlePasteFecha(event)\">" + row[46] + "</td> "
                                + " <td contenteditable=\"false\" oninput=\"formatoFecha(event)\" id=\"fecha_previo_destino[" + cont + "]\" onkeydown=\"tabuladorVertical(event,'fecha_previo_destino'," + cont + ")\" ondblclick=\"show_fecha_previo_destino('" + row[47] + "'," + cont + ")\" onpaste=\"handlePasteFecha(event)\">" + row[47] + "</td> "
                                + " <td contenteditable=\"false\" oninput=\"formatoFecha(event)\" id=\"fecha_resultado_previo[" + cont + "]\" onkeydown=\"tabuladorVertical(event,'fecha_resultado_previo'," + cont + ")\" ondblclick=\"show_fecha_resultado_previo('" + row[48] + "'," + cont + ")\" onpaste=\"handlePasteFecha(event)\">" + row[48] + "</td> "
                                + " <td contenteditable=\"false\" oninput=\"formatoFecha(event)\" id=\"proforma_final[" + cont + "]\" onkeydown=\"tabuladorVertical(event,'proforma_final'," + cont + ")\" ondblclick=\"show_proforma_final('" + row[49] + "'," + cont + ")\" onpaste=\"handlePasteFecha(event)\">" + row[49] + "</td> "
                                + " <td contenteditable=\"false\" oninput=\"validarTextoCheckbox(this)\" id=\"permiso[" + cont + "]\" onkeydown=\"tabuladorVertical(event,'permiso'," + cont + ")\" ondblclick=\"show_permiso(" + cont + ")\" onpaste=\"handlePasteTextCheckBox(event)\">" + row[50] + "</td> "
                                + " <td contenteditable=\"false\" oninput=\"formatoFecha(event)\" id=\"fecha_envio[" + cont + "]\" onkeydown=\"tabuladorVertical(event,'fecha_envio'," + cont + ")\" ondblclick=\"show_fecha_envio('" + row[51] + "','fecha_envio'," + cont + ")\" onpaste=\"handlePasteFecha(event)\">" + row[51] + "</td> "
                                + " <td contenteditable=\"false\" oninput=\"formatoFecha(event)\" id=\"fecha_recepcion_perm[" + cont + "]\" onkeydown=\"tabuladorVertical(event,'fecha_recepcion_perm'," + cont + ")\" ondblclick=\"show_fecha_recepcion_perm('" + row[52] + "','fecha_recepcion_perm'," + cont + ")\" onpaste=\"handlePasteFecha(event)\">" + row[52] + "</td> "
                                + " <td contenteditable=\"false\" oninput=\"formatoFecha(event)\" id=\"fecha_activacion_perm[" + cont + "]\" onkeydown=\"tabuladorVertical(event,'fecha_activacion_perm'," + cont + ")\" ondblclick=\"show_fecha_activacion_perm('" + row[53] + "','fecha_activacion_perm'," + cont + ")\" onpaste=\"handlePasteFecha(event)\">" + row[53] + "</td> "
                                + " <td contenteditable=\"false\" oninput=\"formatoFecha(event)\" id=\"fecha_permisos_aut[" + cont + "]\" onkeydown=\"tabuladorVertical(event,'fecha_permisos_aut'," + cont + ")\" ondblclick=\"show_fecha_permisos_aut('" + row[54] + "','fecha_permisos_aut'," + cont + ")\" onpaste=\"handlePasteFecha(event)\">" + row[54] + "</td> "
                                + " <td contenteditable=\"false\" oninput=\"validarTextoCheckbox(this)\" id=\"co_pref_arancelaria[" + cont + "]\" onkeydown=\"tabuladorVertical(event,'co_pref_arancelaria'," + cont + ")\" ondblclick=\"show_co_pref_arancelaria(" + cont + ")\" onpaste=\"handlePasteTextCheckBox(event)\">" + row[55] + "</td> "
                                + " <td contenteditable=\"false\" oninput=\"validarTextoCheckbox(this)\" id=\"aplic_pref_arancelaria[" + cont + "]\" onkeydown=\"tabuladorVertical(event,'aplic_pref_arancelaria'," + cont + ")\" ondblclick=\"show_aplic_pref_arancelaria(" + cont + ")\" onpaste=\"handlePasteTextCheckBox(event)\">" + row[56] + "</td> "
                                + " <td contenteditable=\"false\" oninput=\"validarTextoCheckbox(this)\" id=\"req_uva[" + cont + "]\" onkeydown=\"tabuladorVertical(event,'req_uva'," + cont + ")\" ondblclick=\"show_req_uva(" + cont + ")\" onpaste=\"handlePasteTextCheckBox(event)\">" + row[57] + "</td> "
                                + " <td contenteditable=\"false\" oninput=\"validarTextoCheckbox(this)\" id=\"req_ca[" + cont + "]\" onkeydown=\"tabuladorVertical(event,'req_ca'," + cont + ")\" ondblclick=\"show_req_ca(" + cont + ")\" onpaste=\"handlePasteTextCheckBox(event)\">" + row[58] + "</td> "
                                + " <td contenteditable=\"false\" oninput=\"formatoFecha(event)\" id=\"fecha_recepcion_ca[" + cont + "]\" onkeydown=\"tabuladorVertical(event,'fecha_recepcion_ca'," + cont + ")\" ondblclick=\"show_fecha_recepcion_ca('" + row[59] + "','fecha_recepcion_ca'," + cont + ")\" onpaste=\"handlePasteFecha(event)\">" + row[59] + "</td> "
                                + " <td contenteditable=\"false\" oninput=\"validarNumero(event)\" onkeydown=\"tabuladorVertical(event,'num_constancia_ca'," + cont + ")\" onpaste=\"handlePasteNumber(event)\" onclick=\"show_num_constancia_ca('num_constancia_ca'," + cont + ")\" id=\"num_constancia_ca[" + cont + "]\">" + row[60] + "</td> "
                                + " <td contenteditable=\"false\" oninput=\"validarNumero(event)\" onkeydown=\"tabuladorVertical(event,'monto_ca'," + cont + ")\" onpaste=\"handlePasteNumber(event)\" contenteditable=\"false\" onclick=\"show_monto_ca('monto_ca'," + cont + ")\" id=\"monto_ca[" + cont + "]\">" + row[61] + "</td> "
                                ...
                                + " <td contenteditable=\"false\" oninput=\"formatoFecha(event)\" id=\"fecha_liberacion[" + cont + "]\" onkeydown=\"tabuladorVertical(event,'fecha_liberacion'," + cont + ")\" ondblclick=\"show_fecha_liberacion('" + row[69] + "'," + cont + ")\" onpaste=\"handlePasteFecha(event)\">" + row[69] + "</td> "
                                + " <td contenteditable=\"false\" oninput=\"validarTextoAlfanumerico(this,'sello_origen'," + cont + ")\" onkeydown=\"tabuladorVertical(event,'sello_origen'," + cont + ")\" onpaste=\"handlePasteAlfanumerico(event)\" id=\"sello_origen[" + cont + "]\">" + row[70] + "</td> "
                                + " <td contenteditable=\"false\" oninput=\"validarTextoAlfanumerico(this,'sello_final'," + cont + ")\" onkeydown=\"tabuladorVertical(event,'sello_final'," + cont + ")\" onpaste=\"handlePasteAlfanumerico(event)\" id=\"sello_final[" + cont + "]\">" + row[71] + "</td> "
                                + " <td contenteditable=\"false\" oninput=\"formatoFecha(event)\" id=\"fecha_retencion_aut[" + cont + "]\" onkeydown=\"tabuladorVertical(event,'fecha_retencion_aut'," + cont + ")\" ondblclick=\"show_fecha_retencion_aut('" + row[72] + "'," + cont + ")\" onpaste=\"handlePasteFecha(event)\">" + row[72] + "</td> "
                                + " <td contenteditable=\"false\" oninput=\"formatoFecha(event)\" id=\"fecha_liberacion_aut[" + cont + "]\" onkeydown=\"tabuladorVertical(event,'fecha_liberacion_aut'," + cont + ")\" ondblclick=\"show_fecha_liberacion_aut('" + row[73] + "'," + cont + ")\" onpaste=\"handlePasteFecha(event)\">" + row[73] + "</td> "
                                ...
                                + " <td contenteditable=\"false\" oninput=\"validarTextoAlfanumericoMotivoAtraso(this,'motivo_atraso'," + cont + ")\" onkeydown=\"tabuladorVertical(event,'motivo_atraso'," + cont + ")\" id=\"motivo_atraso[" + cont + "]\" onpaste=\"handlePasteAlfanumericoMotivoAtraso(event)\">" + row[75] + "</td> "
                                + " <td contenteditable=\"false\" oninput=\"validarTextoAlfanumericoObservaciones(this,'observaciones'," + cont + ")\" onkeydown=\"tabuladorVertical(event,'observaciones'," + cont + ")\" onpaste=\"handlePasteAlfanumericoObservaciones(event)\" id=\"observaciones[" + cont + "]\">" + row[76] + "</td> ";

                        if (AgentType.equals("4001") || AgentType.equals("4006")) { //LOGIX Y VF

                            salida += " <td contenteditable=\"false\" oninput=\"formatoFecha(event)\" id=\"llegada_a_nova[" + cont + "]\" onkeydown=\"tabuladorVertical(event,'llegada_a_nova'," + cont + ")\" ondblclick=\"show_llegada_a_nova('" + row[77] + "'," + cont + ")\" onpaste=\"handlePasteFecha(event)\">" + row[77] + "</td> "
                                    + " <td contenteditable=\"false\" oninput=\"formatoFecha(event)\" id=\"llegada_a_globe_trade_sd[" + cont + "]\" onkeydown=\"tabuladorVertical(event,'llegada_a_globe_trade_sd'," + cont + ")\" ondblclick=\"show_llegada_a_globe_trade_sd('" + row[78] + "'," + cont + ")\" onpaste=\"handlePasteFecha(event)\">" + row[78] + "</td> "
                                    + " <td contenteditable=\"false\" oninput=\"validarTextoAlfanumericoSnParametrizacion(this)\" onkeydown=\"tabuladorVertical(event,'archivo_m'," + cont + ")\" onpaste=\"handlePasteAlfanumerico(event)\" id=\"archivo_m[" + cont + "]\">" + row[79] + "</td> "
                                    + " <td contenteditable=\"false\" oninput=\"formatoFecha(event)\" id=\"fecha_archivo_m[" + cont + "]\" onkeydown=\"tabuladorVertical(event,'fecha_archivo_m'," + cont + ")\" ondblclick=\"show_fecha_archivo_m('" + row[80] + "'," + cont + ")\" onpaste=\"handlePasteFecha(event)\">" + row[80] + "</td> "
                                    + " <td contenteditable=\"false\" oninput=\"formatoFecha(event)\" id=\"fecha_solicit_manip[" + cont + "]\" onkeydown=\"tabuladorVertical(event,'fecha_solicit_manip'," + cont + ")\" ondblclick=\"show_fecha_solicit_manip('" + row[81] + "'," + cont + ")\" onpaste=\"handlePasteFecha(event)\">" + row[81] + "</td> "
                                    + " <td contenteditable=\"false\" oninput=\"formatoFecha(event)\" id=\"fecha_vencim_manip[" + cont + "]\" onkeydown=\"tabuladorVertical(event,'fecha_vencim_manip'," + cont + ")\" ondblclick=\"show_fecha_vencim_manip('" + row[82] + "'," + cont + ")\" onpaste=\"handlePasteFecha(event)\">" + row[82] + "</td> "
                                    + " <td contenteditable=\"false\" oninput=\"formatoFecha(event)\" id=\"fecha_confirm_clave_pedim[" + cont + "]\" onkeydown=\"tabuladorVertical(event,'fecha_confirm_clave_pedim'," + cont + ")\" ondblclick=\"show_fecha_confirm_clave_pedim('" + row[83] + "'," + cont + ")\" onpaste=\"handlePasteFecha(event)\">" + row[83] + "</td> "
                                    + " <td contenteditable=\"false\" oninput=\"formatoFecha(event)\" id=\"fecha_recep_increment[" + cont + "]\" onkeydown=\"tabuladorVertical(event,'fecha_recep_increment'," + cont + ")\" ondblclick=\"show_fecha_recep_increment('" + row[84] + "'," + cont + ")\" onpaste=\"handlePasteFecha(event)\">" + row[84] + "</td> "
                                    + " <td contenteditable=\"false\" oninput=\"validarNumeroT_E(event)\" onkeydown=\"tabuladorVertical(event,'t_e'," + cont + ")\" onpaste=\"handlePasteNumberT_E(event)\" id=\"t_e[" + cont + "]\">" + row[85] + "</td> "
                                    + " <td contenteditable=\"false\" oninput=\"formatoFecha(event)\" id=\"fecha_vencim_inbound[" + cont + "]\" onkeydown=\"tabuladorVertical(event,'fecha_vencim_inbound'," + cont + ")\" ondblclick=\"show_fecha_vencim_inbound('" + row[86] + "'," + cont + ")\" onpaste=\"handlePasteFecha(event)\">" + row[86] + "</td> ";
                        }

                        if (AgentType.equals("4002") || AgentType.equals("4006")) {  //CUSA Y VF

                            salida += " <td contenteditable=\"false\" oninput=\"validarNumero(event)\" onkeydown=\"tabuladorVertical(event,'no_bultos'," + cont + ")\" onpaste=\"handlePasteNumber(event)\" id=\"no_bultos[" + cont + "]\">" + row[87] + "</td> "
                                    + " <td contenteditable=\"false\" oninput=\"validarNumero(event)\" onkeydown=\"tabuladorVertical(event,'peso_kg'," + cont + ")\" onpaste=\"handlePasteNumber(event)\" id=\"peso_kg[" + cont + "]\">" + row[88] + "</td> "
                                    + " <td contenteditable=\"false\" oninput=\"validarTextoCheckbox(this)\" id=\"transferencia[" + cont + "]\" onkeydown=\"tabuladorVertical(event,'transferencia'," + cont + ")\" ondblclick=\"show_transferencia(" + cont + ")\" onpaste=\"handlePasteTextCheckBox(event)\">" + row[89] + "</td> "
                                    + " <td contenteditable=\"false\" oninput=\"formatoFecha(event)\" id=\"fecha_inicio_etiquetado[" + cont + "]\" onkeydown=\"tabuladorVertical(event,'fecha_inicio_etiquetado'," + cont + ")\" ondblclick=\"show_fecha_inicio_etiquetado('" + row[90] + "'," + cont + ")\" onpaste=\"handlePasteFecha(event)\">" + row[90] + "</td> "
                                    + " <td contenteditable=\"false\" oninput=\"formatoFecha(event)\" id=\"fecha_termino_etiquetado[" + cont + "]\" onkeydown=\"tabuladorVertical(event,'fecha_termino_etiquetado'," + cont + ")\" ondblclick=\"show_fecha_termino_etiquetado('" + row[91] + "'," + cont + ")\" onpaste=\"handlePasteFecha(event)\">" + row[91] + "</td> "
                                    ...
                                    + " <td contenteditable=\"false\" oninput=\"validarTexto(this)\" onkeydown=\"tabuladorVertical(event,'proveedor'," + cont + ")\" onpaste=\"handlePasteText(event)\" id=\"proveedor[" + cont + "]\">" + row[93] + "</td> "
