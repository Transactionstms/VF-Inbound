...
///verificar
    ...
    public String consultarEventosCustoms(String tipoAgente, String tipoFiltro, String id){
        ...
        /*10*/ + " SQ.SUMA, "
        /*11*/ + " TIP1.NOMBRE_POD, "
        /*12*/ + " REPLACE(NVL(TO_CHAR(GTN.EST_DEPARTURE_POL, 'MM/DD/YY'),' '), '12/30/1899', ' '), "
        /*13*/ + " REPLACE(NVL(TO_CHAR(GTN.ETA_PORT_DISCHARGE, 'MM/DD/YY'),' '), '12/30/1899', ' '), "
        /*14*/ + " NVL(GTN.MAX_FLETE, 0) AS EST_ETA_DC, "
        /*15*/ + " REPLACE(NVL(TO_CHAR(GTN.FECHA_CAPTURA, 'MM/DD/YYYY'),' '), '12/30/1899', ' '), "
        /*16*/ + " TIP2.NOMBRE_POL, "
        /*17*/ + " NVL(TAA.AGENTE_ADUANAL_NOMBRE, ' ') AS AGENTE_ADUANAL, "
        /*18*/ + " GTN.PLANTILLA_ID, "
        /*19*/ + " SYSDATE AS FECHA_CAPTURAOLD, "
        ...
        /*21*/ + " TIP2.NOMBRE_POL, "
        /*22*/ + " TIBD.NOMBRE_BD, "
        /*23*/ + " REPLACE(NVL(TO_CHAR(GTN.ETA_PLUS2, 'MM/DD/YYYY'),' '), '12/30/1899', ' '), "
        /*24*/ + " REPLACE(NVL(TO_CHAR(TIE.EST_ETA_DC, 'MM/DD/YYYY'),' '), '12/30/1899', ' '), "
        /*25*/ + " REPLACE(NVL(TO_CHAR(GTN.ETA_PLUS, 'MM/DD/YYYY'),' '), '12/30/1899', ' '), "
        /*26*/ + " NVL(TIE.OBSERVACIONES, ' ') AS OBSERVACIONES, "
        /*27*/ + " TIE.ESTATUS_EVENTO, "
        /*28*/ + " NVL(TIE.REFERENCIA_AA,' '), "
        /*29*/ + " REPLACE(NVL(TO_CHAR(TIE.FECHA_CAPTURA, 'MM/DD/YYYY'),' '), '12/30/1899', ' '), "
        /*30*/ + " NVL(TIE.PRIORIDAD,' '), "
        /*31*/ + " NVL(TIC.REFERENCIA_AA,' '), "
        /*32*/ + " NVL(TIC.PAIS_ORIGEN,' '), "
        /*33*/ + " NVL(TIC.SIZE_CONTAINER,' '), "
        /*34*/ + " NVL(TIC.VALOR_USD,' '), "
        /*35*/ + " REPLACE(NVL(TO_CHAR(TIC.ETA_PORT_OF_DISCHARGE, 'MM/DD/YYYY'),' '), '12/30/1899', ' '), "
        /*36*/ + " NVL(TIC.AGENTE_ADUANAL,' '), "
        /*37*/ + " NVL(TIC.PEDIMENTO_A1,' '), "
        /*38*/ + " NVL(TIC.PEDIMENTO_R1,' '), "
        /*39*/ + " NVL(TIC.MOTIVO_RECTIFICACION_1,' '), "
        /*40*/ + " NVL(TIC.PEDIMENTO_R1_2DO,' '), "
        /*41*/ + " NVL(TIC.MOTIVO_RECTIFICACION_2,' '), "
        /*42*/ + " REPLACE(NVL(TO_CHAR(TIC.FECHA_RECEPCION_DOCUMENTOS, 'MM/DD/YYYY'),' '), '12/30/1899', ' '), "
        /*43*/ + " NVL(TIC.RECINTO,' '), "
        /*44*/ + " NVL(TIC.NAVIERA_FORWARDER,' '), "
        /*45*/ + " NVL(TIC.BUQUE,' '), "
        /*46*/ + " REPLACE(NVL(TO_CHAR(TIC.FECHA_REVALID_LIBE_BL, 'MM/DD/YYYY'),' '), '12/30/1899', ' '), "
        /*47*/ + " REPLACE(NVL(TO_CHAR(TIC.FECHA_PREVIO_ORIGEN, 'MM/DD/YYYY'),' '), '12/30/1899', ' '), "
        /*48*/ + " REPLACE(NVL(TO_CHAR(TIC.FECHA_PREVIO_DESTINO, 'MM/DD/YYYY'),' '), '12/30/1899', ' '), "
        /*49*/ + " REPLACE(NVL(TO_CHAR(TIC.FECHA_RESULTADO_PREVIO, 'MM/DD/YYYY'),' '), '12/30/1899', ' '), "
        /*50*/ + " REPLACE(NVL(TO_CHAR(TIC.PROFORMA_FINAL, 'MM/DD/YYYY'),' '), '12/30/1899', ' '), "
        /*51*/ + " NVL(TIC.REQUIERE_PERMISO,' '), "
        /*52*/ + " REPLACE(NVL(TO_CHAR(TIC.FECHA_ENVIO_FICHAS_NOTAS, 'MM/DD/YYYY'),' '), '12/30/1899', ' '), "
        /*53*/ + " REPLACE(NVL(TO_CHAR(TIC.FEC_RECEPCION_PERMISOS_TRAMIT, 'MM/DD/YYYY'),' '), '12/30/1899', ' '), "
        /*54*/ + " REPLACE(NVL(TO_CHAR(TIC.FEC_ACT_PERMISOS, 'MM/DD/YYYY'),' '), '12/30/1899', ' '), "
        /*55*/ + " REPLACE(NVL(TO_CHAR(TIC.FEC_PERM_AUT, 'MM/DD/YYYY'),' '), '12/30/1899', ' '), "
        /*56*/ + " NVL(TIC.CO_APLIC_PREF_ARANCELARIA,' '), "
        /*57*/ + " NVL(TIC.APLIC_PREF_ARANCELARIA_CO,' '), "
        /*58*/ + " NVL(TIC.REQUIERE_UVA,' '), "
        /*59*/ + " NVL(TIC.REQUIERE_CA,' '), "
        /*60*/ + " REPLACE(NVL(TO_CHAR(TIC.FECHA_RECEPCION_CA, 'MM/DD/YYYY'),' '), '12/30/1899', ' '), "
        /*61*/ + " NVL(TIC.NÚMERO_CONSTANCIA_CA,' '), "
        /*62*/ + " NVL(TIC.MONTO_CA,' '), "
        /*63*/ + " REPLACE(NVL(TO_CHAR(TIC.FECHA_DOCUMENTOS_COMPLETOS, 'MM/DD/YYYY'),' '), '12/30/1899', ' '), "
        /*64*/ + " REPLACE(NVL(TO_CHAR(TIC.FECHA_PAGO_PEDIMENTO, 'MM/DD/YYYY'),' '), '12/30/1899', ' '), "
        /*65*/ + " REPLACE(NVL(TO_CHAR(TIC.FECHA_SOLICITUD_TRANSPORTE, 'MM/DD/YYYY'),' '), '12/30/1899', ' '), "
        /*66*/ + " REPLACE(NVL(TO_CHAR(TIC.FECHA_MODULACION, 'MM/DD/YYYY'),' '), '12/30/1899', ' '), "
        /*67*/ + " NVL(TIC.MODALIDAD_CAMION_TREN,' '), "
        /*68*/ + " NVL(TIC.RESULT_MODULACION_VERDE_ROJO,' '), "
        /*69*/ + " REPLACE(NVL(TO_CHAR(TIC.FECHA_RECONOCIMIENTO, 'MM/DD/YYYY'),' '), '12/30/1899', ' '), "
        /*70*/ + " REPLACE(NVL(TO_CHAR(TIC.FECHA_LIBERACION, 'MM/DD/YYYY'),' '), '12/30/1899', ' '), "
        /*71*/ + " NVL(TIC.SELLO_ORIGEN,' '), "
        /*72*/ + " NVL(TIC.SELLO_FINAL,' '), "
        /*73*/ + " REPLACE(NVL(TO_CHAR(TIC.FECHA_RETENCION_AUTORIDAD, 'MM/DD/YYYY'),' '), '12/30/1899', ' '), "
        /*74*/ + " REPLACE(NVL(TO_CHAR(TIC.FECHA_LIB_POR_RET_AUT, 'MM/DD/YYYY'),' '), '12/30/1899', ' '), "
        /*75*/ + " NVL(TEC.DESCRIPCION_ESTADO,' '), "
        /*76*/ + " NVL(TIC.MOTIVO_ATRASO,' '), "
        /*77*/ + " NVL(TIC.OBSERVACIONES,' '), "
        /*78*/ + " REPLACE(NVL(TO_CHAR(TIC.LLEGADA_A_NOVA, 'MM/DD/YYYY'),' '), '12/30/1899', ' '), "
        /*79*/ + " REPLACE(NVL(TO_CHAR(TIC.LLEGADA_A_GLOBE_TRADE_SD, 'MM/DD/YYYY'),' '), '12/30/1899', ' '), "
        /*80*/ + " NVL(TIC.ARCHIVO_M,' '), "
        /*81*/ + " REPLACE(NVL(TO_CHAR(TIC.FECHA_ARCHIVO_M, 'MM/DD/YYYY'),' '), '12/30/1899', ' '), "
        /*82*/ + " REPLACE(NVL(TO_CHAR(TIC.FECHA_SOLICIT_MANIP, 'MM/DD/YYYY'),' '), '12/30/1899', ' '), "
        /*83*/ + " REPLACE(NVL(TO_CHAR(TIC.FECHA_VENCIM_MANIP, 'MM/DD/YYYY'),' '), '12/30/1899', ' '), "
        /*84*/ + " REPLACE(NVL(TO_CHAR(TIC.FECHA_CONFIRM_CLAVE_PEDIM, 'MM/DD/YYYY'),' '), '12/30/1899', ' '), "
        /*85*/ + " REPLACE(NVL(TO_CHAR(TIC.FECHA_RECEP_INCREMENT, 'MM/DD/YYYY'),' '), '12/30/1899', ' '), "
        /*86*/ + " NVL(TIC.T_E,' '), "
        /*87*/ + " REPLACE(NVL(TO_CHAR(TIC.FECHA_VENCIM_INBOUND, 'MM/DD/YYYY'),' '), '12/30/1899', ' '), "
        /*88*/ + " NVL(TIC.NO_BULTOS,' '), "
        /*89*/ + " NVL(TIC.PESO_KG,' '), "
        /*90*/ + " NVL(TIC.TRANSFERENCIA,' '), "
        /*91*/ + " REPLACE(NVL(TO_CHAR(TIC.FECHA_INICIO_ETIQUETADO, 'MM/DD/YYYY'),' '), '12/30/1899', ' '), "
        /*92*/ + " REPLACE(NVL(TO_CHAR(TIC.FECHA_TERMINO_ETIQUETADO, 'MM/DD/YYYY'),' '), '12/30/1899', ' '), "
        /*93*/ + " NVL(TIC.HORA_TERMINO_ETIQUETADO,' '), "
        /*94*/ + " NVL(TIC.PROVEEDOR,' '), "
        /*95*/ + " NVL(TIC.PROVEEDOR_CARGA,' '), "
        /*96*/ + " NVL(TIC.FY,' '), "
       ...
       /*103*/ + " NVL(TO_CHAR(GTN.FECHA_IMPORTACION, 'DD/MM/YY'),'-') "
        ...
        if(tipoFiltro.equals("0")){        //Sin filtros
          ...
          sql += " AND TO_DATE(trunc(GTN.EST_DEPARTURE_POL),'DD/MM/YY') = TO_DATE(" + id + ",'MM/DD/YY') ";
          ...
          sql += " AND TO_DATE(trunc(GTN.ETA_PLUS2),'DD/MM/YY') = TO_DATE(" + id + ",'MM/DD/YY') ";
        }else if(tipoFiltro.equals("16")){ //Inbound notification
          sql += " AND TO_DATE(trunc(GTN.FECHA_CAPTURA),'DD/MM/YYYY') = TO_DATE(" + id + ",'MM/DD/YYYY') ";
