...
/*10*/ + " SQ.SUMA, "
/*11*/ + " TIP1.NOMBRE_POD, "
/*12*/ + " TO_CHAR(GTN.EST_DEPARTURE_POL, 'MON/DD/YYYY') AS EST_DEPARTURE_POL, "
/*13*/ + " TO_CHAR(GTN.ETA_PORT_DISCHARGE, 'MON/DD/YYYY') AS ETA_REAL_PORT, "
/*14*/ + " NVL(GTN.MAX_FLETE, 0) AS EST_ETA_DC, "
/*15*/ + " 'INBOUND NOTIFICATION' AS NOTIFICATION_TYPE, "
/*16*/ + " TIP2.NOMBRE_POL, "
/*17*/ + " NVL(TAA.AGENTE_ADUANAL_NOMBRE, ' ') AS AGENTE_ADUANAL, "
/*18*/ + " GTN.PLANTILLA_ID, "
/*19*/ + " TO_CHAR(GTN.FECHA_CAPTURA, 'MON/DD/YYYY') AS FECHA_CAPTURA, "
/*20*/ + " TIP1.NOMBRE_POD, "
/*21*/ + " TIP2.NOMBRE_POL, "
/*22*/ + " TIBD.NOMBRE_BD, "
/*23*/ + " NVL(TO_CHAR(TIE.EST_ETA_DC, 'MON/DD/YYYY'),' '), "
/*24*/ + " NVL(TO_CHAR(GTN.ETA_PLUS2, 'MON/DD/YYYY'), ' ') AS ETA_DC, "
/*25*/ + " NVL(TO_CHAR(GTN.ETA_PLUS, 'MON/DD/YYYY'), ' ') AS ETA_DC1, "
/*26*/ + " NVL(TIE.OBSERVACIONES, ' ') AS OBSERVACIONES, "
/*27*/ + " TIE.ESTATUS_EVENTO, "
/*28*/ + " NVL(TIE.REFERENCIA_AA,' '), "
/*29*/ + " NVL(TO_CHAR(TIE.FECHA_CAPTURA, 'MON/DD/YYYY'),' '), "    
/*30*/ + " NVL(TIE.PRIORIDAD,' '), "  
/*31*/ + " NVL(TIC.REFERENCIA_AA,' '), " 
/*32*/ + " NVL(TIC.PAIS_ORIGEN,' '), "   
/*33*/ + " NVL(TIC.SIZE_CONTAINER,' '), "   
/*34*/ + " NVL(TIC.VALOR_USD,' '), "               
/*35*/ + " NVL(TO_CHAR(TIC.ETA_PORT_OF_DISCHARGE, 'MON/DD/YYYY'),' '), "       
/*36*/ + " NVL(TIC.AGENTE_ADUANAL,' '), "             
/*37*/ + " NVL(TIC.PEDIMENTO_A1,' '), "               
/*38*/ + " NVL(TIC.PEDIMENTO_R1,' '), "           
/*39*/ + " NVL(TIC.MOTIVO_RECTIFICACION_1,' '), "   
/*40*/ + " NVL(TIC.PEDIMENTO_R1_2DO,' '), "           
/*41*/ + " NVL(TIC.MOTIVO_RECTIFICACION_2,' '), "   
/*42*/ + " NVL(TO_CHAR(TIC.FECHA_RECEPCION_DOCUMENTOS, 'MON/DD/YYYY'),' '), "       
/*43*/ + " NVL(TIC.RECINTO,' '), "     
/*44*/ + " NVL(TIC.NAVIERA_FORWARDER,' '), "     
/*45*/ + " NVL(TIC.BUQUE,' '), "    
/*46*/ + " NVL(TO_CHAR(TIC.FECHA_REVALID_LIBE_BL, 'MON/DD/YYYY'),' '), "   
/*47*/ + " NVL(TO_CHAR(TIC.FECHA_PREVIO_ORIGEN, 'MON/DD/YYYY'),' '), "   
/*48*/ + " NVL(TO_CHAR(TIC.FECHA_PREVIO_DESTINO, 'MON/DD/YYYY'),' '), "   
/*49*/ + " NVL(TO_CHAR(TIC.FECHA_RESULTADO_PREVIO, 'MON/DD/YYYY'),' '), "   
/*50*/ + " NVL(TO_CHAR(TIC.PROFORMA_FINAL, 'MON/DD/YYYY'),' '), "           
/*51*/ + " NVL(TIC.REQUIERE_PERMISO,' '), "    
/*52*/ + " NVL(TO_CHAR(TIC.FECHA_ENVIO_FICHAS_NOTAS, 'MON/DD/YYYY'),' '), " 
/*53*/ + " NVL(TO_CHAR(TIC.FEC_RECEPCION_PERMISOS_TRAMIT, 'MON/DD/YYYY'),' '), " 
/*54*/ + " NVL(TO_CHAR(TIC.FEC_ACT_PERMISOS, 'MON/DD/YYYY'),' '), " 
/*55*/ + " NVL(TO_CHAR(TIC.FEC_PERM_AUT, 'MON/DD/YYYY'),' '), " 
/*56*/ + " NVL(TIC.CO_APLIC_PREF_ARANCELARIA,' '), "                     
/*57*/ + " NVL(TIC.APLIC_PREF_ARANCELARIA_CO,' '), "     
/*58*/ + " NVL(TIC.REQUIERE_UVA,' '), "                                  
/*59*/ + " NVL(TIC.REQUIERE_CA,' '), "    
/*60*/ + " NVL(TO_CHAR(TIC.FECHA_RECEPCION_CA, 'MON/DD/YYYY'),' '), " 
/*61*/ + " NVL(TIC.NÚMERO_CONSTANCIA_CA,' '), "                         
/*62*/ + " NVL(TIC.MONTO_CA,' '), "   
/*63*/ + " NVL(TO_CHAR(TIC.FECHA_DOCUMENTOS_COMPLETOS, 'MON/DD/YYYY'),' '), " 
/*64*/ + " NVL(TO_CHAR(TIC.FECHA_PAGO_PEDIMENTO, 'MON/DD/YYYY'),' '), " 
/*65*/ + " NVL(TO_CHAR(TIC.FECHA_SOLICITUD_TRANSPORTE, 'MON/DD/YYYY'),' '), " 
/*66*/ + " NVL(TO_CHAR(TIC.FECHA_MODULACION, 'MON/DD/YYYY'),' '), " 
/*67*/ + " NVL(TIC.MODALIDAD_CAMION_TREN,' '), "                  
/*68*/ + " NVL(TIC.RESULT_MODULACION_VERDE_ROJO,' '), "       
/*69*/ + " NVL(TO_CHAR(TIC.FECHA_RECONOCIMIENTO, 'MON/DD/YYYY'),' '), " 
/*70*/ + " NVL(TO_CHAR(TIC.FECHA_LIBERACION, 'MON/DD/YYYY'),' '), "    
/*71*/ + " NVL(TIC.SELLO_ORIGEN,' '), "                                         
/*72*/ + " NVL(TIC.SELLO_FINAL,' '), "                
/*73*/ + " NVL(TO_CHAR(TIC.FECHA_RETENCION_AUTORIDAD, 'MON/DD/YYYY'),' '), "    
/*74*/ + " NVL(TO_CHAR(TIC.FECHA_LIB_POR_RET_AUT, 'MON/DD/YYYY'),' '), "    
/*75*/ + " NVL(TEC.DESCRIPCION_ESTADO,' '), "           
/*76*/ + " NVL(TIC.MOTIVO_ATRASO,' '), "              
/*77*/ + " NVL(TIC.OBSERVACIONES,' '), "         
/*78*/ + " NVL(TO_CHAR(TIC.LLEGADA_A_NOVA, 'MON/DD/YYYY'),' '), " 
/*79*/ + " NVL(TO_CHAR(TIC.LLEGADA_A_GLOBE_TRADE_SD, 'MON/DD/YYYY'),' '), " 
/*80*/ + " NVL(TIC.ARCHIVO_M,' '), "  
/*81*/ + " NVL(TO_CHAR(TIC.FECHA_ARCHIVO_M, 'MON/DD/YYYY'),' '), "    
/*82*/ + " NVL(TO_CHAR(TIC.FECHA_SOLICIT_MANIP, 'MON/DD/YYYY'),' '), "    
/*83*/ + " NVL(TO_CHAR(TIC.FECHA_VENCIM_MANIP, 'MON/DD/YYYY'),' '), "    
/*84*/ + " NVL(TO_CHAR(TIC.FECHA_CONFIRM_CLAVE_PEDIM, 'MON/DD/YYYY'),' '), "    
/*85*/ + " NVL(TO_CHAR(TIC.FECHA_RECEP_INCREMENT, 'MON/DD/YYYY'),' '), "    
/*86*/ + " NVL(TIC.T_E,' '), "  
/*87*/ + " NVL(TO_CHAR(TIC.FECHA_VENCIM_INBOUND, 'MON/DD/YYYY'),' '), "                  
/*88*/ + " NVL(TIC.NO_BULTOS,' '), " 
/*89*/ + " NVL(TIC.PESO_KG,' '), "  
/*90*/ + " NVL(TIC.TRANSFERENCIA,' '), "  
/*91*/ + " NVL(TO_CHAR(TIC.FECHA_INICIO_ETIQUETADO, 'MON/DD/YYYY'),' '), "    
/*92*/ + " NVL(TO_CHAR(TIC.FECHA_TERMINO_ETIQUETADO, 'MON/DD/YYYY'),' '), "    
/*93*/ + " NVL(TIC.HORA_TERMINO_ETIQUETADO,' '), "  
/*94*/ + " NVL(TIC.PROVEEDOR,' '), "  
/*95*/ + " NVL(TIC.PROVEEDOR_CARGA,' '), " 						 
/*96*/ + " NVL(TIC.FY,' '), "                                                
