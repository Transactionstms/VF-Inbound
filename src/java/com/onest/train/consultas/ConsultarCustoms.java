        ...
        /*  ----------------------------- ENCABEZADOS DE TABLA  -----------------------------  */
            ...
            /*  ----------------------------- CUERPO/DATA DE TABLA  -----------------------------  */
                    ...
                    salida += "<tr id=\"tr<" + cont + "\">"
                            ...
                            + " <td contenteditable=\"true\" oninput=\"formatoFecha(event)\" id=\"fecha_envio[" + cont + "]\" onkeydown=\"tabuladorVertical(event,'fecha_envio'," + cont + ")\" ondblclick=\"show_fecha_envio('" + row[51] + "'," + cont + ")\" onpaste=\"handlePasteFecha(event)\">" + row[51] + "</td> "
                            + " <td contenteditable=\"true\" oninput=\"formatoFecha(event)\" id=\"fecha_recepcion_perm[" + cont + "]\" onkeydown=\"tabuladorVertical(event,'fecha_recepcion_perm'," + cont + ")\" ondblclick=\"show_fecha_recepcion_perm('" + row[52] + "'," + cont + ")\" onpaste=\"handlePasteFecha(event)\">" + row[52] + "</td> "
                            + " <td contenteditable=\"true\" oninput=\"formatoFecha(event)\" id=\"fecha_activacion_perm[" + cont + "]\" onkeydown=\"tabuladorVertical(event,'fecha_activacion_perm'," + cont + ")\" ondblclick=\"show_fecha_activacion_perm('" + row[53] + "'," + cont + ")\" onpaste=\"handlePasteFecha(event)\">" + row[53] + "</td> "
                            + " <td contenteditable=\"true\" oninput=\"formatoFecha(event)\" id=\"fecha_permisos_aut[" + cont + "]\" onkeydown=\"tabuladorVertical(event,'fecha_permisos_aut'," + cont + ")\" ondblclick=\"show_fecha_permisos_aut('" + row[54] + "'," + cont + ")\" onpaste=\"handlePasteFecha(event)\">" + row[54] + "</td> "
                            ...
                            + " <td contenteditable=\"true\" oninput=\"formatoFecha(event)\" id=\"fecha_recepcion_ca[" + cont + "]\" onkeydown=\"tabuladorVertical(event,'fecha_recepcion_ca'," + cont + ")\" ondblclick=\"show_fecha_recepcion_ca('" + row[59] + "'," + cont + ")\" onpaste=\"handlePasteFecha(event)\">" + row[59] + "</td> "
