        ...
        /*  ----------------------------- ENCABEZADOS DE TABLA  -----------------------------  */
            ...
            /*  ----------------------------- CUERPO/DATA DE TABLA  -----------------------------  */
                    ...
                    salida += "<tr id=\"tr<" + cont + "\">"
                            ...
                            + " <td contenteditable=\"true\" id=\"eta_port_discharge[" + cont + "]\" dblclick=\"show_eta_port_discharge('" + row[34] + "'," + cont + ")\">" + row[34] + "</td> "
                            ...
                            + " <td contenteditable=\"true\" id=\"fecha_recepcion_doc[" + cont + "]\" dblclick=\"show_fecha_recepcion_doc('" + row[41] + "'," + cont + ")\">" + row[41] + "</td> "
                            ...
                            + " <td contenteditable=\"true\" id=\"fecha_revalidacion[" + cont + "]\" dblclick=\"show_fecha_revalidacion('" + row[45] + "'," + cont + ")\">" + row[45] + "</td> "
                            + " <td contenteditable=\"true\" id=\"fecha_previo_origen[" + cont + "]\" dblclick=\"show_fecha_previo_origen('" + row[46] + "'," + cont + ")\">" + row[46] + "</td> "
                            + " <td contenteditable=\"true\" id=\"fecha_previo_destino[" + cont + "]\" dblclick=\"show_fecha_previo_destino('" + row[47] + "'," + cont + ")\">" + row[47] + "</td> "
                            + " <td contenteditable=\"true\" id=\"fecha_resultado_previo[" + cont + "]\" dblclick=\"show_fecha_resultado_previo('" + row[48] + "'," + cont + ")\">" + row[48] + "</td> "
                            + " <td id=\"proforma_final[" + cont + "]\" onclick=\"show_proforma_final('" + row[49] + "'," + cont + ")\">" + row[49] + "</td> "
                            + " <td contenteditable=\"true\" id=\"permiso[" + cont + "]\" dblclick=\"show_permiso(" + cont + ")\">" + row[50] + "</td> "
                            + " <td contenteditable=\"true\" id=\"fecha_envio[" + cont + "]\" dblclick=\"show_fecha_envio('" + row[51] + "'," + cont + ")\">" + row[51] + "</td> "
                            + " <td contenteditable=\"true\" id=\"fecha_recepcion_perm[" + cont + "]\" dblclick=\"show_fecha_recepcion_perm('" + row[52] + "'," + cont + ")\">" + row[52] + "</td> "
                            + " <td contenteditable=\"true\" id=\"fecha_activacion_perm[" + cont + "]\" dblclick=\"show_fecha_activacion_perm('" + row[53] + "'," + cont + ")\">" + row[53] + "</td> "
                            + " <td contenteditable=\"true\" id=\"fecha_permisos_aut[" + cont + "]\" dblclick=\"show_fecha_permisos_aut('" + row[54] + "'," + cont + ")\">" + row[54] + "</td> "
                            ...
                            + " <td contenteditable=\"true\" id=\"req_uva[" + cont + "]\" dblclick=\"show_req_uva(" + cont + ")\">" + row[57] + "</td> "
                            + " <td contenteditable=\"true\" id=\"req_ca[" + cont + "]\" dblclick=\"show_req_ca(" + cont + ")\">" + row[58] + "</td> "
                            + " <td id=\"fecha_recepcion_ca[" + cont + "]\" dblclick=\"show_fecha_recepcion_ca('" + row[59] + "'," + cont + ")\">" + row[59] + "</td> "
                            + " <td contenteditable=\"true\" oninput=\"validarTexto(this)\" onkeydown=\"tabuladorVertical(event,'num_constancia_ca'," + cont + ")\" onpaste=\"handlePaste(event)\" id=\"num_constancia_ca[" + cont + "]\">" + row[60] + "</td> "
                            ...
                            + " <td contenteditable=\"true\" id=\"fecha_doc_completos[" + cont + "]\" dblclick=\"show_fecha_doc_completos('" + row[63] + "'," + cont + ")\">" + row[62] + "</td> "
                            + " <td contenteditable=\"true\" id=\"fecha_pago_pedimento[" + cont + "]\" dblclick=\"show_fecha_pago_pedimento(" + cont + ")\">" + row[63] + "</td> "
                            + " <td contenteditable=\"true\" id=\"fecha_solicitud_transporte[" + cont + "]\" dblclick=\"show_fecha_solicitud_transporte('" + row[64] + "'," + cont + ")\">" + row[64] + "</td> "
                            + " <td contenteditable=\"true\" id=\"fecha_modulacion[" + cont + "]\" dblclick=\"show_fecha_modulacion(" + cont + ")\">" + row[65] + "</td> "
                            + " <td contenteditable=\"true\" id=\"modalidad[" + cont + "]\" dblclick=\"show_modalidad(" + cont + ")\">" + row[66] + "</td> "
                            + " <td contenteditable=\"true\" id=\"resultado_modulacion[" + cont + "]\" dblclick=\"show_resultado_modulacion(" + cont + "," + AgentType + ")\">" + row[67] + "</td> "
                            + " <td contenteditable=\"true\" id=\"fecha_reconocimiento[" + cont + "]\" dblclick=\"show_fecha_reconocimiento('" + row[68] + "'," + cont + ")\">" + row[68] + "</td> "
                            + " <td contenteditable=\"true\" id=\"fecha_liberacion[" + cont + "]\" dblclick=\"show_fecha_liberacion('" + row[69] + "'," + cont + ")\">" + row[69] + "</td> "
                            ...
                            + " <td contenteditable=\"true\" id=\"fecha_retencion_aut[" + cont + "]\" dblclick=\"show_fecha_retencion_aut('" + row[72] + "'," + cont + ")\">" + row[72] + "</td> "
                            + " <td contenteditable=\"true\" id=\"fecha_liberacion_aut[" + cont + "]\" dblclick=\"show_fecha_liberacion_aut('" + row[73] + "'," + cont + ")\">" + row[73] + "</td> "
                ...
                if (AgentType.equals("4001") || AgentType.equals("4006")) { //LOGIX Y VF
                    ...
                    salida += " <td contenteditable=\"true\" id=\"llegada_a_nova[" + cont + "]\" dblclick=\"show_llegada_a_nova('" + row[77] + "'," + cont + ")\">" + row[77] + "</td> "
                            + " <td contenteditable=\"true\" id=\"llegada_a_globe_trade_sd[" + cont + "]\" dblclick=\"show_llegada_a_globe_trade_sd('" + row[78] + "'," + cont + ")\">" + row[78] + "</td> "
                            ...
                            + " <td contenteditable=\"true\" id=\"fecha_archivo_m[" + cont + "]\" dblclick=\"show_fecha_archivo_m('" + row[80] + "'," + cont + ")\">" + row[80] + "</td> "
                            + " <td contenteditable=\"true\" id=\"fecha_solicit_manip[" + cont + "]\" dblclick=\"show_fecha_solicit_manip('" + row[81] + "'," + cont + ")\">" + row[81] + "</td> "
                            + " <td contenteditable=\"true\" id=\"fecha_vencim_manip[" + cont + "]\" dblclick=\"show_fecha_vencim_manip('" + row[82] + "'," + cont + ")\">" + row[82] + "</td> "
                            + " <td contenteditable=\"true\" id=\"fecha_confirm_clave_pedim[" + cont + "]\" dblclick=\"show_fecha_confirm_clave_pedim('" + row[83] + "'," + cont + ")\">" + row[83] + "</td> "
                            + " <td contenteditable=\"true\" id=\"fecha_recep_increment[" + cont + "]\" dblclick=\"show_fecha_recep_increment('" + row[84] + "'," + cont + ")\">" + row[84] + "</td> "
                            ...
                            + " <td contenteditable=\"true\" id=\"fecha_vencim_inbound[" + cont + "]\" dblclick=\"show_fecha_vencim_inbound('" + row[86] + "'," + cont + ")\">" + row[86] + "</td> ";
                }

                if (AgentType.equals("4002") || AgentType.equals("4006")) {  //CUSA Y VF

                    salida += " <td contenteditable=\"true\" oninput=\"validarTexto(this)\" onkeydown=\"tabuladorVertical(event,'no_bultos'," + cont + ")\" onpaste=\"handlePaste(event)\" id=\"no_bultos[" + cont + "]\">" + row[87] + "</td> "
                            + " <td contenteditable=\"true\" oninput=\"validarTexto(this)\" onkeydown=\"tabuladorVertical(event,'peso_kg'," + cont + ")\" onpaste=\"handlePaste(event)\" id=\"peso_kg[" + cont + "]\">" + row[88] + "</td> "
                            + " <td id=\"transferencia[" + cont + "]\" onclick=\"show_transferencia(" + cont + ")\">" + row[89] + "</td> "
                            + " <td contenteditable=\"true\" id=\"fecha_inicio_etiquetado[" + cont + "]\" dblclick=\"show_fecha_inicio_etiquetado('" + row[90] + "'," + cont + ")\">" + row[90] + "</td> "
                            + " <td contenteditable=\"true\" id=\"fecha_termino_etiquetado[" + cont + "]\" dblclick=\"show_fecha_termino_etiquetado('" + row[91] + "'," + cont + ")\">" + row[91] + "</td> "
