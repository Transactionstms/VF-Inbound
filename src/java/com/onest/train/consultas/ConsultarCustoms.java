...
public class ConsultarCustoms extends HttpServlet {
    ...
    /*  ----------------------------- FILTROS MULTISELECT ENCABEZADOS  -----------------------------  */  
        ...
        /*10*/ + " SQ.SUMA, "
        /*11*/ + " TIP1.NOMBRE_POD, "
        /*12*/ + " REPLACE(NVL(TO_CHAR(GTN.EST_DEPARTURE_POL, 'Month/DD/YY'),' '), '01/01/1970', ' '), "
        /*13*/ + " REPLACE(NVL(TO_CHAR(GTN.ETA_PORT_DISCHARGE, 'Month/DD/YY'),' '), '01/01/1970', ' '), "
        /*14*/ + " NVL(GTN.MAX_FLETE, 0) AS EST_ETA_DC, "
        /*15*/ + " REPLACE(NVL(TO_CHAR(GTN.FECHA_CAPTURA, 'Month/DD/YYYY'),' '), '01/01/1970', ' '), "
        /*16*/ + " TIP2.NOMBRE_POL, "
        ...
        /*21*/ + " TIP2.NOMBRE_POL, "
        /*22*/ + " TIBD.NOMBRE_BD, "
        /*23*/ + " REPLACE(NVL(TO_CHAR(GTN.ETA_PLUS2, 'Month/DD/YYYY'),' '), '01/01/1970', ' '), "
        /*24*/ + " REPLACE(NVL(TO_CHAR(TIE.EST_ETA_DC, 'Month/DD/YYYY'),' '), '01/01/1970', ' '), "
        /*25*/ + " REPLACE(NVL(TO_CHAR(GTN.ETA_PLUS, 'Month/DD/YYYY'),' '), '01/01/1970', ' '), "
        /*26*/ + " NVL(TIE.OBSERVACIONES, ' ') AS OBSERVACIONES, "
        /*27*/ + " TIE.ESTATUS_EVENTO, "
        /*28*/ + " NVL(TIE.REFERENCIA_AA,' '), "
        /*29*/ + " REPLACE(NVL(TO_CHAR(TIE.FECHA_CAPTURA, 'Month/DD/YYYY'),' '), '01/01/1970', ' '), "
        /*30*/ + " NVL(TIE.PRIORIDAD,' '), "
        /*31*/ + " NVL(TIC.REFERENCIA_AA,' '), "
        /*32*/ + " NVL(TIC.PAIS_ORIGEN,' '), "
        /*33*/ + " NVL(TIC.SIZE_CONTAINER,' '), "
        /*34*/ + " NVL(TIC.VALOR_USD,' '), "
        /*35*/ + " REPLACE(NVL(TO_CHAR(TIC.ETA_PORT_OF_DISCHARGE, 'Month/DD/YYYY'),' '), '01/01/1970', ' '), "
        ...
        /*42*/ + " REPLACE(NVL(TO_CHAR(TIC.FECHA_RECEPCION_DOCUMENTOS, 'Month/DD/YYYY'),' '), '01/01/1970', ' '), "
        /*43*/ + " NVL(TIC.RECINTO,' '), "
        /*44*/ + " NVL(TIC.NAVIERA_FORWARDER,' '), "
        /*45*/ + " NVL(TIC.BUQUE,' '), "
        /*46*/ + " REPLACE(NVL(TO_CHAR(TIC.FECHA_REVALID_LIBE_BL, 'Month/DD/YYYY'),' '), '01/01/1970', ' '), "
        /*47*/ + " REPLACE(NVL(TO_CHAR(TIC.FECHA_PREVIO_ORIGEN, 'Month/DD/YYYY'),' '), '01/01/1970', ' '), "
        /*48*/ + " REPLACE(NVL(TO_CHAR(TIC.FECHA_PREVIO_DESTINO, 'Month/DD/YYYY'),' '), '01/01/1970', ' '), "
        /*49*/ + " REPLACE(NVL(TO_CHAR(TIC.FECHA_RESULTADO_PREVIO, 'Month/DD/YYYY'),' '), '01/01/1970', ' '), "
        /*50*/ + " REPLACE(NVL(TO_CHAR(TIC.PROFORMA_FINAL, 'Month/DD/YYYY'),' '), '01/01/1970', ' '), "
        /*51*/ + " NVL(TIC.REQUIERE_PERMISO,' '), "
        /*52*/ + " REPLACE(NVL(TO_CHAR(TIC.FECHA_ENVIO_FICHAS_NOTAS, 'Month/DD/YYYY'),' '), '01/01/1970', ' '), "
        /*53*/ + " REPLACE(NVL(TO_CHAR(TIC.FEC_RECEPCION_PERMISOS_TRAMIT, 'Month/DD/YYYY'),' '), '01/01/1970', ' '), "
        /*54*/ + " REPLACE(NVL(TO_CHAR(TIC.FEC_ACT_PERMISOS, 'Month/DD/YYYY'),' '), '01/01/1970', ' '), "
        /*55*/ + " REPLACE(NVL(TO_CHAR(TIC.FEC_PERM_AUT, 'Month/DD/YYYY'),' '), '01/01/1970', ' '), "
        /*56*/ + " NVL(TIC.CO_APLIC_PREF_ARANCELARIA,' '), "
        /*57*/ + " NVL(TIC.APLIC_PREF_ARANCELARIA_CO,' '), "
        /*58*/ + " NVL(TIC.REQUIERE_UVA,' '), "
        /*59*/ + " NVL(TIC.REQUIERE_CA,' '), "
        /*60*/ + " REPLACE(NVL(TO_CHAR(TIC.FECHA_RECEPCION_CA, 'Month/DD/YYYY'),' '), '01/01/1970', ' '), "
        /*61*/ + " NVL(TIC.NÚMERO_CONSTANCIA_CA,' '), "
        /*62*/ + " NVL(TIC.MONTO_CA,' '), "
        /*63*/ + " REPLACE(NVL(TO_CHAR(TIC.FECHA_DOCUMENTOS_COMPLETOS, 'Month/DD/YYYY'),' '), '01/01/1970', ' '), "
        /*64*/ + " REPLACE(NVL(TO_CHAR(TIC.FECHA_PAGO_PEDIMENTO, 'Month/DD/YYYY'),' '), '01/01/1970', ' '), "
        /*65*/ + " REPLACE(NVL(TO_CHAR(TIC.FECHA_SOLICITUD_TRANSPORTE, 'Month/DD/YYYY'),' '), '01/01/1970', ' '), "
        /*66*/ + " REPLACE(NVL(TO_CHAR(TIC.FECHA_MODULACION, 'Month/DD/YYYY'),' '), '01/01/1970', ' '), "
        /*67*/ + " NVL(TIC.MODALIDAD_CAMION_TREN,' '), "
        /*68*/ + " NVL(TIC.RESULT_MODULACION_VERDE_ROJO,' '), "
        /*69*/ + " REPLACE(NVL(TO_CHAR(TIC.FECHA_RECONOCIMIENTO, 'Month/DD/YYYY'),' '), '01/01/1970', ' '), "
        /*70*/ + " REPLACE(NVL(TO_CHAR(TIC.FECHA_LIBERACION, 'Month/DD/YYYY'),' '), '01/01/1970', ' '), "
        /*71*/ + " NVL(TIC.SELLO_ORIGEN,' '), "
        /*72*/ + " NVL(TIC.SELLO_FINAL,' '), "
        /*73*/ + " REPLACE(NVL(TO_CHAR(TIC.FECHA_RETENCION_AUTORIDAD, 'Month/DD/YYYY'),' '), '01/01/1970', ' '), "
        /*74*/ + " REPLACE(NVL(TO_CHAR(TIC.FECHA_LIB_POR_RET_AUT, 'Month/DD/YYYY'),' '), '01/01/1970', ' '), "
        /*75*/ + " NVL(TEC.DESCRIPCION_ESTADO,' '), "
        /*76*/ + " NVL(TIC.MOTIVO_ATRASO,' '), "
        /*77*/ + " NVL(TIC.OBSERVACIONES,' '), "
        /*78*/ + " REPLACE(NVL(TO_CHAR(TIC.LLEGADA_A_NOVA, 'Month/DD/YYYY'),' '), '01/01/1970', ' '), "
        /*79*/ + " REPLACE(NVL(TO_CHAR(TIC.LLEGADA_A_GLOBE_TRADE_SD, 'Month/DD/YYYY'),' '), '01/01/1970', ' '), "
        /*80*/ + " NVL(TIC.ARCHIVO_M,' '), "
        /*81*/ + " REPLACE(NVL(TO_CHAR(TIC.FECHA_ARCHIVO_M, 'Month/DD/YYYY'),' '), '01/01/1970', ' '), "
        /*82*/ + " REPLACE(NVL(TO_CHAR(TIC.FECHA_SOLICIT_MANIP, 'Month/DD/YYYY'),' '), '01/01/1970', ' '), "
        /*83*/ + " REPLACE(NVL(TO_CHAR(TIC.FECHA_VENCIM_MANIP, 'Month/DD/YYYY'),' '), '01/01/1970', ' '), "
        /*84*/ + " REPLACE(NVL(TO_CHAR(TIC.FECHA_CONFIRM_CLAVE_PEDIM, 'Month/DD/YYYY'),' '), '01/01/1970', ' '), "
        /*85*/ + " REPLACE(NVL(TO_CHAR(TIC.FECHA_RECEP_INCREMENT, 'Month/DD/YYYY'),' '), '01/01/1970', ' '), "
        /*86*/ + " NVL(TIC.T_E,' '), "
        /*87*/ + " REPLACE(NVL(TO_CHAR(TIC.FECHA_VENCIM_INBOUND, 'Month/DD/YYYY'),' '), '01/01/1970', ' '), "
        /*88*/ + " NVL(TIC.NO_BULTOS,' '), "
        /*89*/ + " NVL(TIC.PESO_KG,' '), "
        /*90*/ + " NVL(TIC.TRANSFERENCIA,' '), "
        /*91*/ + " REPLACE(NVL(TO_CHAR(TIC.FECHA_INICIO_ETIQUETADO, 'Month/DD/YYYY'),' '), '01/01/1970', ' '), "
        /*92*/ + " REPLACE(NVL(TO_CHAR(TIC.FECHA_TERMINO_ETIQUETADO, 'Month/DD/YYYY'),' '), '01/01/1970', ' '), "
