...
public class InsertarBrokerMenu extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            try {
                ...
                String menu = " insert into broker_menu (menu_id,etiqueta,ruta,owner,group_id,owner_access,"
                        + " group_access,world_access,tipo)"
                        + " values (null, '" + etiqueta + "', '" + ruta + "', '" + owner + "', " + grupo + ", '" + uno1 + "', '" + dos2 + "', '" + tres3 + "', '" + tipo + "' )";

                boolean oraOut1 = oraDB.execute(menu);
                out.println("<form action='" + request.getContextPath() + "/forms1/alta_broker_menu.jsp' name='proceso'>");
