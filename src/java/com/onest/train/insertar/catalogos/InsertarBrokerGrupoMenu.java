...
public class InsertarBrokerGrupoMenu extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            try {
                ...
                String submenu = "INSERT INTO broker_grupo_menu (grupo_menu_id, group_id, menu_id)"
                        + " values (null, " + grupo + ", " + menu + ")";
                boolean oraOut1 = oraDB.execute(submenu);
                out.println("<form action='" + request.getContextPath() + "/forms1/alta_broker_usuario_div.jsp' name='proceso'>");
